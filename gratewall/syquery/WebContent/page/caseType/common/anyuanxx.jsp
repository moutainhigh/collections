	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["casesrcid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	}
	function viewDataSource(casesrcid){
		var title="详细信息";
		var frameurl=""+'/casequery/queryanyuanxxform.do?casesrcid='+casesrcid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="案源信息" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- 案件当事人信息 -->
				<div name='casesrcid' text="案源ID" textalign="center" width="0%"></div>
				<div name='caseid' text="案件记录ID" textalign="center" width="0%"></div>
				<div name='casesou' text="案件来源" textalign="center" width="30%"></div>
				<div name='regno' text="线索(举报)内容" textalign="center" width="30%"></div>
				<div name='regtime' text="登记时间" textalign="center"></div>
