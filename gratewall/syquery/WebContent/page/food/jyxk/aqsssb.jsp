...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="安全设施设备信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='deviceName' text="名称" textalign="center" width="15%"></div>
				<div name='deviceNum' text="数量" textalign="center" width="10%"></div>
				<div name='devicePlace' text="位置" textalign="center" width="10%"></div>
				<div name='deviceRemark' text="备注" textalign="center" width="65%"></div>
