...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="产品模型项信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='productName' text="食品、食品添加剂类别" textalign="center" width="20%"></div>
				<div name='productCategoryName' text="产品类别名称" textalign="center" width="15%"></div>
				<!-- <div name='productCategoryCode' text="产品类别编码" textalign="center" width="15%"></div> -->
				<div name='productTypeInfo' text="产品种类明细" textalign="center" width="15%"></div>
				<!-- <div name='licenseType' text="许可证类型" textalign="center" width="15%" dataurl="../code/xukezheng.json"></div> -->
				<div name='productRemark' text="备注" textalign="center" width="*"></div>
