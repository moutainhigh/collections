...
<script type="text/javascript">
	...
	function viewDataSource(recid){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzdiaoxiaoxxform.do?recid='+recid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		title="吊销信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- <div name='recisd' text="记录id" textalign="center" width="0%"></div>
				<div name='pripid' text="主体身份代码" textalign="center" width="0%"></div> -->
				<div name='revdate' text="吊销日期" textalign="center" width="30%"></div>
				<div name='revrea' text="吊销原因" textalign="center" width="40%"></div>
				<div name='revauth' text="吊销机关" textalign="center" width="20%"></div>
				<!-- <div name='revbasis' text="吊销依据" textalign="center" width="0%"></div> -->
	...
	<div id="formpanel" class="formpanel_table" style="height:200px;">
