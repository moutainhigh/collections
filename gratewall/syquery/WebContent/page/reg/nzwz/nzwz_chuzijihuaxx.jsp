...
<script type="text/javascript">
	...
	function viewDataSource(invid){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzchuzijihuaxxform.do?invid='+invid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		selecttype="1" titledisplay="true" title="出资计划" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
			
				<div name='contermno' text="出资期次" textalign="center" width="20%"></div>
				<div name='confrom' text="出资期限自" textalign="center" width="15%"></div>
				<div name='conto' text="出资期限至" textalign="center" width="15%"></div>
				<div name='cursubconam' text="本期认缴出资额" textalign="center" width="15%"></div>
				<div name='curactconam' text="实际出资" textalign="center" width="15%"></div>
				<div name='acconddte' text="实际出资日期" textalign="center" width="10%"></div>
