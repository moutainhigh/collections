...
<script type="text/javascript">
	...
	function viewDataSource(recid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzlianluoxxform.do?recid='+recid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='recid' text="记录ID" textalign="center" width="20%"></div>
				<div name='pripid' text="主体身份代码" textalign="center" width="20%"></div>
				<div name='personid' text="联络员记录ID" textalign="center" width="20%"></div>
				<div name='department' text="部门" textalign="center" width="20%"></div>
