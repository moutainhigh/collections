...
<script type="text/javascript">
	...
	function viewDataSource(recid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzxukexxform.do?recid='+recid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="100%" width="100%"
		id='jbxxGrid' dataloadcomplete="" datarender="fixColumn()"
		style="Position: Reletive" selecttype="1" titledisplay="true"
		title="许可信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='licname' text="审批文件名称" textalign="center" width="15%"></div>
				<div name='licno' text="审批文件号" textalign="center" width="20%"></div>
				<div name='valfrom' text="有效期自" textalign="center" width="15%"></div>
				<div name='valto' text="有效期至" textalign="center" width="15%"></div>
				<div name='licstate' text="审批文件状态" textalign="center" width="20%"></div>
