...
function fixColumn(event, obj) {// 维护按钮
	...
	for(var i=0;i<data.length;i++){
		var htm ='<div class="jazz-grid-cell-inner">'
			+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["grpcanid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
			+'</div>';
		data[i]["fix"] = htm; 
	}
	return data;
}
function viewDataSource(grpcanid){
	var title="详细信息";
	var type="view";
	var frameurl=""+'/trsquery/queryjituanzhuxiaoxxform.do?grpcanid='+grpcanid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="集团注销信息" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='pripid' text="集团主体身份代码" textalign="center" width="0%"></div>
				<div name='canrea' text="注销原因" textalign="center" width="40%"></div>
				<div name='candate' text="注销日期" textalign="center" width="40%"></div>
				<div name='fix' text="操作" textalign="center" width="20%"></div>
			</div>
		</div>
		<!-- 表格 -->
