...
function fixColumn(event, obj) {// 维护按钮
	...
	for(var i=0;i<data.length;i++){
		...
		var html ='<div class="jazz-grid-cell-inner">'
			+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["personid"]+'\');">'+data[i]["persname"]+'</a>'
			+'</div>';
		data[i]["fix"] = htm; 
		data[i]["persname"] = html;
	}
	return data;
}
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="个体经营者信息" showborder="false"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='persname' text="姓名" textalign="center" width="20%"></div>
				<div name='sex' text="性别" textalign="center" width="10%"></div>
				<div name='certype' text="证件类型" textalign="center" width="30%"></div>
