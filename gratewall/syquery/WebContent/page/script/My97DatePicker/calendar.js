...
var divWidth=this.eCont.offsetWidth>160?this.eCont.offsetWidth:160;
this.dd.style.cssText='position:absolute;z-index:197;display:block;';
this.dd.style.width=divWidth;
this.dd.obj=this;
...
s.a("<td align=center onmouseover=\"this.className='WymOn'\" onmouseout=\"this.className='Wym'\" onmousedown=\"$d.mDiv.style.display='none';\">x</td></tr>");
s.a("</table>");
...
s.a(">\u2190</td><td class='Wym' onmouseover=\"this.className='WymOn'\" onmouseout=\"this.className='Wym'\" onmousedown=\"$d.yDiv.style.display='none';$d.yInput.blur();\">x</td><td ");
