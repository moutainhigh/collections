 ...
 */
@Controller
@RequestMapping("/trsSearchcase")
public class TrsSearchControllercase {
    
    @Autowired
    private TrsSearchService trsSearchServicecase;
	...
	public Map findKeyValueDcDmDbtypeBO(OptimusRequest req, OptimusResponse resp) 
			...
			Map<String,String> map= new HashMap<String,String>();
		 	...
		 	List<Map> list=trsSearchServicecase.querySearchCountBo();
	...
	public void SearchCount(OptimusRequest req, OptimusResponse resp) 
    	...
    	trsSearchServicecase.doSearchConntDual(queryKeyWord);
