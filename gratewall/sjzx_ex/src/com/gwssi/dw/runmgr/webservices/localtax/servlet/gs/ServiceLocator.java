...
public class ServiceLocator extends org.apache.axis.client.Service implements com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://localhost:7001/bjaic/services/BJGSWebService";
    ...
    public com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoapSoapBindingStub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoapSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoapSoapBindingStub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.ServiceSoapSoapBindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
