...
public class ReturnMultiGSData  implements java.io.Serializable {
    ...
    private com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.GSDJInfo[] GSDJ_INFO_ARRAY;
    ...
    public ReturnMultiGSData(
           ...
           com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.GSDJInfo[] GSDJ_INFO_ARRAY) {
           this.FHDM = FHDM;
           this.ZTS = ZTS;
           this.KSJLS = KSJLS;
           this.JSJLS = JSJLS;
     ...
     */
    public com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.GSDJInfo[] getGSDJ_INFO_ARRAY() {
        return GSDJ_INFO_ARRAY;
    }
     ...
     */
    public void setGSDJ_INFO_ARRAY(com.gwssi.dw.runmgr.webservices.localtax.servlet.gs.GSDJInfo[] GSDJ_INFO_ARRAY) {
        this.GSDJ_INFO_ARRAY = GSDJ_INFO_ARRAY;
    }
    ...
    static {
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://tempuri.org/", "item"));
        typeDesc.addFieldDesc(elemField);
    }
