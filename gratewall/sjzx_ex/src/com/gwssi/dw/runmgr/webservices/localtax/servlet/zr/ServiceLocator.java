...
public class ServiceLocator extends org.apache.axis.client.Service implements com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://172.24.30.30:8001/BJGSInfoDataExchange/BJGSWebService.asmx";
    ...
    public com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_PortType getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_BindingStub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_BindingStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "http://172.24.30.30:8001/BJGSInfoDataExchange/BJGSWebService.asmx";
    ...
    public com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_PortType getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap12Stub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_BindingStub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_BindingStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap12Stub _stub = new com.gwssi.dw.runmgr.webservices.localtax.servlet.zr.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
