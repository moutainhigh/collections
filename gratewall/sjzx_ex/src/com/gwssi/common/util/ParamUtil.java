 ...
 * 
 * 
 * 项目名称：bjgs_exchange 类名称：ParamUtil 类描述：参数处理工具类 创建人：lizheng 创建时间：Apr 9, 2013
 * 11:00:43 AM 修改人：lizheng 修改时间：Apr 9, 2013 11:00:43 AM 修改备注：
 * 
 * @version
 * 
 */
	...
	private static String objectToString(Object valueObj)
	{
		if (valueObj instanceof String[]) {
			...
			if (array.length == 0) {
				 ...
				 * 因此不能使用requestToBean以及requestToVO，requestToDAO方法获取checkbox以及多选select的值，
