 ...
 *
 */
public class VoCollectWsParamValuePrimaryKey extends VoBase
{
	private static final long serialVersionUID = 201307231043580004L;
	 ...
	 * 构造函数
	 */
	public VoCollectWsParamValuePrimaryKey()
	{
		super();
	}
	 ...
	 * @param value 数据节点
	 */
	public VoCollectWsParamValuePrimaryKey(DataBus value)
	{
		super(value);
	}
