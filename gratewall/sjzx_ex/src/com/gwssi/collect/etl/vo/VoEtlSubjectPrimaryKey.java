 ...
 *
 */
public class VoEtlSubjectPrimaryKey extends VoBase
{
	private static final long serialVersionUID = 201308130950380004L;
	 ...
	 * @param value 数据节点
	 */
	public VoEtlSubjectPrimaryKey(DataBus value)
	{
		super(value);
	}
