 ...
 * 
 */
public class JmsGSGeneralClient
{
	// 日志
	protected static Logger	logger	= TxnLogger.getLogger(JmsGSGeneralClient.class
											.getName());
	...
	{
		try {
			JmsGeneralClient client = JmsClientFactory.getClient();
