 ...
 *
 */
public class VoViewSysAppLogQuerySelectKey extends VoBase
{
	private static final long serialVersionUID = 201208010743390003L;
	 ...
	 * 构造函数
	 */
	public VoViewSysAppLogQuerySelectKey()
	{
		super();
	}
	 ...
	 * @param value 数据节点
	 */
	public VoViewSysAppLogQuerySelectKey(DataBus value)
	{
		super(value);
	}
