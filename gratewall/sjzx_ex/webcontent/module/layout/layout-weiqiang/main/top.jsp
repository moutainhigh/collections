	...
	function toolbar_onclick( menuId ){
	    if(menuId=='000000'){
		  ...
		  parent._showFunctionPage('/txn53000009.do' );
			...
			//解决办法2
			top.window.document.getElementById("mainMenuId").value=menuId;
			top.window.document.getElementById("mainForm").submit();
		}
	}
			...
			<div class="header" >
				...
				<div  class="r_cont">
					...
					<!-- 	<li onclick="system_logout()" title="退出系统" class="quit">&nbsp;</li> -->
						<li title="加入收藏" onclick="window.external.AddFavorite(top.window.location.href, '深圳市市场和质量监督管理委员会');" class="reg">&nbsp;</li>
...
<form id="menuForm" method="post" action="/txn53000099.do" >
	<input id="menuId" type="hidden"  name="menu:mid" value="" />
</form>
</body>
