...
<html>
<head>
<link rel="stylesheet" href="../newcss/basic.css" />
...
<script type="text/javascript" src="../lib/jquery/jquery.simplemodal.js"></script>
...
<frameset rows="114,*" cols="*" name="rowset" frameborder="no" border="0" framespacing="0">
  <frame src="<%=layoutPath%>/main/top_old.jsp?menuId=<%=menuId%>" name="topFrame" scrolling="no" noresize="noresize" id="topFrame" />
  <frameset cols="0,0,100%" name="listset" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="<%=rootPath%>/txn53000099.do" name="main" scrolling="auto" noresize="noresize" id="main" />
  </frameset>
</frameset>
<noframes><body>
</body>
