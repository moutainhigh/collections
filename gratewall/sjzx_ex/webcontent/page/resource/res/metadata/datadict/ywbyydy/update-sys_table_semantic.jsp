...
<freeze:body>
<freeze:title caption="修改业务表信息"/>
<freeze:errors/>

<freeze:form action="/txn30402002">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="table_no" caption="业务表编码" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改业务表信息" width="95%">
      <freeze:button name="record_saveAndExit" caption="保 存" hotkey="SAVE_CLOSE" onclick="func_record_saveAndExit();"/>
      <freeze:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      <freeze:hidden property="table_no" caption="业务表编码" datatype="string" style="width:95%"/>
      ...
      <freeze:radio property="downloadflag" caption="是否可下载" valueset="布尔型数" notnull="true" style="width:95%" show="name" data="code"/>
