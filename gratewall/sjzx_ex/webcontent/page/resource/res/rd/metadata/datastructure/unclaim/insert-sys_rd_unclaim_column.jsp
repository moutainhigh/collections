...
{
	saveRecord( '', '保存未认领表字段表' );
}

// 保存并继续
function func_record_saveAndContinue()
{
	saveAndContinue( '', '保存未认领表字段表' );
}
...
<freeze:body>
<freeze:title caption="增加未认领表字段信息"/>
<freeze:errors/>

<freeze:form action="/txn80002403">
  <freeze:block property="record" caption="增加未认领表字段信息" width="95%">
