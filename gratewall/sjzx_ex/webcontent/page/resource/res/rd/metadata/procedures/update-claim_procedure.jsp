...
<freeze:form action="/txn80005202">
    <freeze:block property="record" caption="修改存储过程" width="95%">
        ...
        <freeze:textarea property="view_use" caption="存储过程用途" colspan="2" rows="3" maxlength="1000" minlength="1" style="width:95%" />
        <freeze:textarea property="view_script" caption="存储过程脚本" colspan="2" rows="10" minlength="1" style="width:95%" />
