...
<freeze:form action="/txn80003202">
    <freeze:block property="record" caption="修改视图" width="95%">
        ...
        <freeze:cell property="view_name" caption="视图名称:"   style="width:95%"/>
        <freeze:cell property="sys_name" caption="主题名称:"  style="width:95%"/>
        
        <freeze:textarea property="view_use" caption="视图用途" colspan="2" rows="3" maxlength="1000" minlength="1" style="width:95%" />
        <freeze:textarea property="view_script" caption="视图脚本" colspan="2" rows="10" minlength="1" style="width:95%" />
