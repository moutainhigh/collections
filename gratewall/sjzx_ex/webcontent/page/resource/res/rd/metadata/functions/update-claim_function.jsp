...
<freeze:form action="/txn80004202">
    <freeze:block property="record" caption="修改函数" width="95%">
        ...
        <freeze:textarea property="view_use" caption="函数用途" colspan="2" rows="3" maxlength="1000" minlength="1" style="width:95%" />
        <freeze:textarea property="view_script" caption="函数脚本" colspan="2" rows="10" minlength="1" style="width:95%" />
