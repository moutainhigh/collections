...
<br />
 <table width="200"  align="center"  cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
    <tr class="secTitle" >
      <td width="90" style="border-bottom:2px solid white" >未认领表</td>
      <td width="92" align="center" style="border-bottom:2px solid white"><freeze:out value="${record.wrlb}"></freeze:out>张</td>
    </tr>
    <tr class="secTitle">
      <td >已认领表</td>
