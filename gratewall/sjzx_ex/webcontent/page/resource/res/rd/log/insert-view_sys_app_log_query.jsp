...
<freeze:body>
<freeze:title caption="增加日志查询信息"/>
<freeze:errors/>

<freeze:form action="/txn620100103">
  <freeze:block property="record" caption="增加日志查询信息" width="95%">
      ...
      <freeze:text property="username" caption="用户姓名" datatype="string" maxlength="100" style="width:95%"/>
