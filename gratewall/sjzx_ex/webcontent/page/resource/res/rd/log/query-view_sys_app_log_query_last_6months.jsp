...
function __userInitPage()
{
	...
	for (var i=0; i < operationSpan.length; i++){
		...
		if("系统管理"==types[i]){
			operationSpan[i].innerHTML = "<a title='查看日志' onclick='setCurrentRowChecked(\"record\");func_record_addRecord();' href='#'><div class='query'></div></a>";
		}
...
<freeze:body>
<freeze:title caption="查询最近半年日志查询列表"/>
<freeze:errors/>

<freeze:form action="/txn620100106">
  <freeze:block theme="query" property="select-key" caption="查询条件" width="95%">
      <freeze:text property="username" caption="用户账号" datatype="string" maxlength="100" style="width:90%"/>
    ...
    <freeze:datebox property="query_date_end" caption="操作时间" style="width:100%" colspan="0"/>
      ...
      <freeze:browsebox property="orgid" caption="所属机构" valueset="机构" show="name" style="width:90%"/>
...
<br />
  <freeze:grid property="record" caption="最近半年日志查询列表" keylist="username" width="95%" rowselect="false" navbar="bottom" fixrow="false" checkbox="false">
      ...
      <freeze:cell property="username" caption="用户账号" style="width:12%" align="center"/>
      <freeze:cell property="orgid" caption="所属机构" valueset="机构" style="width:25%" align="center"/>
      <freeze:cell property="type" caption="日志类型" valueset="操作类型" style="width:15%" align="center" />
