...
<freeze:body>
<freeze:title caption="修改基础数据元信息"/>
<freeze:errors/>

<freeze:form action="/txn7000302">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="sys_rd_standard_dataelement_id" caption="基础数据元ID" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改基础数据元信息" width="95%">
      <freeze:button name="record_saveAndExit" caption="保 存" hotkey="SAVE_CLOSE" onclick="func_record_saveAndExit();"/>
      <freeze:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      <freeze:hidden property="sys_rd_standard_dataelement_id" caption="基础数据元ID" datatype="string" maxlength="32" style="width:95%"/>
