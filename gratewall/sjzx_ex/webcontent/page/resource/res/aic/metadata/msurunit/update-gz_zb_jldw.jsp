...
<freeze:body>
<freeze:title caption="修改计量单位信息"/>
<freeze:errors/>

<freeze:form action="/txn301062">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="jldw_dm" caption="计量单位代码" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改计量单位信息" width="95%" columns="1" nowrap="true">
      <freeze:button name="record_saveAndExit" caption="保 存" hotkey="SAVE_CLOSE" onclick="func_record_saveAndExit();"/>
      <freeze:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      <freeze:text property="jldw_dm" caption="计量单位代码" validator="checkIt()" datatype="string" maxlength="4" minlength="4" readonly="true" style="width:95%"/>
