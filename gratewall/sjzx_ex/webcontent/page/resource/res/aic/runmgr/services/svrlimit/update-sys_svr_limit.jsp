...
<freeze:body>
<freeze:title caption="修改用户服务限制信息"/>
<freeze:errors/>

<freeze:form action="/txn50011702">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="sys_svr_limit_id" caption="用户服务限制主键" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改用户服务限制信息" width="95%">
      <freeze:button name="record_saveAndExit" caption="保 存" hotkey="SAVE_CLOSE" onclick="func_record_saveAndExit();"/>
      <freeze:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      <freeze:hidden property="sys_svr_limit_id" caption="用户服务限制主键" datatype="string" maxlength="32" style="width:95%"/>
