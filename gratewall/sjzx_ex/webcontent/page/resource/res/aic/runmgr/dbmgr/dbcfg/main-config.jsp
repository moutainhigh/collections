...
<freeze:body>
	...
	<freeze:errors />
		...
		<div id="step2DIV" style="display:none">
			...
			<p align="center">
				<input name="button" type="button" class="menu" id='toStepButton' onClick="toStep2();" value="下一步" />
				<input name="button" type="button" class="menu" id='goBack1' onClick="window.goBack();" value=" 返 回 " />
			</p>
		</div>
