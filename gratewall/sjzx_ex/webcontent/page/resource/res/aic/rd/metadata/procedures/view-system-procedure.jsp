...
<freeze:body>
<freeze:title caption="存储过程认领情况列表"/>
<freeze:errors/>
...
<freeze:form action="/txn80005000">
  ...
  <freeze:grid property="record" caption="存储过程认领情况列表"  nowrap="true" keylist="sys_rd_data_source_id" width="95%" navbar="bottom" fixrow="false" checkbox="false">
      <freeze:cell property="operation" caption="序号" style="width:3%"/>
      <freeze:cell property="db_name" caption="数据源名称" style="width:20%" />
      <freeze:cell property="total" caption="存储过程总数" style="width:20%" />
