...
<freeze:body>
<freeze:title caption="函数信息"/>
<freeze:errors/>

<freeze:form action="/txn80003104">
<freeze:block property="record" caption="函数信息" width="95%" columns="1">
		
        <freeze:cell property="unclaim_table_code" caption="函数名称:" />
        <freeze:cell property="remark" caption="函数用途:"  />
        <freeze:hidden property="object_script" caption="函数脚本:" />
    </freeze:block>
