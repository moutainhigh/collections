...
<freeze:body>
<freeze:title caption="查看函数信息"/>
<freeze:errors/>

<freeze:form action="/txn80004205">
<freeze:block property="record" caption="查看函数信息" width="95%" columns="1">
		<freeze:hidden property="object_schema" caption="用户:" />
		<freeze:cell property="sys_name" caption="主题名称:"  />
        <freeze:cell property="view_name" caption="函数名称:" />
        <freeze:cell property="view_use" caption="函数用途:" colspan="2" width="20%" />
        <freeze:hidden property="view_script" caption="函数脚本:" colspan="2" width="30%"/> 
    </freeze:block>
