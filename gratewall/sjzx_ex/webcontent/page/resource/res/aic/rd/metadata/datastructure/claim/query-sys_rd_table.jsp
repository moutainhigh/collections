...
{
	var page = new pageDefine( "/txn80002206.do", "查看已认领", "modal","600","450" );
	page.addParameter( "record:sys_rd_table_id", "primary-key:sys_rd_table_id" );
	page.updateRecord();
}
...
<br />
  <freeze:grid property="record" caption="查询已认领列表" keylist="sys_rd_table_id" width="95%" navbar="bottom"  fixrow="false" multiselect="false" onclick="func_record_columnRecord();" >
      ...
      <freeze:button name="record_editRelation" caption="维护表关系" txncode="80002606" enablerule="1" hotkey="" align="right" onclick="func_record_editRelation();" visible="false"/>
      ...
      <freeze:button name="record_updateRecord" caption="修改" txncode="80002204" enablerule="1" hotkey="UPDATE" align="right" onclick="func_record_updateRecord();"/>
      <freeze:button name="record_viewRecord" caption="查看" txncode="80002206" enablerule="1" hotkey="" align="right" onclick="func_record_viewRecord();"/>
      
      <freeze:cell property="table_code" caption="物理表" style="width:25%" ondblclick="func_record_columnRecord();"  />
      ...
      <freeze:cell property="sys_rd_system_id" caption="主题名称" valueset="业务主题" style="width:15%" ondblclick="func_record_columnRecord();" />
