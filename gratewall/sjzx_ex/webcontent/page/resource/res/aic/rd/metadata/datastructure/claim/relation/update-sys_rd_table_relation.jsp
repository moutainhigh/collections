...
<freeze:body>
<freeze:title caption="修改表关系信息"/>
<freeze:errors/>

<freeze:form action="/txn80002602">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="sys_rd_table_relation_id" caption="关联ID" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改表关系信息" width="95%">
