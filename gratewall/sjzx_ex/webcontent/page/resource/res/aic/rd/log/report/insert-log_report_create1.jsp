...
<freeze:form action="/txn620200106" enctype="multipart/form-data">
  <freeze:block property="record" caption="增加系统使用情况报告信息" width="95%">
      <freeze:button name="record_saveRecord" caption="上传"  hotkey="SAVE" onclick="func_record_saveAndExit();"/>
      ...
      <freeze:text property="report_name" caption="报告名称" colspan="2" style="width:95%"/>
      <freeze:file property="filename" caption="文件名" colspan="2" accept="*.doc,*.docx" style="width:98%"/>
