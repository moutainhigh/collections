...
<freeze:body>
<freeze:title caption="修改主题信息"/>
<freeze:errors/>

<freeze:form action="/txn8000112">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="sys_rd_system_id" caption="主键" style="width:95%"/>
  </freeze:frame>
  <freeze:block property="select-key"  width="95%">
  		<freeze:hidden property="db_type" caption="数据源类型" datatype="string" style="width:95%"/>
  		<freeze:hidden property="jndi_name" caption="JNDI" datatype="string" style="width:95%"/>
  		<freeze:hidden property="db_url" caption="数据源连接串" datatype="string" style="width:95%"/>
  		<freeze:hidden property="db_driver" caption="driver" datatype="string" style="width:95%"/>
  		<freeze:hidden property="db_username" caption="用户" datatype="string" style="width:95%"/>
  		<freeze:hidden property="db_password" caption="账号" datatype="string" style="width:95%"/>  		
  </freeze:block>
  <freeze:block property="record" caption="修改主题信息" width="95%">
      ...
      <freeze:radio property="isshow" caption="是否可用" valueset="布尔型数" style="width:90%"></freeze:radio>
