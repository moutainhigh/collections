...
<freeze:body>
<freeze:title caption="存储过程信息"/>
<freeze:errors/>

<freeze:form action="/txn80003104">
<freeze:block property="record" caption="存储过程信息" width="95%" columns="1">
		
        <freeze:cell property="unclaim_table_code" caption="存储过程名称:" />
        <freeze:cell property="remark" caption="存储过程用途:"  />
        <freeze:hidden property="object_script" caption="存储过程脚本:" />
    </freeze:block>
