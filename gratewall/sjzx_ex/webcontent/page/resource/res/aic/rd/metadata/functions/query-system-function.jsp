...
<freeze:html>
<head>
<title>查询已认领函数列表</title>
</head>

<script language="javascript">
function func_go_view()
{
	var page = new pageDefine( "/txn80004201.do", "函数管理" );
...
<freeze:form action="/txn80004200">
  ...
  <freeze:grid property="record" caption="函数认领情况列表" nowrap="true" keylist="sys_rd_data_source_id" width="95%" navbar="bottom" fixrow="false" multiselect="false">
  <freeze:button name="go_view" caption="函数管理" txncode="80004201" enablerule="1" align="right" onclick="func_go_view();"/>
