...
{
	var page = new pageDefine( "/txn20301021.do", "查询字段列表");
	page.addParameter("record:share_table_id","select-key:share_table_id");
	page.goPage();	
}
...
<freeze:form action="/txn20301001">
  ...
  <freeze:grid property="record" caption="查询共享表列表" checkbox="false" keylist="share_table_id" width="95%" navbar="bottom" onclick="getColumnList();" fixrow="true">

		 <freeze:hidden property="share_table_id" caption="共享表ID" style="width:10%" visible="false"/>
      <freeze:hidden property="business_topics_id" caption="业务主题ID" style="width:11%" />
      ...
      <freeze:hidden property="table_no" caption="表编号" style="width:11%" />
      <freeze:hidden property="show_order" caption="显示顺序" style="width:10%" />
      <freeze:hidden property="time_" caption="时间字段" style="width:10%" />
      <freeze:hidden property="table_type" caption="表类型" style="width:12%" />
      <freeze:hidden property="table_index" caption="表索引" style="width:20%" visible="false" />
