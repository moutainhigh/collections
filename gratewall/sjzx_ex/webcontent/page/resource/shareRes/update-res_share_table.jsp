...
<freeze:body>
<freeze:title caption="修改共享表信息"/>
<freeze:errors/>

<freeze:form action="/txn20301002">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="share_table_id" caption="共享表ID" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改共享表信息" width="95%">
