...
function func_record_saveAndExit()
{
	...
	var page = new pageDefine( "/txn20102021.ajax", "新增socket数据源" );
...
<freeze:form action="/txn20102021">
  <freeze:block property="record" caption="增加数据源信息" width="95%">
      ...
      <freeze:hidden property="data_source_type" caption="数据源类型"  value="04"  style="width:95%" />
      ...
      <freeze:textarea property="access_url" caption="访问URL" notnull="true" colspan="2" rows="2" maxlength="2000" style="width:98%"/>
