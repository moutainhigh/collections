...
{	
	...
	var page = new pageDefine( "/txn20102003.ajax", "新增database数据源" );
	...
	page.callAjaxService("DataBaseServiceCallBack");
}

function DataBaseServiceCallBack(errorCode, errDesc, xmlResults){
...
<freeze:form action="/txn20102003">
  ...
  <freeze:block property="record" caption="增加数据源信息" width="95%">
      ...
      <freeze:hidden property="data_source_type" caption="数据源类型" valueset="资源管理_数据源类型" value="01"  colspan="2" style="width:95%"  />
      ...
      <freeze:text property="db_instance" caption="数据库实例" datatype="string" maxlength="30" notnull="true" style="width:95%"/>
      ...
      <freeze:hidden property="access_url" caption="访问URL" datatype="string" maxlength="255"  style="width:98%"/>
