...
<freeze:form action="/txn20102006">
  ...
  <freeze:block property="record" caption="修改数据源表信息" width="95%">
      ...
      <freeze:cell property="db_type" caption="数据库类型" datatype="string"  style="width:95%"/>
      ...
      <freeze:textarea property="db_desc" caption="数据源描述" colspan="2" rows="4" maxlength="2000" readonly="true" style="width:98%"/>
