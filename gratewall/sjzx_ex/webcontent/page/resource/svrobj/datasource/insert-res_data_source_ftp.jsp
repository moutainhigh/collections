...
function func_record_saveAndExit()
{
	...
	var page = new pageDefine( "/txn20102007.ajax", "新增ftp数据源" );
	...
	page.callAjaxService("FTPCallBack");
}

function FTPCallBack(errorCode, errDesc, xmlResults){
...
<freeze:form action="/txn20102007">
  <freeze:block property="record" caption="增加数据源信息" width="95%">
      ...
      <freeze:hidden property="data_source_type" caption="数据源类型" valueset="资源管理_数据源类型" value="02" colspan="2"  style="width:95%" />
      ...
      <freeze:textarea property="access_url" notnull="true" caption="文件路径" title="文件路径要以‘/’开始和结束"  colspan="2" rows="2" maxlength="2000" style="width:98%"/>
