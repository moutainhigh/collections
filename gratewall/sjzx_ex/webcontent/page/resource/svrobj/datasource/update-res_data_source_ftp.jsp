...
<freeze:form action="/txn20102012">
  ...
  <freeze:block property="record" caption="修改数据源信息" width="95%">
      ...
      <freeze:browsebox property="service_targets_id" caption="所属服务对象" show="name" valueset="资源管理_服务对象名称"  onchange="setName();" notnull="true" maxlength="32" style="width:95%"/>
      <freeze:select property="data_source_type" caption="数据源类型" show="name" valueset="资源管理_数据源类型" readonly="true" style="width:95%"/>
      <freeze:text property="data_source_name" caption="数据源名称" notnull="true" datatype="string" maxlength="100" style="width:95%"/>
      ...
      <freeze:text property="access_url" notnull="true" caption="文件路径" colspan="2" title="文件路径要以‘/’开始和结束" maxlength="1000" style="width:98%"/>
