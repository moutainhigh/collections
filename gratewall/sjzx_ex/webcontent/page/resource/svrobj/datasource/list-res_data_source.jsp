...
<freeze:errors/>
 <gwssi:panel action="txn20102001" target="wstest" parts="t1,t2,t3" styleClass="wrapper">
  <gwssi:cell id="t1" name="数据源类型" key="data_source_type" data="dsType" />
  <gwssi:cell id="t2" name="服&nbsp;务&nbsp;对&nbsp;象" key="service_targets_type,service_targets_id" isGroup="true" data="svrTarget" pop="true"  maxsize="10" />
