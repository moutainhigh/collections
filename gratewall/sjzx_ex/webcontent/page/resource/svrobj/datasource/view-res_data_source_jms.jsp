...
<freeze:form action="/txn20102026">
  ...
  <freeze:block property="record" caption="查看数据源信息" width="95%">
      ...
      <freeze:cell property="db_password" caption="数据源密码"   datatype="string" style="width:95%"/>
      ...
      <freeze:cell property="req_que_name" caption="请求队列名称" datatype="string"  style="width:95%"/>
      <freeze:cell property="res_que_name" caption="接收队列名称" datatype="string"  style="width:95%"/>
      <freeze:cell property="access_url" caption="访问URL" datatype="string"  colspan="2" style="width:98%"/>
      ...
      <freeze:hidden property="db_type" caption="数据库类型" datatype="string"  style="width:95%"/>
      <freeze:hidden property="db_instance" caption="数据源实例" datatype="string"  style="width:95%"/>
