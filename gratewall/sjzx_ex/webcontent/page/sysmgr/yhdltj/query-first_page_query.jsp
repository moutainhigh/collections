...
function queryfo(){
	...
	var page = new pageDefine("/txn61000002.do", "详细信息","_blank");
...
<freeze:form action="/txn61000001">
  <freeze:block theme="query" property="select-key" caption="查询条件" width="95%">
      ...
      <freeze:text property="opername" caption="人员姓名" datatype="string" maxlength="24" style="width:95%"/>     
      <freeze:hidden property="orgcode" caption="登录用户机构" style="width:90%" />
  </freeze:block>
	<br />
  <freeze:grid property="record" caption="用户登录统计列表" keylist="username" width="95%" checkbox="false" navbar="bottom" fixrow="false" onclick="queryfo()">
      ...
      <freeze:cell property="count" caption="登陆次数" style="width:7%" />
      <freeze:cell property="sfyx" caption="用户状态" style="width:8%" />
      <freeze:hidden property="username" caption="用户账号" style="width:10%" />
