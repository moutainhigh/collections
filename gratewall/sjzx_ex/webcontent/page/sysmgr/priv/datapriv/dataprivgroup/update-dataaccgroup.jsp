...
{
	saveAndExit( '', '保存数据权限组管理' );	// /txn1030041.do
}

// 返 回
function func_record_goBack()
{
	goBack();	// /txn1030041.do
}
...
<freeze:body>
<freeze:title caption="修改数据权限组管理信息"/>
<freeze:errors/>

<freeze:form action="/txn1030042">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="dataaccgrpid" caption="数据权限分组ID" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改数据权限组管理信息" width="95%">
