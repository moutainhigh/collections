...
<freeze:form action="/txn807002">
  ...
  <freeze:block property="record" caption="修改用户信息2434" width="95%" >
    <freeze:button name="record_saveAndExit" caption="保存" txncode="807002" hotkey="SAVE" onclick="func_record_save_record();"/>
    ...
    <freeze:text property="jgname" caption="<font color='red'>*所属机构</font>" style="width:60%"  readonly="true" 
   ...
   <!-- <input type="button" name="orgchoice" value="选择" onclick="selectJG('tree','record:jgid_fk','record:jgname')" 
    class="menu"/>-->
	...
	<freeze:browsebox property="roleids" caption="角色" multiple="true" valueset="组织机构角色" show="name" namebox="rolenames" notnull="true" colspan="2" style="width:96%" />
