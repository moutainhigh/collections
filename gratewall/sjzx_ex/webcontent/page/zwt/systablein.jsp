	...
	<div id="container">
			<div class="wrap">
				...
				<div id="main">
				 ...
				 <div id="graph" style="font-size:10px;width:100%;padding-bottom:110px;padding-top:10px;text-align:center;float:left;overflow:hidden;background: #EBF0F5;"></div>
					...
					<script type="text/javascript">
							...
							d3.json("/page/zwt/json/systablein.json", function(X,Y) {
								var T = d3.map(Y);
								...
								script.setAttribute("src", "/page/zwt/js/conversation_systablein.min.js");
