	...
	<div id="container">
			<div class="wrap">
				...
				<div id="main">
				 ...
				 <div id="graph" style="width:100%;padding:50px;text-align:center;float:left;overflow:hidden;background: #EBF0F5;"></div>
					...
					<script type="text/javascript">
							...
							d3.json("/page/zwt/json/zwt_all.json", function(X,Y) {
								var T = d3.map(Y);
								...
								script.setAttribute("src", "/page/zwt/js/conversation_detail.min.js");
