        ...
        <table style="width:100%" cellPadding="0" cellspaceing="0">
             <Tr>
	             <Td width="50px" valign="top">
	               <a href="/page/zwt/MLPie_L1.jsp">第一层</a><Br/>
	               <a href="<%=link2%>&select-key:count_type=00">第二层</a>
	             </Td>
	             <Td>
	             <div style="font-size: 12px;font-weight: bold; ">
	             <label><input type="radio" name="fb_type" onclick="changeStatisticsType('00')" checked="checked" />共享数据量</label>
          		 <label><input type="radio" name="fb_type" onclick="changeStatisticsType('01')" />共享次数</label>
