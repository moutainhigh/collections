...
{
	var page = new pageDefine( "insert-rename_standard.jsp", "增加规则","modal" );
	page.addRecord();
}
...
{
	var page = new pageDefine( "/txn603014.do", "修改规则","modal");
...
function func_record_updateRecord(idx)
{
	...
	var page = new pageDefine( "/txn603014.do", "修改技术规则","modal" );
...
{
	var page = new pageDefine( "/txn603015.do", "删除规则" );
	page.addParameter( "record:standard_id", "primary-key:standard_id" );
...
{
	var svrId = getFormFieldValue("record:standard_id", idx);
	var page = new pageDefine( "/txn603018.do", "查看服务表","modal" );
	page.addValue( svrId, "primary-key:standard_id" );
	page.updateRecord();
}
...
<freeze:body>
<freeze:title caption="查询命名规则列表"/>
<freeze:errors/>

<freeze:form action="/txn603011">
  <freeze:block theme="query" property="select-key" caption="查询条件" width="95%">
      <freeze:text property="standard_name" caption="命名规范名称" datatype="string" maxlength="100" style="width:95%"/>
...
<br/>
 ...
 <freeze:cell property="@rowid" align="center" caption="序号" style="width:5%" />
      <freeze:cell property="standard_name" caption="命名规范名称" align="center" style="width:20%" />
      <freeze:cell property="enable_time" caption="发布日期" align="center" style="width:18%" />
