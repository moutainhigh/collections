...
{
	saveAndExit( '', '保存规则标准' );	// /txn604001.do
}
...
<freeze:form action="/txn603007" enctype="multipart/form-data">
  ...
  <freeze:block property="record" caption="修改规则信息" width="95%" >
      ...
      <freeze:cell property="standard_name" caption="技术规范名称" datatype="string"  colspan="2" style="width:98%"/>
