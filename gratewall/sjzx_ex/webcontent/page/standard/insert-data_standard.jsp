...
<freeze:form action="/txn603003"  enctype="multipart/form-data">
  <freeze:block property="record" caption="增加规则信息" width="95%"  >
      ...
      <freeze:text property="standard_name" caption="数据规范名称"  notnull="true" datatype="string" maxlength="100" colspan="2" style="width:98%"/>
      <freeze:select property="standard_type" caption="规范类型"  valueset="规范类型"  notnull="true" style="width:95%"/>
      <freeze:hidden property="specificate_type" caption="规则类型" datatype="string" value="1" maxlength="20" style="width:95%"/>
     <freeze:hidden property="specificate_status" caption="规范状态" datatype="string" maxlength="20" style="width:95%"/>
      ...
      <freeze:datebox property="enable_time" caption="启用时间" datatype="string" maxlength="11" prefix="<table width='100%' border='0' cellpadding='0' cellspacing='0'>
