...
{
	saveAndContinue( '', '保存技术规则标准' );
}

// 保存并关闭
function func_record_saveAndExit()
{
	saveAndGoNext( '', '保存技术规则标准', 'txn604001.do' );	// /
}
...
<freeze:form action="/txn603008" enctype="multipart/form-data">
  <freeze:block property="record" caption="增加规则信息" width="95%" >
     ...
     <freeze:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      ...
      <freeze:text property="standard_name" caption="技术规范名称"  notnull="true" datatype="string" maxlength="100" colspan="2" style="width:98%"/>
      <freeze:select property="standard_type" caption="规范类型"  valueset="规范类型"  notnull="true" style="width:95%"/>
      <freeze:hidden property="specificate_type" caption="规则类型" value="2" datatype="string" maxlength="20" style="width:95%"/>
