...
<freeze:form action="/txn603002" enctype="multipart/form-data">
  ...
  <freeze:block property="record" caption="修改规则信息" width="95%" >
      ...
      <freeze:cell property="standard_name" caption="数据规范名称" datatype="string"  colspan="2" style="width:98%"/>
      <freeze:cell property="standard_type" caption="规范类型" datatype="string" valueset="规范类型" style="width:95%"/>
      ...
      <freeze:cell property="enable_time" caption="启用时间" datatype="string"  prefix="<table width='100%' border='0' cellpadding='0' cellspacing='0'>
