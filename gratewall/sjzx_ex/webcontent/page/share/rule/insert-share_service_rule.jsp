...
{
	saveRecord( '', '保存共享服务访问规则表' );
}

// 保存并继续
function func_record_saveAndContinue()
{
	saveAndContinue( '', '保存共享服务访问规则表' );
}
...
<freeze:body>
<freeze:title caption="增加访问规则信息"/>
<freeze:errors/>

<freeze:form action="/txn403003">
  <freeze:block property="record" caption="增加访问规则信息" width="95%">
