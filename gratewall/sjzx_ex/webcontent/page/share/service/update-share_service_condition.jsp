...
<freeze:body>
<freeze:title caption="修改服务查询条件信息"/>
<freeze:errors/>

<freeze:form action="/txn40210002">
  <freeze:frame property="primary-key" width="95%">
      <freeze:hidden property="condition_id" caption="服务查询条件ID" style="width:95%"/>
  </freeze:frame>

  <freeze:block property="record" caption="修改服务查询条件信息" width="95%">
