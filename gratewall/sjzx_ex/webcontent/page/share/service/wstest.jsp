...
function collectResCallBack(errorCode, errDesc, xmlResults){
	...
	<%
		...
		String[] colNameEnArray = tmpMap.get("column_name_en")==null ? new String[0]:
			tmpMap.get("column_name_en").split(",");
		String[] colNameCnArray = tmpMap.get("column_name_cn")==null ? new String[0]:
			tmpMap.get("column_name_cn").split(",");
		
		System.out.println("这是访问新的接口");
		String param = XmlToMapUtil.map2Dom(map);
		GSGeneralWebService ws = new GSGeneralWebService();
		String dom = (String)ws.queryData(param);
