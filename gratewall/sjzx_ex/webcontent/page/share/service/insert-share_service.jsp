...
<!-- 
 ...
 -->
<freeze:body>
<freeze:title caption="增加服务表信息"/>
<freeze:errors/>
<freeze:form action="/txn40200009" enctype="multipart/form-data">
  <freeze:block property="record" caption="增加服务表信息" width="95%">
      ...
      <freeze:hidden property="limit_data" caption="限制条件"  style="width:98%"/>
      ...
      <freeze:hidden property="visit_period" datatype="string" />
       <freeze:text property="service_no" readonly="true" caption="服务编号" datatype="string" maxlength="20"  style="width:98%"/>
     <freeze:browsebox property="service_targets_id" caption="服务对象" notnull="true" valueset="资源管理_共享服务对象名称"  show="name" style="width:95%"/>
      <freeze:select property="service_type" caption="服务类型" valueset="资源管理_数据源类型" onchange="changeServiceType()" notnull="true" style="width:95%"/>
      <freeze:browsebox notnull="true" property="interface_id" caption="基础接口" onchange="getTableListByInterface()" valueset="共享服务_接口名称"  show="name" style="width:95%"/>
      <freeze:select property="service" caption="复制服务" onchange="setListByService()" style="width:95%"/>
      <freeze:text property="service_name" caption="服务名称" datatype="string" notnull="true" maxlength="100" style="width:95%"/>
      <freeze:select property="service_state" caption="服务状态" valueset="资源管理_归档服务状态" value="N" notnull="true" style="width:95%"/>
      <freeze:select property="is_single" caption="是否单户" valueset="是否单户"  style="width:95%"/>
      <freeze:textarea property="service_description" caption="服务说明" colspan="2" rows="1" maxlength="2000" style="width:95%"/>
      <freeze:textarea property="regist_description" caption="备案说明" colspan="2" rows="1" maxlength="2000" style="width:95%"/> 
      
      
      <freeze:file property="fjmc1" caption="说明附件" style="width:80%" maxlength="100" colspan="2" />&nbsp;<span class="btn_add" onclick="addNewRow()" title="增加"></span><table id="moreFile" width="100%"  cellspacing="0" cellpadding="0"></table>
  </freeze:block>
</freeze:form>
<br />
