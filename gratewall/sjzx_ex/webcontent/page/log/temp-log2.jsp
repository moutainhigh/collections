...
<freeze:form action="/txn601011">
  ...
  <freeze:text property="username" caption="资源名称" datatype="string" maxlength="24" style="width:95%"/>
      <freeze:select property="opername" caption="资源类型"   style="width:95%"/>
   
      <freeze:datebox property="creat_start_time" caption="操作时间" datatype="string" maxlength="30" prefix="<table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='45%'>" style="width:100%"/>
      </td><td width='5%'>&nbsp;至：</td><td width='45%'>
      <freeze:datebox property="creat_end_time" caption="操作时间" datatype="string" maxlength="30" style="width:100%" colspan="0"/>
