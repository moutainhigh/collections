...
function func_record_saveAndExit()
{
	//saveAndExit( '', '归档采集日志' );
	if(check()){
	var page = new pageDefine( "/txn6011013.ajax", "归档采集日志" );
...
<freeze:body>
	<freeze:title caption="归档采集日志" />
	<freeze:errors />

	<freeze:form action="/txn6011013">

		<freeze:block property="select-key" caption="修改功能大小类对应信息" width="95%">
