...
<freeze:body>
<freeze:title caption="增加数据增长信息"/>
<freeze:errors/>

<freeze:form action="/txn620100303">
  <freeze:block property="record" caption="增加数据增长信息" width="95%">
      ...
      <freeze:text property="table_class_id" caption="分类主键id" datatype="string" maxlength="40" style="width:95%"/>
