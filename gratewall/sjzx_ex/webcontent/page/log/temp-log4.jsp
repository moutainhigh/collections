...
<freeze:body>
<freeze:title caption="查询资讯管理日志列表"/>
...
<freeze:form action="/txn601011">
  <freeze:block theme="query" property="select-key" caption="查询条件" width="95%">
      ...
      <freeze:select property="opername" caption="报告类型"   style="width:95%"/>
   
      <freeze:datebox property="creat_start_time" caption="报告日期" datatype="string" maxlength="30" prefix="<table width='100%' border='0' cellpadding='0' cellspacing='0'><tr><td width='45%'>" style="width:100%"/>
      </td><td width='5%'>&nbsp;至：</td><td width='45%'>
      <freeze:datebox property="creat_end_time" caption="报告日期" datatype="string" maxlength="30" style="width:100%" colspan="0"/>
      </td><td width='5%'></td></tr></table>
       <freeze:text property="username" caption="报告名称" datatype="string" maxlength="24" style="width:95%"/>
  </freeze:block>
<br/>
