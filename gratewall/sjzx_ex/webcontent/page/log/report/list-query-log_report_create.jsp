...
<freeze:errors/>
<gwssi:panel action="txn620200192" target="wstest" parts="t1,t2,t3" styleClass="wrapper">
  <gwssi:cell id="t1" name="报告状态" key="state"  data="repState"   />
  <gwssi:cell id="t2" name="创建时间" key="create_date" data="created_time" date="true"/>
   <gwssi:cell id="t3" name="发布时间" key="publish_date" data="created_time" date="true"/>
