...
<freeze:html width="900" height="400">
<head>
<title>增加报告操作情况信息</title>
</head>
...
{
	saveRecord( '', '保存日志报告使用情况' );
}

// 保存并继续
function func_record_saveAndContinue()
{
	saveAndContinue( '', '保存日志报告使用情况' );
}
...
<freeze:body>
<freeze:title caption="增加报告操作情况信息"/>
<freeze:errors/>

<freeze:form action="/txn620200203">
  <freeze:block property="record" caption="增加报告操作情况信息" width="95%">
