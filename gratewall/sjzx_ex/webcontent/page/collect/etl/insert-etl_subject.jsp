...
function func_record_saveRecord()
{
	...
	save_flag = true;
	saveRecord( '', '保存etl任务表失败' );
}

// 保存并继续
function func_record_saveAndContinue()
{
	saveAndContinue( '', '保存etl任务表' );
}
...
<freeze:body>
<freeze:title caption="增加etl任务信息"/>
<freeze:errors/>

<freeze:form action="/txn30300003">
  <freeze:block property="record" caption="增加etl任务信息" width="95%">
