...
function func_record_saveRecord()
{
	...
	document.forms["CollectTaskUpdateForm"].setAttribute("action", "/txn30101014.do");
...
function func_record_getFunction()
{
	...
	var page = new pageDefine( "/txn30101017.do", "获取采集任务对应ftp文件");
	page.addParameter("record:collect_task_id","record:collect_task_id");
	page.addParameter("record:data_source_id","record:data_source_id");
	page.updateRecord();
}
...
<freeze:form action="/txn30101013" enctype="multipart/form-data">
  ...
  <freeze:block property="record" caption="修改采集任务信息" width="95%">
      ...
      <freeze:button name="record_getFtpFile" caption="获取文件" hotkey="SAVE" onclick="func_record_getFunction();"/>
