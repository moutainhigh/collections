...
function func_record_prevRecord(){
	var page = new pageDefine( "/txn30101042.do", "配置采集方法");
...
<freeze:form action="/txn301010344" enctype="multipart/form-data">
  ...
  <freeze:block property="record" caption="修改采集任务信息" width="95%">
      ...
      <freeze:button name="record_saveRecord" caption="保 存" hotkey="CLOSE" onclick="func_record_goBack_forSave();"/>
