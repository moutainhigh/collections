...
<freeze:form action="/txn30101035" enctype="multipart/form-data">
...
<br>
   <freeze:grid property="dataItem" caption="方法列表" keylist="database_task_id" multiselect="false" checkbox="false" width="95%"  fixrow="false" >
