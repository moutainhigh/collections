...
<freeze:form action="/txn30101031" enctype="multipart/form-data">
...
<freeze:file property="fjmc1" caption="备案文件" style="width:80%" maxlength="100" colspan="2" />&nbsp;<span class="btn_add" onclick="addNewRow()" title="增加"></span><table id="moreFile" width="100%"  cellspacing="0" cellpadding="0"></table>
 ...
 <br>
   <freeze:grid property="dataItem" caption="方法列表" keylist="database_task_id" multiselect="false" checkbox="false" width="95%" navbar="bottom" fixrow="false" >
      ...
      <freeze:hidden property="database_task_id" caption="任务ID"  />
      <freeze:hidden property="collect_task_id" caption="采集任务ID"  />
      <freeze:cell property="@rowid" caption="序号"  style="width:5%" align="center" />
      <freeze:cell property="collect_table" caption="目标采集表" style="width:20%" />
      <freeze:cell property="collect_mode" caption="采集方式" style="width:15%" />
      <freeze:cell property="source_collect_table" caption="源采集表"   style="width:15%" />
      <freeze:cell property="source_collect_column" caption="源采集字段" style="width:30%" />
