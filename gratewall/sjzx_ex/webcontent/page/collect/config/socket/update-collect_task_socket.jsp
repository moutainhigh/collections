...
function func_record_saveRecord(){
	...
	document.forms["CollectTaskUpdateForm"].setAttribute("action", "/txn30101053.do");
	saveRecord( '', '保存采集任务信息' );
	/**
...
function getParameter(){
   ...
   var collectType = "<%=ExConstant.TYPE_SJYLX_SOCKET%>";
...
function func_record_addRecord()
{
    ...
    if(collect_task_id==null||collect_task_id==""){
	 ...
	 var page = new pageDefine( "/txn30102007.do", "增加方法");
...
{
	var page = new pageDefine( "/txn30102008.do", "修改方法信息");
...
if(confirm("是否删除选中的记录")){
	var page = new pageDefine( "/txn30102011.do", "删除方法信息" );
	page.addValue(idx,"primary-key:webservice_task_id");
...
{
	var page = new pageDefine( "/txn30102010.do", "查看方法信息", "modal" );
	page.addValue(idx,"primary-key:webservice_task_id");
...
<freeze:form action="/txn30101052" enctype="multipart/form-data">
