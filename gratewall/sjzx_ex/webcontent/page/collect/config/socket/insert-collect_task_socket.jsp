...
function changeTarget()
{
	if (getFormFieldValue("record:service_targets_id") != null && getFormFieldValue("record:service_targets_id") != "")
	{
		...
		setFormFieldValue("record:task_name",name+"_SOCKET");
...
function func_record_addRecord()
{
	...
	//var page = new pageDefine( "/txn30102003.do", "增加方法", "modal" );
	//page.addValue(collect_task_id,"primary-key:collect_task_id");
	//page.addRecord();
	
	 var page = new pageDefine( "/page/collect/config/socket/insert-collect_webservice_task.jsp", "增加方法");
	 page.addRecord();
	}
...
<freeze:form action="/txn30101051" enctype="multipart/form-data">
...
<freeze:file property="fjmc1" caption="备案文件" style="width:80%" maxlength="100" colspan="2" />&nbsp;<span class="btn_add" onclick="addNewRow()" title="增加"></span><table id="moreFile" width="100%"  cellspacing="0" cellpadding="0"></table>
 ...
 <br>
   <freeze:grid property="dataItem" caption="方法列表" keylist="webservice_task_id" multiselect="false" checkbox="false" width="95%" navbar="bottom" fixrow="false" >
      ...
      <freeze:hidden property="webservice_task_id" caption="任务ID"  />
