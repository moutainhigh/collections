...
<freeze:errors/>
<gwssi:panel action="txn30101001" target="wstest" parts="t1,t2,t3,t4" styleClass="wrapper">
   <gwssi:cell id="t1" name="对象类型" key="service_targets_type,service_targets_id" isGroup="true" data="svrTarget" pop="true"  maxsize="10" />
   <gwssi:cell id="t2" name="采集类型" key="collect_type"  data="colType" />
   <gwssi:cell id="t3" name="任务状态" key="task_status"  data="taskStatus" />
   <gwssi:cell id="t4" name="创建时间" key="created_time" data="created_time" date="true"/>
</gwssi:panel>
