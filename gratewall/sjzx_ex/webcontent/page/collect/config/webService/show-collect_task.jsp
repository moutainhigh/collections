...
function func_record_goBack()
{
	...
	/* var page = new pageDefine( "/txn30101001.do", "查看方法信息");
	page.goPage(); */
	window.close();
}
...
<br>
   <freeze:grid property="dataItem" caption="方法列表" keylist="webservice_task_id" multiselect="false" checkbox="false" width="95%"  fixrow="false" rowselect="false">
