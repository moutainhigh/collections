var connectCondition4s = function(config){
	alert("connectConditionPlugin4s.js");
	if (!config.id){
...
// 添加事件
connectCondition4s.prototype.addEvent = function(){
	var p = this;
	// 选择表1时
 ...
 */
connectCondition4s.prototype.removeOptionFromSelect = function(selectId, optionValue){
...
// 默认选中columnTwo中的选项
connectCondition4s.prototype.setDefaultColumn = function(selectId, optionText){	
	var p = this;
...
// 初始化
connectCondition4s.prototype.init = function(){	
...
// 设置选择数据表
connectCondition4s.prototype.setDataFromSelect = function(selectId){
	var tableGhost = document.getElementById(this.id + "TableGhost");
...
// 获取表下的字段列表
connectCondition4s.prototype.getColumns = function(tableNo, columnSelectId){
	var p = this;
 ...
 * 添加一条表连接条件
 */
connectCondition4s.prototype.addConnCondition = function(){
	var p 	     = this;
...
connectCondition4s.prototype.deleteCondition = function(idx){
	var p = this;
 ...
 */
connectCondition4s.prototype.validateConnCondition = function(selectedTblId){
	var p = this;
	//获得“已选数据表”对象
 ...
 */
connectCondition4s.prototype.getTableId = function(){
	var p = this;
 ...
 * @return String
 */
connectCondition4s.prototype.getconnConditionStr = function(){
	var p = this;
	var paramStr = "";
 ...
 * @param 用来比较的JSON对象
 */
connectCondition4s.prototype.exist = function(obj){
	if(!obj){
		return false;
	}
	var p = this;
 ...
 * 清除所有连接条件
 */
connectCondition4s.prototype.Clear = function(){
	var p = this;
