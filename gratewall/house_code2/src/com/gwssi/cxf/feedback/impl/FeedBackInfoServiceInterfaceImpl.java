...
public class FeedBackInfoServiceInterfaceImpl implements
	...
	public String getFeedbackInfo(@WebParam(name="updateStartTime") String updateStartTime, 
										@WebParam(name="updateEndTime") String updateEndTime) {
		/**
		 * 返回参数说明：
	...
	@Override
	@WebResult(name="String")
	public String getFeedbackInfoById(@WebParam(name="id") String id) {
