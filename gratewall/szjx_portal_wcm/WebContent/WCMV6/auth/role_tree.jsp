...
//4.初始化（获取数据）	
	...
	String strDisabledRoles = CMyString.showNull(currRequestHelper.getString("DisabledRoles"));
...
<%!
	public String toTreeNavJavascript(User _currUser, String _sObjTreeName, boolean _isShowAll)throws WCMException {
        ...
        for (int i = 0; i < currRoles.size(); i++) {
            ...
            sResult += _sObjTreeName + ".addItem(\"" + CMyString.filterForJs(currRole.getName())
                    + "\", " + currRole.getId() + ", \"角色["
                    + PageViewUtil.toHtml(currRole.getName()) + "]\", getRoleNodeHref("
