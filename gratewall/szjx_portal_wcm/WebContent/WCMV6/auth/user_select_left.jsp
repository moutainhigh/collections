...
<TR>
    <TD align="left" valign="top" bgcolor="#FFFFFF">
		...
		<script src="group_tree.jsp?OperType=<%=PageViewConstants.TREE_OPERATION_GRPUSER_SEL_SPECIAL%>&TreeType=<%=nTreeType%>&ShowAll=0"></script>
	 </TD>
</TR>
<!--~- END ROW1 -~-->
</TABLE>
