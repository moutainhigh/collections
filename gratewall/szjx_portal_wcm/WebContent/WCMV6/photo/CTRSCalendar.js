...
// $Id: CTRSCalendar_Obj.js,v 1.1 2006/12/31 00:23:32 huxiejin Exp $
...
Calendar.dayMouseDblClick = function(ev) {
	...
	if(Calendar.extraDealOnDblClick){//huxiejin@2006-12-30
		Calendar.extraDealOnDblClick(calendar.sel.value);
	}
};
...
Calendar.cellClick = function(el, ev) {	
	...
	var newdate = false;
	var date = null;
	cal.daySelected = false;//wenyh 跳转
	if (typeof el.navtype == "undefined") {
		cal.daySelected = true;
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	function fixPosition(box) {
		...
		if (Calendar.is_ie) {
			br.y += document.body.scrollTop+40;//wenyh@2007-06-21 plus 40px,for show.
			br.x += document.body.scrollLeft;
		} else {
			br.y += window.scrollY+40;//wenyh@2007-06-21 plus 40px,for show.
			br.x += window.scrollX;
		}
