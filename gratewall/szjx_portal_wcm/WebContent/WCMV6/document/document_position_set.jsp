...
<INPUT TYPE="hidden" name="ChannelId" value="<%=nChannelId%>">
	<table width="100%" cellspacing="1" cellpadding="2" style="marging-top:10px; font-size:12px">
		<tr>
			<td align="left"> 为文档<font color=blue>[<%=currDocument.getTitle()%></font>]调整顺序:  </td> 
		</tr>
		<!--~--- ROW4 ---~-->
		<tr>
			<td>
				让文档处于频道[<font color=blue><%=currChannel.getName()%></font>]
				...
				<span id="DocumentOrderRegion" style="display:none">第<input type="text" name="DocOrder" value="<%=(nDocOrder+1)%>" style="border:1px gray solid;width:60px">位,(共<span class="num"><%=nSize%></span>篇文档)</span>
			</td>
		</tr>		
		<!--~- END ROW4 -~-->
		<!--~--- ROW5 ---~-->
