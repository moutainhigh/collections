...
<BODY <%if(!bIsReadOnly){%>onunload="UnLockMe();"<%}%>>
		...
		<td>
			<div class="editor_title">
				...
				<div class="top_bar_shuru">
					<input id="DocTitle" name="DocTitle" class="input_text" type="text" size="70" value="<%=sTitle%>" validation="max_len:'200',min_len:'1',type:'string',required:true,desc:'标题'" <%=sReadOnly%>/>
				</div>
				<div class="title_color" onclick="SetTitleColor(this);">
				<div class="title_color1"></div>
				<div id="title_color" class="title_color2" style="background-color:<%=sTitleColor%>;"></div>
				</div>
				<div class="document_option" style="display:<%=(bIsReadOnly)?"none":""%>">
				...
				<div class="document_option">类型
					<%=(bIsReadOnly)?getDocType(nDocType):getDocTypeSelector()%>
				</div>
				<div class="toolbar_sep"></div>
		...
		<td>
			<table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
				<tr>
						...
						<div style="width:100%;height:100%;display:">
							<table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
								<tr class="editor_body" align="center" valign="top">
									<td>
										<!--//文本型文档-->
										<div id="txt_editor" style="width:98%;height:98%;margin-top:5px;border:1px solid #b7b7a6;background:#FFFFFF;overflow:auto;display:none">
											<textarea id="_editorValue_" name="DocContent" style="width:100%;height:99.5%;border:0" <%=sReadOnly%>><%=sContent%></textarea>
										</div>
										<!--//链接型文档-->
										<div id="link_editor" style="border:1px solid #b7b7a6;width:500px;margin-top:100px;padding:20px;background:#FFFFFF;display:none">
											<table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
												<tr style="height:30px;" valign="top">
													<td align="center">
														<span style="float:left;line-height:30px;width:70px">链接地址:</span>
														<span style="float:left;margin:4px 0 0">
															<INPUT TYPE="text" id="DOCLINK" name="DOCLINK" style="width:248px" class="input_text" value="<%=sDocLink%>" <%=sReadOnly%>>
														</span>
													</td>
												</tr>
												<tr><td></td></tr>
										...
										<!--//文件型文档-->
										<div id="file_editor" style="border:1px solid #b7b7a6;width:500px;margin-top:100px;padding:20px;background:#FFFFFF;display:none">
											...
											<table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
												<tr style="height:30px;" valign="top">
													<td align="center">
														...
														<INPUT TYPE="<%=(bIsReadOnly)?"text":"file"%>" name="DocFile" style="width:320px" class="input_text" value="">
														<INPUT TYPE="button" name="uploadDocFile" style="width:60px;height:20px;margin-left:5px;display:<%=(bIsReadOnly)?"none":""%>" class="input_text" value="上传" onclick="UpdateDocFile();">
													</td>
												</tr>
												<tr style="height:30px;" valign="top" align="center">
													<td>
														...
														<span style="float:left;margin:4px 0 0">
															<INPUT TYPE="text" id="DOCFILENAME" name="DOCFILENAME" readonly=true style="width:248px" class="input_text" value="<%=sDocFileName%>" <%=sReadOnly%>>
														</span>
													</td>
												</tr>
												<tr><td></td></tr>
										...
										<table id="html_editor" border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;;display:none">
											...
											<tr>
												...
												<td class="editor_body" style="padding:15px;" valign="top">
													<iframe id="_trs_editor_" style="width:100%;height:100%" frameborder=0 allowTransparency="true" src="<%=(bIsReadOnly)?"../editor/trs_iframe_readonly.html":"../editor/trs_iframe.html"%>"></iframe>
												</td>
											</tr>
										</table>
									</td>
								</tr>
								<tr class="bottom_editor_toolbar" style="visibility:<%=(bIsReadOnly)?"hidden":"visible"%>">
								...
								<tr class="bottom_toolbar" style="visibility:<%=(bIsReadOnly)?"hidden":"visible"%>">
									<td align="center" valign="top" style="-moz-user-select:none;" onselectstart="return false;" ondragstart="return false;">
										...
										<script>
											...
											buttonGroup.addItem(new ButtonGroupItem("保存...",SaveExit,'bgr_icon save_exit','保存并退出'));
											buttonGroup.addItem(new ButtonGroupItem("保存并新建",SaveAddNew,'bgr_icon save_addnew','保存并新建'));
											<%if(bIsCanPub){%>
											buttonGroup.addItem(new ButtonGroupItem("发布并新建",PublishAddNew,'bgr_icon publish_addnew','发布并新建'));
											buttonGroup.addItem(new ButtonGroupItem("保存并发布",SavePublish,'bgr_icon save_publish','保存并发布'));
											<%}%>
											buttonGroup.draw();
											setTimeout(function(){
					...
					<td class="info_container" valign="top">
						<table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
							<tr class="attr_column_head" onclick="ShowAttrColumn('doc_basic');">
								<td>
									<div class="attr_column_title" id="doc_basic_attr_title">
										基本属性
									</div>
								</td>
							</tr>
									...
									<div style="width:100%;height:100%;overflow:auto;">
										<div style="padding:5px 0 0 5px">
											...
											<div class="attr_row">
												...
												<input type="text" name="DOCPEOPLE" value="<%=sOutlineTitle%>" validation="max_len:'200',type:'string',desc:'首页标题'" <%=sReadOnly%>>
												</span>
											</div>
											<div class="attr_row">
												<span class="attr_name">副标题:</span>
												<span class="attr_input_text" style="width:150px">
												<input type="text" name="SubDocTitle" value="<%=sDocSubTitle%>" validation="max_len:'200',type:'string',desc:'副标题'" <%=sReadOnly%>></span>
											</div>
											<div class="attr_row">
												<span class="attr_name">关键词:</span>
												<span class="attr_input_text" style="width:150px;">
												<input type="text" name="DOCKEYWORDS" value="<%=sDocKeyWords%>" validation="max_len:'200',type:'string',desc:'关键词'" <%=sReadOnly%>>
												</span>
											</div>
											<div class="attr_row" style="height:200px;">
												<span class="attr_name">摘要:</span>
												<span class="wcm_pointer" style="float:right;margin-right:15px;color:red;display:none">自动摘要</span>
												<div></div>
												<span class="attr_textarea"><textarea style="margin:0 5px" name="DocAbstract" cols="25" rows="10" validation="max_len:'1000',type:'string',desc:'摘要'" <%=sReadOnly%>><%=sDocAbstract%></textarea>
												</span>
											</div>
											<div class="attr_row">
												<span class="attr_name">来源:</span>
												<%if(bIsReadOnly){%>
												<span class="attr_input_text" style="width:150px;">
												<input type="text" value="<%=getDocSourceName(loginUser,nCurrDocSource)%>" <%=sReadOnly%>>
												</span>
												<%}else{%>
												<span class="attr_select">
											 <TRS_UI:EditableSelect id="docSource" fieldName="DocSource" value="<%=nCurrDocSource%>" options="getAllDocSources()" type="2" autovalid="false" newvalue="-1" validation="max_len:'50',type:'string',desc:'来源'" >
												</TRS_UI:EditableSelect>
												<script language="javascript">
												<!--
													function getAllDocSources(){
														return <%=getAllDocSourceJs(loginUser)%>;
													}
													UITransformer.transformAll($('docSource'));
												//-->
												</script>
												</span>
												<%}%>
							...
							<tr class="attr_column_head" onclick="ShowAttrColumn('doc_other');">
								<td>
									<div class="attr_column_title" id="doc_other_attr_title">
										其他属性
									</div>
								</td>
							</tr>
									...
									<div style="width:100%;height:100%;overflow:auto;">
										<div style="padding:5px 0 0 5px">
											<div class="attr_row">
												...
												<span class="attr_input_text" style="width:150px">
												<input type="text" name="DocAuthor" value="<%=sDocAuthor%>" validation="max_len:'50',type:'string',desc:'作者'" <%=sReadOnly%>>
												</span>
											</div>
											<div class="attr_row">
											...
											<div class="attr_row">
												...
												<span class="attr_table">
													...
													<TBODY id="attr_extendfield_tbody" >
														<%=showExtendFields(currExtendedFields,currDocument,strDBName,bIsReadOnly)%>
													</TBODY>
													</TABLE>
												</span>
											</div>
...
<%if(bIsCanTop){%>
							<tr class="attr_column_head" onclick="ShowAttrColumn('doc_settop');">
								<td>
									<div class="attr_column_title" id="doc_settop_attr_title">
										置顶设置
									</div>
								</td>
							</tr>
									...
									<div style="width:100%;height:100%;overflow:auto;">
										<div style="padding:5px 0 0 5px">
											<div class="attr_row">
												...
												<%}else{%>
												<%=bTopped?(bTopForever?"永久置顶":"限时置顶:"+dtTopValidTime):"未置顶"%>
												<%}%>
												</span>
											</div>
											<%if(!bIsReadOnly){%>
...
%>
							<tr class="attr_column_head" onclick="ShowAttrColumn('doc_publish');">
								<td>
									<div class="attr_column_title" id="doc_publish_attr_title">
										发布设置
									</div>
								</td>
							</tr>
									...
									<div style="width:100%;height:100%;overflow:auto;">
										<div style="padding:5px 0 0 5px">
											<div class="attr_row">
												...
												<span class="attr_name" style="width:16px;padding-top:0;float:left; margin-top: 5px;"><IMG border="0" style="cursor:pointer;display:<%=(bIsReadOnly)?"none":""%>" align="absmiddle" title="设置模板" src="../images/icon/TempSelect.gif" onclick="SelectTemps();"></span>
											...
											<div class="attr_row">
												<span class="attr_name" style="width:80px">定时发布<input type="checkbox" name="cb_publish_time" onclick="setPublishOnTime(this.checked);" style="display:<%=(bIsReadOnly)?"none":""%>" <%=(bDefineSchedule)?"checked":""%>>:</span>
												<%if(!bIsReadOnly){%>
												...
												<%}else{%>
													...
													<%=!bDefineSchedule?"未定义":strExecTime%>
													</span>
												<%}%>
											</div>
										</div>
