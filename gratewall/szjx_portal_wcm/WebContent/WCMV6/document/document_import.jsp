...
//						"SiteId" : getParameter("SiteId"),
					...
					//ge gfc add @ 2007-4-30 16:57 文档导入的目的地是栏目
					//因此只需传入栏目id，不需要传入站点id，应删除该字段
//					if(oPostData['SiteId'] != null) {
//						delete oPostData['SiteId'];
//					}
					...
					oHelper.Call('wcm6_document','importDocuments',oPostData,true,
						function(_transport,_json){
							...
							(top.actualTop||top).ReportsDialog.show(_json, '文档导入结果', function(){
								$dialog().hide();
