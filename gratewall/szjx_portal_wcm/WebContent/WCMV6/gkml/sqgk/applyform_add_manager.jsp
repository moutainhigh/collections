...
<%@include file="DepartmentConfigs.jsp"%>
...
//5.权限校验
	boolean bCanEditIdxId = false;
	boolean bCanEditDepartment = false;
	...
	if(nFlowDocId > 0) {
		...
		if(flowdoc == null) {
			throw new WCMException("处理流转文档失败！没有找到指定[FlowDocId=" + nFlowDocId + "]参数的工作流轨迹！");
		}
		bCanEditIdxId = sDGNodeName.equals(flowdoc.getNode().getName());
		bCanEditDepartment = sSCNodeName.equals(flowdoc.getNode().getName());
	}else{
...
<script language="javascript" src="DepartmentConfigs.js" type="text/javascript"></script>
<style type="text/css">
    .personTable td{
...
<BODY>
<div class="container" style="padding-left:5px;padding-top:0;">
    <!--div class="header">
...
<td align="right" id="td_top_nav" width="120" style="display:none">
...
<table border=0 cellspacing=0 cellpadding=0 style="border-left:1px solid silver;border-top:1px solid silver;width:100%;display:none;" id="applyerInfo_1">
    <tr>
...
<table border=0 cellspacing=0 cellpadding=0 style="border-left:1px solid silver;border-top:1px solid silver; width:100%;" id="applyerInfo_2">
    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("applyerName"), "&nbsp;")%>
													</div>	
												</td>
                                                <td class="label">工作单位</td>
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("department"), "&nbsp;")%>
													</div>	
												</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("certificateCode"), "&nbsp;")%>
													</div>	
												</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("telephone"), "&nbsp;")%>
													</div>	
												</td>
                                                <td class="label">邮政编码</td>
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("postCode"), "&nbsp;")%>
													</div>	
												</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("address"), "&nbsp;")%>
													</div>	
												</td>
                                                <td class="label">传真</td>
                                                <td>
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("fax"), "&nbsp;")%>
													</div>	
												</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
													<div class="normalText">
														<%=showEmpty(currApplyForm.getPropertyAsString("email"), "&nbsp;")%>
													</div>	
												</td>
                                            </tr>
                                        </tbody>
                                ...
                                <td>
                                    <table class="personTable" border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
                                        <tr>
                                            ...
                                            <td>
												<div class="normalText">
													<%=showEmpty(currApplyForm.getPropertyAsString("organizeCode"), "&nbsp;")%>
												</div>	
											</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
												<div class="normalText">
													<%=showEmpty(currApplyForm.getPropertyAsString("legalPerson"), "&nbsp;")%>
												</div>	
											</td>
                                            <td class="label">联系人姓名</td>
                                            <td>
												<div class="normalText">
													<%=showEmpty(currApplyForm.getPropertyAsString("associationPerson"), "&nbsp;")%>
												</div>	
											</td>
                                        </tr>
                                        <tr>
...
<table border=0 cellspacing=0 cellpadding=0 style="border-left:1px solid silver;width:100%;display:none" id="needInfo_1">
    <tr>
...
<table border=0 cellspacing=0 cellpadding=0 style="border-left:1px solid silver;width:100%;display:;" id="needInfo_2">
    <tr>
                    ...
                    <td> 
                        <table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
                            <tr>
                                ...
                                <td class="tdBorder">
									<div class="normalText" style="padding:2px 8px;">
										<%if(bCanEditIdxId){%>
											<input type="text" class="inputTag" name="input_IndexCode" value="<%=showEmpty(currApplyForm.getPropertyAsString("indexCode"), "")%>">
										<%}else{%>
											<%=showEmpty(currApplyForm.getPropertyAsString("indexCode"), "&nbsp;")%>
										<%}%>
									</div>	
                                </td>
                            </tr>
							<tr>
                                ...
                                <td class="tdBorder">
                                    <div class="normalText" style="padding:2px 8px;">
										<%if(bCanEditDepartment){%>									
										<select id="sel_DestDpt">
											<%
												for(int i = 0; i < arrDepts.length; i++){
													out.print("<option value='");
													out.print(arrDepts[i][0]);
													out.print("'>");
													out.print(arrDepts[i][1]);
													out.print("</option>");
												}
											%>
										</select>
										<script>
											$('sel_DestDpt').value = '<%=showEmpty(currApplyForm.getPropertyAsString("DestDpt"), "")%>';
										</script>
										<%}else{%>
											<%=showEmpty(currApplyForm.getPropertyAsString("DestDpt"), "&nbsp;")%>
										<%}%>
									</div>                    
                                </td>
                            </tr>
                            <tr>
                                <td style="width:80px;height:130px;text-align:center;" class="tdBorder">所需信息的<br>内容描述</td>
                                <td class="tdBorder" style="padding:8px;">
                                    <div class="textareaTag"><%=showEmpty(currApplyForm.getPropertyAsString("applyDesc"), "&nbsp;")%></div>                    
                                </td>
                            </tr>
                            <tr>
                                <td style="width:80px;height:70px;text-align:center;" class="tdBorder">所需信息的<br>用途</td>
                                <td class="tdBorder" style="padding:8px;">
                                    <div class="textareaTag"><%=showEmpty(currApplyForm.getPropertyAsString("purpose"), "&nbsp;")%></div>                    
                                </td>
                            </tr>
                        </table>
                    </td>
...
<table border=0 cellspacing=0 cellpadding=0 style="border-left:1px solid silver;width:100%;" id="dataContainer4">
    <tr>
        <td class="tdBorder RowLabel">信<br>息<br>处<br>理<br>情<br>况</td>
        <td>
			<FORM NAME="frmData" ID="frmData" action="applyform_add_manager_dowith.jsp" method="post" style="width:100%;height:100%;margin:0;">
			<input type="hidden" name="ApplyFormId" id="ApplyFormId" value="<%=currApplyForm.getId()%>">
			<input type="hidden" name="indexCode" value="<%=showEmpty(currApplyForm.getPropertyAsString("indexCode"), "")%>">
			<input type="hidden" name="DestDpt" value="<%=showEmpty(currApplyForm.getPropertyAsString("DestDpt"), "")%>">
            <table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
                <tr>
                    <td> 
                        <table border=0 cellspacing=0 cellpadding=0 style="width:100%;height:100%;">
                            <tr>
                                ...
                                <td class="tdBorder">
									<div class="normalText" style="padding:2px 8px;">
										...
										%>
										<span style="margin-right:20px;"><%=currApplyForm.getStatusName()%></span>		<%if(hasRight){%>								
										<a href="" onclick="setMailContent(<%=currApplyForm.getId()%>);">获取邮件默认回复信息</a>
										<%}%>
									</div>	
                                </td>
                            </tr>
                            <tr>
                                <td style="width:80px;height:300px;text-align:center;" class="tdBorder">回复内容</td>
                                <td class="tdBorder" style="padding:8px;">
									<%if(hasRight){%>
									<textarea class="textareaTag" name="mailBody" id="mailBody" style="border:1px solid gray;width:100%;display:none;"><%=CMyString.showEmpty(currApplyForm.getMailBody())%></textarea>
									<iframe id="mailBodyIframe" src="mailBodyIframe.html" style="width:100%;height:280px;"></iframe>
									<%}else{%>
										<%=CMyString.showEmpty(currApplyForm.getMailBody(), "&nbsp;")%>
									<%}%>
                                </td>
                            </tr>
							 <tr>
                                <td style="width:80px;height:50px;text-align:center;" class="tdBorder">材料附件<br>
								<%if(hasRight){%>
								<span onclick="doAppendixs();" style="color:red;cursor:pointer;">附件管理</span>
								<%}%>
								</td>
                                <td class="tdBorder" style="padding:8px;">
				...
				<input name="FlowDocId" type="hidden" id="hdFlowDocId">
...
<div id="dvFlowDocPanel" style="margin-left:5px;display:none; width:260px;height:98%;overflow-x:hidden;overflow-y: hidden;vertical-align:top;position:absolute;right:0px;top:73px;">
	<iframe id="frmFlowDoc" src="../../include/blank.html" frameborder="NO" border="0" width="100%" height="100%" scrolling="no" allowtransparency="1"></iframe>
</div>
</BODY>
</HTML>

<%!
	private String showEmpty(String sSrcStr, String sDefaultStr){
		if(sSrcStr == null || "".equals(sSrcStr.trim())){
			return sDefaultStr;
		}
		return sSrcStr;
	}
	private String displayAttachments(String _sAttachments){
		if(_sAttachments==null){
			return "";
		}
		return _sAttachments;
	}
