...
<script src="video_list.js" label="PageScope" desc="页面的描述文件"></script>
<!-- ~PageJavaScript END~    -->
...
<table id="table_body" class="wcm_table_layout" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<div style="float:left;" class="grid_row" grid_rowid="{#RecId}" right="{#Right}" docid='{#DocId}'>
...
<!-- 						<a href="javascript:window.open('./player.jsp?v={#ATTRIBUTE.TOKEN}', '_blank', 'width=640,height=480,location=yes');" title="{#DocTitle}">{#DocTitle}</a> -->
					</span>
				</div>
				<%--
				TODO need extra table?
				<div style="width:128px; overflow:hidden; white-space: nowrap; text-overflow:ellipsis;">
					<span>时长: {#ATTRIBUTE.DURATION}</span>
				</div>
				--%>
			</div>
