...
//	String uploadApp = "http://218.247.176.156:8080/fma";
	...
	String uploadUrl = uploadApp + "/servlets/upload";
%>
<div id="con" style="margin-top:5px;width:auto">
	
	<div id="dvUpd" style="margin-top:5px;width:auto" align="center">

		<div id="flashcontent">您的浏览器Flash环境有些问题导致该内容无法显示, 请尝试点击<a>这里</a>观看或<a>报告环境信息!</a></div>
		...
		<script type="text/javascript">
			...
			var so = new SWFObject("vUpload.swf", "flexApp", "420", "315", "9.0.28", "#FF6600");
			so.useExpressInstall('expressinstall.swf');
			so.addVariable("uploadUrl", "<%= uploadUrl %>");
			so.addVariable("maxSize", "104857600");
	...
	<!-- 
		<object id='flexApp' classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='420' height='315' 
		codebase='http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab' >
		<param name='flashvars' value='bridgeName=fa&uploadUrl=<%= uploadUrl %>&maxSize=104857600' />
		<param name='movie' value='vUpload.swf' />
	...
	<div style="margin-top:5px;" align="center">
		<span>1. 支持上传的视频格式：.avi | .dat | .mpg | .wmv | .asf | .rm | .rmvb | .mov | .flv | .mp4 | .3gp | .dv | .qt | .divx等</span><br>
		<span>2. 上传文件长度不能超过100MB.</span><br>
		<span>3. 上传过程中请不要关闭本页.</span>
	</div>
	<div id="dvMeta" style="margin-top:5px;" align="center">
	<form id="frmMeta" action="submit.jsp" method="post">
		...
		<div style="width:100%;height:100%;overflow:auto;">
			<div style="padding:5px 0 0 5px">
				...
				<div class="attr_row" align="center">
					...
					<span style="width:150px; overflow:hidden; border:#b7b7a6 1px solid;"><input type="text" ></span>  
					<span class="attr_input_text" style="width:150px"><input type="text" name="SubDocTitle" value="<%=sDocSubTitle%>"></span>
					-->
					<span>副标题:</span>
				...
				<div align="center">
					<input id="s" type="button" value="提交" disabled="disabled" onclick="javascript:saveMetaInfo();">
					<!--   -->
				</div>
			</div>
		</div>
