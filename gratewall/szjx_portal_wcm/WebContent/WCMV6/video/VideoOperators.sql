--- V6视频选件的数据库更新(SQLServer版)，主要包括对模板置标, 属性面板操作等数据表的更新
---created ls@2007-01-04 14:17
...
'videos', 38, 1, 1, 'admin', getdate()
from XWCMPAGEOPERATOR;

-- 针对 videoInChannel 的操作
delete from XWCMPAGEOPERATOR where OprKey='upload' and OprType='videoInChannel';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER,CrUser, CrTime)
select max(PAGEOPERATORID)+1, '新建视频', 'upload', '上传新视频', 'videoInChannel', 32, 1, 1, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='record' and OprType='videoInChannel';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER,CrUser, CrTime)
select max(PAGEOPERATORID)+1, '新建视频录制', 'record', '在线录制新视频', 'videoInChannel', 32, 1, 2, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='live' and OprType='videoInChannel';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER,CrUser, CrTime)
select max(PAGEOPERATORID)+1, '新建视频直播', 'live', '建立新的直播视频', 'videoInChannel', 32, 1, 3, 'admin', getdate()
from XWCMPAGEOPERATOR;
...
insert into WCMTAGBEANS(TAGBEANID, TAGNAME, TAGBEAN, TAGDESC, CRUSER, CRTIME, ENABLED) 
 ...
 '提取流媒体信息置标解析器', 'admin', getdate(), 1 from WCMTAGBEANS;
...
insert into WCMTAGBEANS(TAGBEANID, TAGNAME, TAGBEAN, TAGDESC, CRUSER, CRTIME, ENABLED) 
 ...
 '播放流媒体置标解析器', 'admin', getdate(), 1 from WCMTAGBEANS;
...
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '发布该视频', 'basicpublish', '发布该视频', 'video', 39, 1, 2, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='copy' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '复制该视频到...', 'copy', '复制该视频到...', 'video', 34, 1, 3, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='move' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '移动该视频到...', 'move', '移动该视频到...', 'video', 65, 1, 4, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='quote' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '引用该视频到...', 'quote', '引用该视频到...', 'video', 34, 1, 5, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='changeStatus' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '改变状态', 'changeStatus', '改变该视频的状态', 'video', 32, 0, 6, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='detailpublish' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '仅发布该视频的细览', 'detailpublish', '仅重新生成该视频的细览页面', 'video', 39, 0, 7, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='recallpublish' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '撤销发布该视频', 'recallpublish', '撤回已发布目录或页面', 'video', 39, 0, 8, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='trash' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '将该视频放入回收站', 'trash', '将该视频放入回收站', 'video', 33, 0, 9, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='export' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '导出视频文档信息', 'export', '导出视频文档信息', 'video', 34, 0, 10, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='play' and OprType='video';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1,  '播放该视频', 'play', '播放该视频', 
'video', 38, 0, 11, 'admin', getdate()
from XWCMPAGEOPERATOR;

-- 针对多个Video对象的操作
delete from XWCMPAGEOPERATOR where OprKey='basicpublish' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '发布这些视频', 'basicpublish', '发布这些视频', 'videos', 39, 1, 2, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='copy' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '复制这些视频到...', 'copy', '复制这些视频到...', 'videos', 34, 1, 3, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='move' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '移动这些视频到...', 'move', '移动这些视频到...', 'videos', 65, 1, 4, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='quote' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '引用这些视频到...', 'quote', '引用这些视频到...', 'videos', 34, 1, 5, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='changeStatus' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '改变这些视频的状态', 'changeStatus', '改变这些视频的状态', 'videos', 32, 0, 6, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='detailpublish' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '仅发布这些视频的细览', 'detailpublish', '仅重新生成这些视频的细览页面', 'videos', 39, 0, 7, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='recallpublish' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '撤销发布这些视频', 'recallpublish', '撤回已发布目录或页面', 'videos', 39, 0, 8, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='trash' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '将视频放入回收站', 'trash', '将视频放入回收站', 'videos', 33, 0, 9, 'admin', getdate()
from XWCMPAGEOPERATOR;

delete from XWCMPAGEOPERATOR where OprKey='export' and OprType='videos';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER, CrUser, CrTime)
select max(PAGEOPERATORID)+1, '导出视频文档信息', 'export', '导出视频文档信息', 'videos', 34, 0, 10, 'admin', getdate()
from XWCMPAGEOPERATOR;

-- 针对 videoInChannel 的操作
delete from XWCMPAGEOPERATOR where OprKey='import' and OprType='videoInChannel';
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER,CrUser, CrTime)
select max(PAGEOPERATORID)+1, '导入WCM视频文档', 'import', '导入已有的WCM视频文档', 'videoInChannel', 32, 0, 4, 'admin', getdate()
from XWCMPAGEOPERATOR;
...
insert XWCMPAGEOPERATOR(PAGEOPERATORID, OPRNAME, OPRKEY, OPRDESC, OPRTYPE, RightIndex, ISDISPLAY, OPRORDER,CrUser, CrTime)
select max(PAGEOPERATORID)+1, '新建视频直播', 'live', '建立新的直播视频', 'videoInSite', 32, 1, 1, 'admin', getdate()
from XWCMPAGEOPERATOR;
...
insert into WCMTAGBEANS(TAGBEANID, TAGNAME, TAGBEAN, TAGDESC, CRUSER, CRTIME, ENABLED) 
 ...
 '视频直播展示的置标解析器', 'admin', getdate(), 1 from WCMTAGBEANS;