...
<SCRIPT LANGUAGE="JavaScript">
	...
	$import('com.trs.wcm.domain.FieldInfoMgr');
...
<textarea name="objectTemplate" id="objectTemplate" rows="" cols="" style="display:none;">
    <div class="row">
        <span class="label">元数据别名：</span>
        <span class="value" id="tableAnotherName"></span>
    </div>    
    <div class="row">
        <span class="label">英文名称：</span>
        <span class="value">
            <input class="" type="text" name="fieldName" id="fieldName" value="{#MetaDBField.FieldName}" validation="type:'common_char2',required:'true',max_len:'30',no_desc:''">
        </span>
    </div>    
    <div class="row">
        <span class="label">中文名称：</span>
        <span class="value">
            <input type="text" name="anotherName" id="anotherName" value="{#MetaDBField.AnotherName}" validation="type:'string',required:'true',max_len:'100',no_desc:''">
        </span>
    </div>    
    <div class="row">
        <span class="label">字段类型：</span>
        <span class="value">
            <select name="fieldType" id="fieldType" initValue="{#MetaDBField.FieldType}">
				<%
					for(int i = 0, length = dataTypes.getDataTypesCount(); i < length; i++){
						MetaDataType dataType = dataTypes.getDataTypeAt(i);
    ...
    <div class="row" id="enmValueContainer" style="display:none;">
        ...
        <span class="value">
            <input type="text" name="enmValue" id="enmValue" value="{#MetaDBField.enmValue}" validation="type:'string',max_len:'200',no_desc:''" _title="格式为:item~item<br><span style='white-space:nowrap;overflow:visible;'>其中item为：label`value或label</span><br>如:<li>中国`1~美国`2~英国`3<br><li>中国~美国~英国<br><font color='red'>双击打开构造页面</font>">
        </span>
    </div>    
    <div class="row" id="classIdContainer" style="display:none;">
        <span class="label">分类法ID：</span>
        <span class="value">
            <input type="text" name="classId" id="classId" value="{#MetaDBField.CLASSID}" validation="showid:'validTip',rpc:'checkClassInfoValid'">
    ...
    <div class="row">
        ...
        <span class="value">
            <select name="dbType" id="dbType" initValue="{#MetaDBField.dbType}">
				<%
    ...
    <div class="row" id="dbLengthContainer" style="display:none;">
        ...
        <span class="value">
            <input type="text" name="dbLength" id="dbLength" value="{#MetaDBField.dbLength}" validation="type:'int',min:'1',no_desc:''" firstLoaded="true">
        </span>
    </div>    
    <div class="row" id="dbScaleContainer" style="display:none;">
        <span class="label">小数位数：</span>
        <span class="value">
            <input type="text" name="dbScale" id="dbScale" value="{#MetaDBField.DBScale}" validation="type:'int',min:'0',max:'38',no_desc:''">
        </span>
    </div>    
    <div class="row" id="defaultValueContainer">
        <span class="label">字段默认值：</span>
        <span class="value">
            <input type="text" name="defaultValue" id="defaultValue" value="{#MetaDBField.DefaultValue}" validation="type:'string',max_len:'100',no_desc:'',showid:'defaultValidTip'">
    ...
    <div class="row">
		...
		<span>
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="notNull" id="notNull" initValue="{#MetaDBField.NotNull}">
			</span><label for="notNull">不能为空</label>
		</span>
		<span style="margin-left:5px;">
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="notEdit" id="notEdit" initValue="{#MetaDBField.NotEdit}">
			</span><label for="notEdit">不能编辑</label>
		</span>	
		<span style="margin-left:5px;">
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="hiddenField" id="hiddenField" initValue="{#MetaDBField.hiddenField}">
			</span><label for="hiddenField">隐藏字段</label>
		</span>	
		<span style="margin-left:5px;">
			<span id="radioOrCheckContainer" style="display:none;">
				<input isBoolean="true" value="1|0" class="input_checkbox" type="checkbox" name="RADORCHK"  id="RADORCHK" initValue="{#MetaDBField.RADORCHK}"><label for="RADORCHK">单选树</label>
			</span>
		</span>	
    </div>    
    <div class="row" style="display:none;">
		...
		<span>
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="inOutline" id="inOutline" initValue="{#MetaDBField.inOutline}">
			</span><label for="inOutline">概览显示</label>
		</span>
		<span style="margin-left:5px;">
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="titleField" id="titleField" initValue="{#MetaDBField.titleField}" onclick="setTitleEvent(this);">
			</span><label for="titleField">标题字段</label>
		</span>
		<span style="margin-left:5px;">
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="searchField" id="searchField" initValue="{#MetaDBField.searchField}">
			</span><label for="searchField">检索字段</label>
		</span>		
		<span style="margin-left:5px;">
			<span>
				<input isBoolean="true" value="1|0" type="checkbox" class="input_checkbox" name="inDetail" id="inDetail" initValue="{#MetaDBField.inDetail}">
    ...
    <div class="row" style="display:none;">
        ...
        <span class="value">
            <input type="text" name="validator" id="validator" value="{#MetaDBField.Validator}">
