...
*/
	...
	if(sSiteIds == null && sChannelIds == null){
		throw new WCMException("没有指定要同步文档的站点或栏目ID[siteIds/channelIds]");
	}
	...
	out.println("本次同步涉及文档总数：[<b style='color:red;'>" + aResult[0] + "</b>]<br>");
	out.println("其中[<b style='color:red;'>" + aResult[1] + "</b>]篇没有权限处理<br>");
%>
