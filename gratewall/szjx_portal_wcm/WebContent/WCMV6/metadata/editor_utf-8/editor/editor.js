	...
	initView: function (sParentID) {
		...
		var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 495px; padding-left:2px;'>\
				<div id='EDiaryEditorToolBar' style='position: relative; width: 495px; height: 69px; background: url(images/editor/toolbar_bg.gif) -72;'>\
					<div id='EDiaryEditorFontFamilyMenu' title='字体' style='position: absolute; left: 8px; top: 12px; width: 92px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Family' unselectable='on'>字体</div>\
					<div id='EDiaryEditorFontSizeMenu' title='字号' style='position: absolute; left: 105px; top: 12px; width: 66px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Size' unselectable='on'>字号</div>\
					<div id='EDiaryEditorFontStyleMenu' title='段落' style='position: absolute; left: 173px; top: 12px; width: 66px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Style' unselectable='on'>段落</div>\
				</div>\
				<div style='height: 200px; width: 582px!important ; width: 495px;' id='EDiaryEditorContent'>\
					<iframe id='editor_body_area' name='editor_body_area' style='width: 455px!important ; width: 493px; height: 200px; border:1px solid #abc0db; overflow-x: atuo; display: nones;' frameborder='0'></iframe>\
...
//				{t: "22px",n:""},
					...
					if(key2 == 0) {// head
						_toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 6px; display: none;' id='EDiaryEditorFontFamilyItem'>\
								<div style=' height: 160px!important ;height: 160px; background-image: url(images/editor/menu_bg.gif);' id='EDiaryEditorFontFamilyBox'>\
						";
					}
					...
					if(key2 == 0) {// head
						_toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 103px; display: none;' id='EDiaryEditorFontSizeItem'>\
								<div style='height: 162px!important ;height: 160px; background-image: url(images/editor/menu_bg.gif);' id='EDiaryEditorFontSizeBox'>\
						";
					}
					if(key2 < _toolMenuInfo[key].length) {// body
	...
	insertFace: function (nFaceNum) {
		//wcm path
		var sPath = location.protocol + "//" + location.host + "/wcm/WCMV6/metadata/editor_utf-8/";
		var FacePath = sPath + "face/";
		this.iframe.contentWindow.focus();
