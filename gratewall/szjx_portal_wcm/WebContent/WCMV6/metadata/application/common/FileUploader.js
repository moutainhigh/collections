...
Object.extend(FileUploader.prototype, {
	uploadSrc					: '../common/file_upload.html',
	uploadDoWithSrc				: '../common/file_upload_dowith.jsp',
	...
	initialize : function(sRelateElement, fChangeEvent, fUploadedCallBack){
		...
		document.appendChild(this.oIframeElement);
	...
	onBrowse : function(){
		try{
			if(!this.oFileControl){
				...
				Event.observe(this.oFileControl, 'change', function(event){
