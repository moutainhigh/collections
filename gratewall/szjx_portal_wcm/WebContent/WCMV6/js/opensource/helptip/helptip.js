...
var helpTipHandler = {
	...
	create:	function () {
		...
		document.onclick = this.onDivBlur;
		document.body.appendChild(d);		
		this.helpTip = d;
	},
	onDivBlur : function(e){
		var el = helpTipHandler.helpTip;
		e = e || window.event;
		var t = e.srcElement;
		
		var bSrcIsAnchor = false
		if(t && t.tagName.toUpperCase() == 'A') {
			bSrcIsAnchor = true;
		}
		while(t && t != helpTipHandler.anchor &&  t != el && t != document.body){
			t = t.parentNode;
		}//*/
		if(t == helpTipHandler.anchor || t == el) {
			return bSrcIsAnchor;
		}
		//else
		try{
			helpTipHandler.hideHelpTip(helpTipHandler.anchor);	
		}catch (ex){
		}
	},
