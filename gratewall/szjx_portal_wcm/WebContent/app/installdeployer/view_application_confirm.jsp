...
<%
	if(!loginUser.isAdministrator()){
		throw new WCMException("您没有权限进行视图生成应用的操作！");
	}
	//还没有处理完成
...
<DIV class="row" id="content" style="">
	<div><font color="red">重新生成视图应用，会改变原来资源库中视图应用的页面，请先做好原视图应用的备份，再往下执行。</font><div>
	<div>视图应用的目录：wcm应用路径\app\application</div>
</DIV>
</body>
</html>