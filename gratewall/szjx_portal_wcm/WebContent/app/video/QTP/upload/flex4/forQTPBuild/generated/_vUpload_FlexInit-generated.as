...
public class _vUpload_FlexInit
{
   ...
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["sortFontSize", "lineHeight", "unfocusedTextSelectionColor", "kerning", "iconColor", "markerWidth", "textDecoration", "dominantBaseline", "adjustedRadius", "fontThickness", "depthColors", "blockProgression", "textAlignLast", "textAlpha", "itemRollOverColor", "rollOverColor", "fontSize", "shadowColor", "paragraphEndIndent", "fontWeight", "indicatorGap", "breakOpportunity", "leading", "symbolColor", "renderingMode", "paragraphStartIndent", "footerColors", "contentBackgroundColor", "paragraphSpaceAfter", "digitWidth", "ligatureLevel", "firstBaselineOffset", "itemDisabledColor", "fontLookup", "todayColor", "paragraphSpaceBefore", "separatorWidth", "fontFamily", "labelPlacement", "lineThrough", "alignmentBaseline", "trackingLeft", "separatorColor", "fontStyle", "dropShadowColor", "selectionColor", "dropdownBorderColor", "disabledIconColor", "textJustify", "focusColor", "alternatingItemColors", "typographicCase", "highlightColor", "textRollOverColor", "digitCase", "shadowCapColor", "inactiveTextSelectionColor", "justificationRule", "dividerColor", "trackingRight", "itemSelectionColor", "leadingModel", "selectionDisabledColor", "baseColor", "letterSpacing", "focusedTextSelectionColor", "baselineShift", "axisTitleStyleName", "fontSharpness", "barColor", "sortFontStyle", "modalTransparencyDuration", "justificationStyle", "contentBackgroundAlpha", "fontAntiAliasType", "textRotation", "errorColor", "direction", "cffHinting", "locale", "horizontalGridLineColor", "backgroundDisabledColor", "modalTransparencyColor", "textIndent", "themeColor", "verticalGridLineColor", "modalTransparency", "tabStops", "markerHeight", "headerColors", "textAlign", "sortFontWeight", "textSelectedColor", "labelWidth", "whiteSpaceCollapse", "fontGridFitType", "proposedColor", "disabledColor", "modalTransparencyBlur", "color", "sortFontFamily"];
