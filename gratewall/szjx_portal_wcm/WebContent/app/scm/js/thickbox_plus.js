...
function TB_show(caption, url) { //function called when the user clicks on a thickbox link
	try {
		...
		$("body").append("<div id='TB_load'><div id='TB_loadContent'><img src='images/loading3.gif' /></div></div>");
		$("#TB_overlay").show();
		...
		if(urlType == '.htm' || urlType == '.html'){//code to show html pages
			...
			ajaxContentH = TB_HEIGHT - 58;
			$("#TB_window").append("<div id='TB_closeAjaxWindow' style='border-bottom:1px solid #D7D7D7;background:#F0F0F0;height:26px;line-height:26px;'><div style='float:left;font-size:14px;padding-left:15px;color:#636363'>创建微博</div><a href='#' id='TB_closeWindowButton'>关闭</a></div><div id='TB_ajaxContent' style='overflow:hidden;background:#f0f0f0;border-top:1px solid #fff;width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'><div style='clear:both'></div></div>");
			$("#TB_closeWindowButton").click(TB_remove);
