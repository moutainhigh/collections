...
String[] pStatSQL = new String[] { 
	"select sum(COMMENTCOUNT) DataCount, AccountId"
...
Map oAccountDataMap = new HashMap<String, List>();
...
if(sPlatform.equals("all")){
	sTitle = nStatYear+ "年不同平台各帐号微博被评论率";
}else{
	String sPlatChineseName = PlatformFactory.getPlatform(sPlatform).getChineseName();
	sTitle = nStatYear+ "年"+sPlatChineseName+"平台各帐号微博被评论率";
}%>