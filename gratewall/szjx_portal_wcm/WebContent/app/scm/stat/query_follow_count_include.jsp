...
String[] pStatSQL = new String[] { "select FOLLOWERCOUNT, AccountId "
	+ " from XWCMMICROUSERSTATDATA"
	+ " where"
	+ " CrTime >=${StartTime}"
	+ " and CrTime <=${EndTime}"
	+ " order by ACCOUNTID ASC,CRTIME asc" };
