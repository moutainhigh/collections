...
<%
	...
	if(currOption == null){
		throw new WCMException(ExceptionNumber.ERR_OBJ_NOTFOUND, CMyString.format(LocaleServer.getString("option_pictrue_set.jsp.option_pictrue_set.jsp.notfindoptionid", "没有找到ID为{0}的选项！"), new int[]{nOptionId}));
	}
	int nGroupId = currOption.getGroupId();
	String sPictrueFile = currOption.getPicFileName();
%>
...
<head>
	...
	<title WCMAnt:param="option_pictrue_set.jsp.setoptionpicture">设置选项图片</title>
			...
			btns : [
				{
					...
					cmd : function(){
						...
						basicDataHelper.call("wcm61_advisorcenter","saveOption",{
							ObjectId : <%=nOptionId%>,
							GroupId : <%=nGroupId%>,
							PICTRUE : $('option_img_input').value
			...
			<table border=0 cellspacing=0 cellpadding=0 align="center" height="21" style="margin-top:5px;" width="120px">
				<tr>
					<td valign="top" align="center" width="60px">
						 <span style="padding-left:10px;padding-top:5px;cursor:pointer;" onclick="resumeThumb()"><img src="./zt-xj_an1.gif" border=0 alt="" /></span>
					</td>
					<td valign="top" align="right" width="60px"><IFRAME src="./public_pic_upload.jsp" frameborder="no" border="0" framespacing="0" width="50px" height="22px" scrolling="no" ></IFRAME></td>
				</tr>
			</table>
		</td>
	</tr>
