...
<head>
	...
	<title WCMAnt:param="option_select.jsp.optionselect"> 选择选项 </title>
		...
		<tr>
			...
			<td width="90" align="center">
				<div style="margin-top:25px; text-align:center; width:90px;">
					<input type="button" class="button" value="<%=LocaleServer.getString("option.select.jsp.addbtn","添加 >>")%>" style="width:90px" onclick="moveOptions('OptionsForSelect','OptionsSelected')">
					<br>
					<br>
					<input type="button" class="button" value="<%=LocaleServer.getString("option.select.jsp.removebtn","<< 移除")%>" style="width:90px" onclick="moveOptions('OptionsSelected','OptionsForSelect')">
				</div>
		</td>
			<td width="270">
				<div style="height:330px;overflow:hidden;width:270px;">
