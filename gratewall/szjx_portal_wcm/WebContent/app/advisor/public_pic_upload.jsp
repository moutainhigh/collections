...
<HEAD>
  ...
  <TITLE WCMAnt:param="public_pic_upload.jsp.uploadpic">上传图片</TITLE>
	<BASE TARGET="_self">
	<style type="text/css">
	<!--
		body{
...
<form id="frmPost" name="frmPost" action="./public_pic_upload_dowith.jsp" method="post" enctype="multipart/form-data">
	<!-- 上传按钮 @ BEGIN -->
		<div style="height:100%;cursor:pointer;width:40px;background-color:#FFFFFF;">
			<span><input type="file" id="MyFile" name="MyFile" onchange="uploadFile(this)" class="fileInput" hidefocus="true"><img src="./zt-xj_an2.gif" border=0 alt=""/></span>
		</div>
	<!-- 上传按钮 @ END -->
</form>
</BODY>
