...
(function()
{
	...
	//试图在IE中粘贴，剪切或复制命令执行。返回一个布尔值，表明操作成功。
	var execIECommand = function( editor, command )
	{
		...
		//以下似乎是唯一可靠的方法检测到剪贴板命令在IE中启用。
		//这将触发的onpaste/ oncut/ oncopy事件，只有在安全设置允许执行的命令。
	...
	//允许窥视剪贴板内容粘贴内容重定向到一个临时的bin和抓住它的内容。
	function getClipboardData( evt, mode, callback )
	{
		...
		// Create container(容器) to paste into
