...
(function()
{
	...
	{
		this.fire( 'beforeSetMode', { newMode : mode } );/*SJ--Fired before the editor mode is set.*/

		var data,
			holderElement = this.getThemeSpace( 'contents' ),/*SJ--Returns the DOM element that represents a theme space.*/ 
		...
		if ( this.mode )
		{
			...
			this.fire( 'beforeModeUnload' );/*SJ--Fired before changing the editor mode.*/
