...
CKEDITOR.plugins.add( 'sourcearea',
{
	...
	init : function( editor )
	{
				...
				editor.addMode( 'source',
					{
						load : function( holderElement, data )
						{
							...
							var styles =
							{
								...
								'text-align' : 'left',
								overflow:'auto',
								//兼容IE ff下td中嵌套iframe会多出3px边框的高度,(ff仅支持3px，无视3)
								'margin-bottom':(CKEDITOR.env.ie8Compat||CKEDITOR.env.gecko)?'3px':'0px'
							};
						...
						/*SJ--getSnapshotData():return iframe.getFrameDocument().getBody().getHtml();*/
		...
		editor.addCommand( 'source', sourcearea.commands.source );//调用init外的执行函数
