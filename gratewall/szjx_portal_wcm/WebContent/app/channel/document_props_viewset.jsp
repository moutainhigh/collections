...
<%
	...
	//2、获取到已设置的字段的值
	Channel currChannel = Channel.findById(nWebsiteId);
	if(currChannel == null){
...
window.m_fpCfg = {
	...
	function save(){
		...
		getHelper().JspRequest(WCMConstants.WCM6_PATH + "channel/document_props_viewset_dowith.jsp", oPostData,  true, function(transport, json){
			notifyFPCallback();
			FloatPanel.close();
		});
		return false;
