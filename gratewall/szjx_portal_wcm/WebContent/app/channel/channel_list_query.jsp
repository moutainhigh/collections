...
<td WCMAnt:param="channel_list.head.crtime" grid_sortby="crtime" width="120">创建时间</td>
<td width="40"><span WCMAnt:param="channel_list.head.edit">修改</span><%=getOrderFlag("edit", sCurrOrderBy)%></td>
<td width="80"><span WCMAnt:param="channel_list.head.increasingpublish">增量发布</span><%=getOrderFlag("increasingpublish", sCurrOrderBy)%></td>
