					...
					<TABLE width="680" height="300" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;background:gray;">
						<TR bgcolor="#FFFFFF">
							<TD width="191" valign="top">
								<iframe src="../include/blank.html" id="treeNav" allowtransparency="true" scrolling="auto" frameborder="0" style="width:191px;height:335px;"></iframe>
							</TD>
							<TD width="480">
...
var m_nRelationViewId = FloatPanel.dialogArguments.relationViewId;
window.m_fpCfg = {
	m_arrCommands : [{
		cmd : 'myClose',
		name : '保存'
