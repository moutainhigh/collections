...
Ext.apply(PageContext, {
	...
	initParams : {
		...
		"ChnlDocSelectFields" : "WCMChnlDoc.DOCKIND,WCMChnlDoc.DOCID,WCMChnlDoc.ChnlId,WCMChnlDoc.DocStatus,WCMChnlDoc.DocChannel,WCMChnlDoc.DocOrderPri,WCMChnlDoc.Modal,WCMChnlDoc.RecId,WCMCHNLDOC.CRTIME,WCMCHNLDOC.INVALIDTIME",
...
PageContext.addGridFunctions({
	...
	'chnldoc_edit' : function(event){//单击列表上标题链接时执行的操作
	...
	'open_channel' : function(event){//单击列表上栏目链接时执行的操作
		var channelid;
