function renderUploadFlash(cfg){
	...
	var settings = {
		...
		button_width: "85",
		button_height: "18",
		button_action: SWFUpload.BUTTON_ACTION.SELECT_FILE,/*一次只能上传一个文件*/
...
function fileQueueError(file, errorCode, message) {
	try {
		...
		case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
			progress.setStatus("图片不符合规范，请上传符合规范的图片.");
