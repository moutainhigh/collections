	...
	<div class="layout_container">
		<div class="layout_north">
			...
			<div class="editor_header" id="editor_header">
				...
				<div class="document_option" style=""><span WCMAnt:param="document_addedit.jsp.form">所属</span>
					<%=getDocFormSelector()%>
				</div>
				<div class="toolbar_sep"></div>
				<div class="document_option"><span WCMAnt:param="document_addedit.jsp.type">类型</span>
					<%=getDocTypeSelector()%>
				</div>
				<!--
				<div class="toolbar_sep"></div>
