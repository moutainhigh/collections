...
<head>
	...
	<script src="base_classinfo_list.js"></script>

	<link href="../css/thumb_list_common.css" rel="stylesheet" type="text/css" />
	<link href="base_classinfo_list.css" rel="stylesheet" type="text/css" />
	<style type="text/css">
		.toolbar{float:left;}
		...
		<div class="header">
			<div class="oper_field">
				...
				<div class="querySearch" id="querySearch">
					<form method="post" id="search_form" action="base_classinfo_list.jsp">
			...
			<!-- 描述信息区域 -->
			<div class="desc">您可以管理以下分类中的资源:</div>
		</div>
