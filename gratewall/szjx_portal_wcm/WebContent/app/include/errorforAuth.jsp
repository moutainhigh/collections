...
sErrDetail = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrDetail : LocaleServer.getString("errorforAuth.jsp.syserror", "系统出现错误");
sErrMsg = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrMsg : LocaleServer.getString("errorforAuth.jsp.syserror", "系统出现错误");
out.clear();
...
<META http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<TITLE WCMAnt:param="error.jsp.trswcmsystemtipinfo">TRS WCM系统提示信息</TITLE>
...
<div class="layout_container layout_bordercontainer">
	<div class="layout_north" align="center">
		...
		<SPAN class="font_redbold style7"><span WCMAnt:param="error.jsp.tip">系统提示信息</span>: &nbsp;&nbsp;<div id="errorMessage" style="display:inline;"><%=CMyString.transDisplay(sErrMsg)%></div></SPAN> 
		(<A id="id_linkShowDetail" href="#" class="navigation_page_link" onclick="showDetail();return false;" WCMAnt:param="error.jsp.showDetail">显示详细信息</A>)
	</div>
	<div class="layout_center_container">
	<div id="id_spanErrDetail" class="layout_center">
		<UL>
			<li><font color="#000000"><b WCMAnt:param="error.jsp.errNo">错误编号：</b></font><span id="errorNumber"><%=nErrNo%></span></li>
			<li><font color="#000000"><b WCMAnt:param="error.jsp.errType">错误类型：</b></font><span id="errorType"><%=sErrType%></span></li>
