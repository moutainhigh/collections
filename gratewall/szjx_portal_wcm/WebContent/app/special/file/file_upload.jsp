...
<HEAD>
  ...
  <TITLE WCMAnt:param="file_upload.jsp.title">上传缩略图</TITLE>
	<BASE TARGET="_self">
	<style type="text/css">
	<!--
		body{
...
<form id="frmPost" name="frmPost" action="./file_upload_dowith.jsp" method="post" enctype="multipart/form-data">
	<!-- 上传按钮 @ BEGIN -->
