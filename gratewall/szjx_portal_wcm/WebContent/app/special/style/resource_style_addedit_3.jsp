<div class="example">
	...
	<div class="example_image">
		<img src="./css_template/resource_template_3.gif" border=0 alt="" width="395px">
	</div>
	...
	<div class="design_container">
		...
		<div class="base_set_box" id="base_set_box">
			...
			<!-- 边框 @ BEGIN -->
				<div class="fieldset_box">
					<div class="fieldset_box_head">
						<div class="fieldset_box_head_left" WCMAnt:param="resource_style_addedit_common.jsp.secondframe">2、边框</div>
					</div>
					<div class="fieldset_box_body">
						<div class="fieldset_box_content">
							<table border=0 cellspacing=0 cellpadding=0 width="100%">
								<tr>
									<td class="set_title" style="width:90px"  WCMAnt:param="resource_style_addedit_common.jsp.leftframebgpic">左边框背景图：</td>
									<%
										String p_w_body_background = getStyleItemValue(hmResStyleItemMap,"p_w_body_background");
										p_w_body_background = CMyString.showNull( p_w_body_background, "" );
									%>
									<td class="set_value">
										<input type="hidden" name="p_w_body_background" id="p_w_body_background" value="<%=CMyString.filterForHTMLValue(p_w_body_background)%>" ParamType="StyleItem" >
										<span style="vertical-align:middle;">
										<iframe src="./image_for_style_upload.jsp?InputId=p_w_body_background&FileUrl=<%=CMyString.filterForHTMLValue(p_w_body_background)%>&ImageUploadPath=<%=CMyString.filterForHTMLValue(sImageUploadPath)%>" frameborder="no" border="0" framespacing="0" class="fileuploadiframe" scrolling="no" id="p_w_body_background_iframe" name="p_w_body_background_iframe"></iframe>
										</span>
										<span style="vertical-align:middle;display:inline-block;" class="resumeBgImg">
											<span style="display:inline-block;cursor:pointer;height:27px;vertical-align:middle;" onclick="resumeBgImg('p_w_body_background')"><img src="../images/zt-xj_an1.gif" border=0 alt="" /></span>
										</span>
									</td>
								</tr>
								<tr>
									<td class="set_title" style="width:90px"  WCMAnt:param="resource_style_addedit_common.jsp.rightframebgpic">右边框背景图：</td>
									<%
										String p_w_body_bg_background = getStyleItemValue(hmResStyleItemMap,"p_w_body_bg_background");
										p_w_body_bg_background = CMyString.showNull( p_w_body_bg_background, "" );
									%>
									<td class="set_value">
										<input type="hidden" name="p_w_body_bg_background" id="p_w_body_bg_background" value="<%=CMyString.filterForHTMLValue(p_w_body_bg_background)%>" ParamType="StyleItem" >
										<span style="vertical-align:middle;"><iframe src="./image_for_style_upload.jsp?InputId=p_w_body_bg_background&FileUrl=<%=CMyString.filterForHTMLValue(p_w_body_bg_background)%>&ImageUploadPath=<%=CMyString.filterForHTMLValue(sImageUploadPath)%>" frameborder="no" border="0" framespacing="0" class="fileuploadiframe" id="p_w_body_bg_background_iframe" name="p_w_body_bg_background_iframe" scrolling="no"></iframe>
										</span>
										<span style="vertical-align:middle;display:inline-block;" class="resumeBgImg">
											<span style="display:inline-block;cursor:pointer;height:27px;vertical-align:middle;" onclick="resumeBgImg('p_w_body_bg_background')"><img src="../images/zt-xj_an1.gif" border=0 alt="" /></span>
										</span>
									</td>
								</tr>
							</table>
			...
			<!-- 尾部 @ BEGIN -->
				<div class="fieldset_box">
					<div class="fieldset_box_head">
						<div class="fieldset_box_head_left" WCMAnt:param="resource_style_addedit_common.jsp.thirdtail">3、尾部</div>
					</div>
					<div class="fieldset_box_body">
						<div class="fieldset_box_content">
							<table border=0 cellspacing=0 cellpadding=0 width="100%">
								<tr>
									<td class="set_title" style="width:90px"  WCMAnt:param="resource_style_addedit_common.jsp.height">高度：</td>
									<%
										String p_w_foot_height = getStyleItemValue(hmResStyleItemMap,"p_w_foot_height");
										p_w_foot_height = CMyString.showNull( p_w_foot_height, "1px" );
									%>
									<td class="set_value">
										<input type="text" class="inputtext" name="p_w_foot_height" value="<%=p_w_foot_height%>" validation="desc:'高度输入内容',required:true,type:'string',max_len:30,format:/(^[1-9]\d*|^0)(px|pt|em)$/,warning:'<%=LocaleServer.getString("resource_style_addedit_translate.jsp.heightformatbeintandunitptempx","高度格式必须为:整数+单位(pt/em/px)")%>',showid:'p_w_foot_height_mgr'" ParamType="StyleItem"   validation_desc="高度输入内容" WCMAnt:paramattr="validation_desc:resource_style_addedit_common.jsp.heightinputcontent"><span id="p_w_foot_height_mgr"></span>
									</td>
								</tr>
								<tr>
									<td class="set_title" style="width:90px" WCMAnt:param="resource_style_addedit_common.jsp.leftbgpic">左侧背景图：</td>
									<%
										String p_w_foot_background = getStyleItemValue(hmResStyleItemMap,"p_w_foot_background");
										p_w_foot_background = CMyString.showNull( p_w_foot_background, "" );
									%>
									<td class="set_value">
										<input type="hidden" name="p_w_foot_background" id="p_w_foot_background" value="<%=CMyString.filterForHTMLValue(p_w_foot_background)%>" ParamType="StyleItem" >
										<span style="vertical-align:middle;">
										<iframe src="./image_for_style_upload.jsp?InputId=p_w_foot_background&FileUrl=<%=CMyString.filterForHTMLValue(p_w_foot_background)%>&ImageUploadPath=<%=CMyString.filterForHTMLValue(sImageUploadPath)%>" frameborder="no" border="0" framespacing="0" scrolling="no" class="fileuploadiframe" id="p_w_foot_background_iframe" name="p_w_foot_background_iframe"></iframe>
										</span>
										<span style="vertical-align:middle;display:inline-block;" class="resumeBgImg">
											<span style="display:inline-block;cursor:pointer;height:27px;vertical-align:middle;" onclick="resumeBgImg('p_w_foot_background')"><img src="../images/zt-xj_an1.gif" border=0 alt="" /></span>
										</span>
									</td>
								</tr>
								<tr>
									<td class="set_title" style="width:90px" WCMAnt:param="resource_style_addedit_common.jsp.rightbgpic">右侧背景图：</td>
									<%
										String p_w_foot_bg_background = getStyleItemValue(hmResStyleItemMap,"p_w_foot_bg_background");
										p_w_foot_bg_background = CMyString.showNull( p_w_foot_bg_background, "" );
									%>
									<td class="set_value">
										<input type="hidden" name="p_w_foot_bg_background" id="p_w_foot_bg_background" value="<%=CMyString.filterForHTMLValue(p_w_foot_bg_background)%>" ParamType="StyleItem" >
										<span style="vertical-align:middle;">
										<iframe src="./image_for_style_upload.jsp?InputId=p_w_foot_bg_background&FileUrl=<%=CMyString.filterForHTMLValue(p_w_foot_bg_background)%>&ImageUploadPath=<%=CMyString.filterForHTMLValue(sImageUploadPath)%>" frameborder="no" border="0" framespacing="0" class="fileuploadiframe" id="p_w_foot_bg_background_iframe" name="p_w_foot_bg_background_iframe" scrolling="no"></iframe></span>
										<span style="vertical-align:middle;display:inline-block;" class="resumeBgImg">
											<span style="display:inline-block;cursor:pointer;height:27px;vertical-align:middle;" onclick="resumeBgImg('p_w_foot_bg_background')"><img src="../images/zt-xj_an1.gif" border=0 alt="" /></span>
										</span>
									</td>
								</tr>
							</table>
			...
			<!-- 内容 @ BEGIN -->
				<div class="fieldset_box">
					<div class="fieldset_box_head">
						<div class="fieldset_box_head_left" WCMAnt:param="resource_style_addedit_common.jsp.fourthcontent">4、内容</div>
					</div>
					<div class="fieldset_box_body">
						<div class="fieldset_box_content">
							<table border=0 cellspacing=0 cellpadding=0 width="100%">
			...
			<!-- 内容背景图 @ BEGIN -->
				<div class="fieldset_box">
					<div class="fieldset_box_head">
						<div class="fieldset_box_head_left" style="width:100px;" WCMAnt:param="resource_style_addedit_common.jsp.fifthcontentbgpic">5、内容背景图</div>
					</div>
					<div class="fieldset_box_body">
						<div class="fieldset_box_content">
							<table border=0 cellspacing=0 cellpadding=0 width="100%">
						...
						<div class="fieldset_box_content">
							<table border=0 cellspacing=0 cellpadding=0 width="100%">
								...
								<tr>
									...
									%>
									<td class="set_value">
										<input type="text" name="p_w_title_padding_top" ParamType="StyleItem" value="<%=p_w_title_padding_top%>" validation="desc:'间距输入内容',required:false,type:'string',max_len:30,format:/(^[1-9]\d*|^0)(px|pt|em)$/,warning:'<%=LocaleServer.getString("resource_style_addedit_translate.jsp.upspacingformatintunitptempx","上间距格式必须为:整数+单位(pt/em/px)")%>',showid:'p_w_title_padding_top_mgr'"  validation_desc="间距输入内容" WCMAnt:paramattr="validation_desc:resource_style_addedit_common.jsp.consultinputcontent"><span id="p_w_title_padding_top_mgr"></span>
									</td>
								</tr>
								<tr>
