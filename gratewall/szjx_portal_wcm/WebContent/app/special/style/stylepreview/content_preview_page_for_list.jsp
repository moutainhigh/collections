...
<%
	...
	if(oContentStyle == null){
		throw new WCMException("获取资源类型[Id:"+ nContentStyleId+"]失败");
	}
	String sCssFlag = oContentStyle.getCssFlag();
	//3、获取预览样式
	processor.reset();
	String sPreViewCssContent = (String)processor.excute("wcm61_contentstyle","makePreviewCssContent",parameters);
...
<div class="p_index_doc_list ">
	<div class="p_w_box">
		<h2 class="p_w_head">
			<span class="p_w_title"><a href="#" target="_blank">文档列表</a></span>
		...
		<div class="p_w_body">
			...
			<!-- content begin -->
				<div class="p_w_content_box">
					<div class="p_w_content <%=sCssFlag%>">
						<h1>没有找到符合条件的文档</h1>
						<ul>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#" >穆里尼奥：弗格森卫冕欧冠将成史上最伟大</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line"></li>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#">马队向圣西罗看台竖中指？ 告别夜他被谁激怒(图)</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line"></li>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#">印度官员闪电出访斯里兰卡要跟中国争影响力</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line"></li>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#">俄决定订购48架苏-35战机 空军编号苏-27SM2</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line"></li>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#">巴军方称绝对不允许恐怖分子靠近中巴公路(图)</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line"></li>
							<LI class=p_doc_title_li><SPAN class=p_doc_title><A href="#">乌允许俄续用航母飞行员训练场 曾计划租给中国</A></SPAN><SPAN class=datetime>09-05-25</SPAN><span class='doc_new_icon'></span></LI><li class="c_line c_last_line"></li>
						</ul>
					</div>
				</div>
			<!-- content end -->
