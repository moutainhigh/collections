...
<%
	...
	// 2 将文件拷贝到正式目录中
	if (sFileFlag != FilesMan.FLAG_WEBFILE) {
		sSaveFileName = oFilesMan.copyWCMFile(sSaveFileName,
				FilesMan.FLAG_WEBFILE);
		sSaveFileHttpDir = oFilesMan.mapFilePath(sSaveFileName,FilesMan.PATH_HTTP);
		sSaveFileHttpPath = sSaveFileHttpDir+sSaveFileName;
	}
...
<HEAD>
	...
	<TITLE WCMAnt:param="public_thumb_upload_dowith.jsp.title">缩略图处理页面</TITLE>
</HEAD>
<BODY>
<script>
	...
	%>
	window.location.href="./public_thumb_upload.jsp";
</script>
</BODY>
</HTML>