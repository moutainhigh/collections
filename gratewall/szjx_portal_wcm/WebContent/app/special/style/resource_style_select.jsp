...
<div class="rstyle_box" id="rstyle_box">
	...
	%>
	<div class="thumb" id="thumb_item_<%=nRowId%>" itemId="<%=nRowId%>" title="编号:&nbsp;<%=nRowId%>&#13;资源风格名称:&nbsp;<%=CMyString.filterForHTMLValue(sStyleName)%>&#13;创建者:&nbsp;<%=CMyString.filterForHTMLValue(sCrUser)%>&#13;创建时间:&nbsp;<%=CMyString.filterForHTMLValue(sCrTime)%>" WCMAnt:paramattr="title:resource_style_select.jsp.numresourccrusercrtime">
...
<div class="selectAllBox" id="selectAllBox"><span class="selectSp" id="selectSp"><input type="checkbox" name="SelAll" id="SelAll" value="" style="border:none;"/> <label for="SelAll" WCMAnt:param="resource_style_select.jsp.selectall">全选</label></span></div>
</body>
