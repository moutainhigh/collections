...
String sRootPath = CMyString.showNull(request.getContextPath(), "/wcm"); //站点根目录 //why@2002-04-27:需要从系统配置中读取
...
sErrDetail = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrDetail :( LocaleServer.getString("error.jsp.label.sys_error", "系统出现错误"));
sErrMsg = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrMsg :( LocaleServer.getString("error.jsp.label.sys_error", "系统出现错误"));
out.clear();
