...
<%
	...
	if(!(result instanceof Specials)){
		throw new WCMException("服务(com.trs.ajaxservice.PageStyleServiceProvider.query)返回的对象集合类型不为Specials，而为"+(result.getClass())+"，请确认。");
	}
