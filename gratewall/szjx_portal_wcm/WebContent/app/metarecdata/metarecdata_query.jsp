...
<%
	...
	if(!(result instanceof MetaViewDatas)){
		throw new WCMException(CMyString.format(LocaleServer.getString("metarecdata_query.type","服务(com.trs.components.metadata.service.MetaDataCenterServiceProvider.query)返回的对象集合类型不为MetaViewDatas，而为({0})，请确认。"),new Object[]{result.getClass()}));
	}
...
<%
	...
	tx.printStackTrace();
	throw new WCMException(LocaleServer.getString("metarecdata_query.runExce","metarecdata_query.jsp运行期异常!"), tx);
}
%>
<%!
