...
<html>
 <head>
  <title WCMAnt:param="flash_piechart.title"> 用户发稿量饼状图 </title>
  ...
  <link href="../flash_chart_common.css" rel="stylesheet" type="text/css" />
  </style>
 </head>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="flash_piechart.pic">
					用户发稿量饼状图
				</div>
			</div>
		</div>
				...
				<tr>
					...
					<td class="data-select-td">
						<div class="data-info-div">
							<div class="data-desc" WCMAnt:param="flash_piechart.method">统计方式：
							</div>
							<div id="data-select">
							</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		flash_options.init({data_url:"../../include/doc_stat/user/piechartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
