...
<html>
 <head>
  <title WCMAnt:param="user_trendchart.title"> 用户发稿量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="user_trendchart.pic">
					用户发稿量柱状图
				</div>
			</div>
		</div>
				...
				<tr>
					...
					<td class="data-select-td">
						<div class="data-info-div">
							<div class="" WCMAnt:param="user_trendchart.time">
								时间单位：
							</div>
							<div class="" id="time-steps">
								<input type="radio" checked name="time-step" id="day-units" value="1"><label for="day-units" WCMAnt:param="user_trendchart.day"> 天 </label>
								<input type="radio" name="time-step" id="month-units" value="2"><label for="month-units" WCMAnt:param="user_trendchart.month"> 月 </label>
								<input type="radio" name="time-step" id="season-units" value="4"><label for="year-units" WCMAnt:param="user_trendchart.season"> 季度 </label>
								<input type="radio" name="time-step" id="year-units" value="3"><label for="year-units" WCMAnt:param="user_trendchart.year"> 年 </label>
							</div>
							<div class="data-desc" WCMAnt:param="user_trendchart.count">统计方式：
							</div>
							<div id="data-select">
							</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"trendchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options",default_time_step:<%=nTimeStep%>});
