...
<html>
 <head>
  <title WCMAnt:param="site_trendchart.siteclicktrendchart"> 站点点击量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="site_trendchart.siteclicktrendchart">
					站点点击量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="" WCMAnt:param="site_trendchart.timeunit">
					时间单位：
				</div>
				<div class="" id="time-steps">
					<input type="radio" checked name="time-step" id="day-units" value="1"><label for="day-units" WCMAnt:param="site_trendchart.day">天 </label>
				...
				<div class="data-desc" WCMAnt:param="site_trendchart.statistic.method">
				统计方式：点击时间段
				</div>
				<div id="data-select">
				</div>
  ...
  <!--
	...
	Event.observe(window,"load",function(){
		...
		Ext.apply(TABS_CONFIG.SITE_HITSCOUNT,{
			default_item:"trendchart"
		});
		Stat.Tab.UI.init(TABS_CONFIG.SITE_HITSCOUNT);
