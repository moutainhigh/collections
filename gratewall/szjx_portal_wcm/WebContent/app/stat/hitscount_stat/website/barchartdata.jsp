...
<%	
	...
	StringBuffer siteNames = new StringBuffer(500);
	...
	for (int i = currPager.getFirstItemIndex(); i <= currPager.getLastItemIndex(); i++) {			
		try{
			...
			if(website == null)
				continue;
			String sSiteName = CMyString.transDisplay(website.getDesc());
			...
			// 构造元素信息
			elements.append("{\"top\":"+num+",\"tip\":\"站点:"+sSiteName+"<br>点击量:#top#\"}");
			// 构造发稿人
			siteNames.append("\""+sSiteName+"\"");
	...
	y_max += y_step;
	response.setHeader("XlabelsNum",String.valueOf((CMyString.split(siteNames.toString(),",").length)));
	response.setHeader("ChartType","barchart");
	out.clear();
	out.print(getBarChartJson("站点点击量",elements.toString(),siteNames.toString(),y_max,y_step));
%>