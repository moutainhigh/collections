...
Ext.apply(SEARCH_CONFIG.SPECIAL_HITSCOUNT,{
	export_cmd:function(){
		var sRequestUrl = 'export_special_hitscount.jsp';
...
Event.observe(window,"load",function(){
	...
	new Stat.Tab().init(TABS_CONFIG.SPECIAL_HITSCOUNT);
	//初始化检索字段信息
	initSearchParam();
...
function hitsTimeOptionClick(nType){
	...
	location.href = 'special_datatable.jsp?' + paramStr;
}
function getUrlJson(){
	var json = {};
