...
<html>
 <head>
  <title WCMAnt:param="special_piechart.title"> 专题点击量饼状图 </title>
  ...
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="special_piechart.chart">
					专题点击量饼状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="special_piechart.method">统计方式：点击时间段</div>
