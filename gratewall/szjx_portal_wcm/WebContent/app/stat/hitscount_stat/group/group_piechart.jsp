...
<html>
 <head>
  <title WCMAnt:param="group_piechart.departmentclicknumpiechart"> 部门点击量饼状图 </title>
  ...
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="group_piechart.departmentclickpiechart">
					部门点击量饼状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="group_piechart.countMethod">统计方式：点击时间段</div>
