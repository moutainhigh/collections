...
<html>
 <head>
  ...
  <title WCMAnt:param="channel_barchart.title"> 栏目点击量柱状图 </title>
  ...
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c"  WCMAnt:param="channel_barchart.chart">
					栏目点击量柱状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc"  WCMAnt:param="channel_barchart.method">统计方式：点击时间段</div>
