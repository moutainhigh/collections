...
<html>
 <head>
  <title WCMAnt:param="channel_trendchart.title"> 栏目点击量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="channel_trendchart.chart">
					栏目点击量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="" WCMAnt:param="channel_trendchart.timeunit">
					时间单位：
				</div>
				<div class="" id="time-steps">
					<input type="radio" checked name="time-step" id="day-units" value="1"><label for="day-units" WCMAnt:param="channel_trendchart.day">天 </label>
					<input type="radio" name="time-step" id="month-units" value="2"><label for="month-units" WCMAnt:param="channel_trendchart.month">月 </label>
					<input type="radio" name="time-step" id="season-units" value="4"><label for="season-units" WCMAnt:param="channel_trendchart.season">季度 </label>
					<input type="radio" name="time-step" id="year-units" value="3"><label for="year-units" WCMAnt:param="channel_trendchart.year">年 </label>
				</div>
				<div class="data-desc" WCMAnt:param="channel_trendchart.statisticMethod">
				统计方式：点击时间段
				</div>
				<div id="data-select">
				</div>
  ...
  <!--
	...
	Event.observe(window,"load",function(){
		var sSearchConfig = bStatGroupByChannel ? SEARCH_CONFIG.CHANNEL_HITSCOUNT : SEARCH_CONFIG.DOCUMENT_HITSCOUNT_BYUSER;
		Stat.SearchBar.UI.init(sSearchConfig);

		Ext.apply(TABS_CONFIG.CHANNEL_HITSCOUNT,{
			default_item:"trendchart"
		});
		Stat.Tab.UI.init(TABS_CONFIG.CHANNEL_HITSCOUNT);
