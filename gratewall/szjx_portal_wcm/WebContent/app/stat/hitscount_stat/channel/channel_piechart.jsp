...
<html>
 <head>
  ...
  <title WCMAnt:param="channel_piechart.title"> 栏目点击量饼状图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="channel_piechart.chart">
					栏目点击量饼状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc"  WCMAnt:param="channel_piechart.statisticMehtod">统计方式：点击时间段</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"piechartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
