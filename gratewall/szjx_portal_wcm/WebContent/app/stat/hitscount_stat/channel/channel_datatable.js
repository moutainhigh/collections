...
Event.observe(window,"load",function(){
	...
	Ext.apply(sSearchConfig,{
		export_cmd:function(){
			var sRequestUrl = 'export_channel_hitscount.jsp';
	...
	new Stat.Tab().init(TABS_CONFIG.CHANNEL_HITSCOUNT);
...
function hitsTimeOptionClick(nType){
	...
	location.href = 'channel_datatable.jsp?' + paramStr;
}
function getUrlJson(){
	var json = {};
