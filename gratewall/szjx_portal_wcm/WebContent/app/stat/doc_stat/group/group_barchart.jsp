...
<html>
 <head>
  <title WCMAnt:param="group_barchart.departmentpublishbarchart"> 部门发稿量柱状图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="group_barchart.pic">
					部门发稿量柱状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="group_barchart.count">统计方式：</div>
  ...
  <!--
	...
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"group_barchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
