...
<html>
 <head>
  <title WCMAnt:param="group_trendchart.departmentpublishtrendchart"> 部门发稿量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="group_trendchart.departmentpublishtrendchart">
					部门发稿量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				...
				<div class="data-desc" WCMAnt:param="group_trendchart.count">统计方式：
				</div>
				<div id="data-select">
				</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Ext.apply(TABS_CONFIG.GROUP_DEFAULT,{
		...
		Flash.Data.Render.init({data_url:"group_trendchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options",default_time_step:<%=getBestTimeStep(currRequestHelper)%>});
