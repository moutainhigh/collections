...
<html>
 <head>
  <title WCMAnt:param="site_barchart.sitepublishbarchart"> 站点发稿量柱状图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="site_barchart.sitepublishbarchart">
					站点发稿量柱状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="site_barchart.countway">统计方式：</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		Ext.apply(SEARCH_CONFIG.SITE_DEFAULT,{
			select_item:[{
				text:"站点名称",
				value:"sitename"
			}]
		...
		Flash.Data.Render.init({data_url:"site_barchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
