...
<html>
 <head>
  <title WCMAnt:param="site_trendchart.sitepublishtrendchart"> 站点发稿量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="site_trendchart.sitepublishtrendchart">
					站点发稿量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="" WCMAnt:param="site_trendchart.timeunit">时间单位：</div>
				<div class="">
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"site_trendchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options",default_time_step:<%=nTimeStep%>});
