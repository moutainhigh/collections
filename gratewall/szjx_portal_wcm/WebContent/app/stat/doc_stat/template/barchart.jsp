 ...
 <body>
  ...
  <!--
	...
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"#PREFIX#_barchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
	});
