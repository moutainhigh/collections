...
<%@page import="com.trs.components.wcm.content.persistent.WebSite"%><%out.clear();%>
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict/dtd">
<html>
 <head>
  <title> #PREFIX_DESC#饼状图 </title>
 ...
 <body>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"#PREFIX#_piechartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
	});
