...
<html>
 <head>
  <title WCMAnt:param="chnl_piechart.title"> 栏目发稿量饼状图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="chnl_piechart.pic">
					栏目发稿量饼状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="chnl_piechart.count">统计方式：</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"chnl_piechartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
