...
<html>
 <head>
  ...
  <title WCMAnt:param="chnl_datatable.title"> 栏目发稿量统计 </title>
  ...
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="chnl_datatable.count">
					栏目发稿量统计列表
				</div>
			</div>
		</div>
		<div class="data">
			<table cellspacing="0" cellpadding="0" class="tb">
				<tbody>
					<tr>
						<th class="first" rowspan="2" width="50" WCMAnt:param="chnl_datatable.num">序号</th><th rowspan="2" WCMAnt:param="chnl_datatable.chnl.name">栏目名称</th><th rowspan="2" WCMAnt:param="chnl_datatable.site">所属站点</th><th rowspan="2" width="80" WCMAnt:param="chnl_datatable.total">总发稿量</th><th colspan="6" width="260" WCMAnt:param="chnl_datatable.doc.count">文档状态统计</th><th colspan="3" width="180" WCMAnt:param="chnl_datatable.">使用情况统计</th><th colspan="4" width="200" WCMAnt:param="chnl_datatable.doc.count">文档类型统计</th><th colspan="2" width="120" WCMAnt:param="chnl_datatable.doc.count">文档分布统计</th>
					</tr>
					<tr>
						<th WCMAnt:param="chnl_datatable.new">新稿</th><th WCMAnt:param="chnl_datatable.check">正审</th><th WCMAnt:param="chnl_datatable.edit">已编</th><th WCMAnt:param="chnl_datatable.checked">已签</th><th WCMAnt:param="chnl_datatable.sent">已发</th><th WCMAnt:param="chnl_datatable.back">返工</th><th WCMAnt:param="chnl_datatable.src">原稿</th><th WCMAnt:param="chnl_datatable.copy">复制</th><th WCMAnt:param="chnl_datatable.quote">引用</th><th WCMAnt:param="chnl_datatable.word">文字型</th><th WCMAnt:param="chnl_datatable.pic">图片型</th><th WCMAnt:param="chnl_datatable.audio">音频型</th><th WCMAnt:param="chnl_datatable.video">视频型</th><th WCMAnt:param="chnl_datatable.department">部门</th><th WCMAnt:param="chnl_datatable.person">个人</th>
					</tr>
<%
...
<script language="javascript" src="chnl_datatable.js" type="text/javascript"></script>