...
<%
	int nTimeStep = getBestTimeStep(currRequestHelper);
%>
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict/dtd">
<html>
 <head>
  <title WCMAnt:param="chnl_trendchart.title"> 栏目发稿量走势图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="chnl_trendchart.pic">
					栏目发稿量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="" WCMAnt:param="chnl_trendchart.timeunit">
					时间单位：
				</div>
				<div class="" id="time-steps">
					<input type="radio" checked name="time-step" id="day-units" value="1"><label for="day-units" WCMAnt:param="chnl_trendchart.day"> 天 </label>
					<input type="radio" name="time-step" id="month-units" value="2"><label for="month-units" WCMAnt:param="chnl_trendchart.month"> 月 </label>
					<input type="radio" name="time-step" id="season-units" value="4"><label for="season-units" WCMAnt:param="chnl_trendchart.season"> 季度 </label>
					<input type="radio" name="time-step" id="year-units" value="3"><label for="year-units" WCMAnt:param="chnl_trendchart.year"> 年 </label>
				</div>
				<div class="data-desc" WCMAnt:param="chnl_trendchart.count">统计方式：
				</div>
				<div id="data-select">
				</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		Stat.SearchBar.UI.init(SEARCH_CONFIG.CHANNEL_DEFAULT);

		Ext.apply(TABS_CONFIG.CHANNEL_DEFAULT,{
			default_item:"trendchart"
		});
		Stat.Tab.UI.init(TABS_CONFIG.CHANNEL_DEFAULT);
		...
		Flash.Data.Render.init({data_url:"chnl_trendchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options",default_time_step:<%=nTimeStep%>});
