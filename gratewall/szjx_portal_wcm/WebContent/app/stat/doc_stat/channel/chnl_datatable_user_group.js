...
new Stat.Tab().init(Ext.applyIf(TABS_CONFIG.CHANNEL_DEFAULT,{
	items:[{
		key:'table',
		url:'chnl_datatable_user_group.jsp',
		desc:'数据表'
	}]
}));
	...
	*/
	...
	Click_Detail : function(evt){
		...
		if(el){
			...
			location.href = "doc_statofchannel_list.jsp"+window.location.search+"&channelIds="+nChnlId+"&statType="+nType+"&case="+nCase;
		}
	},
	/*
	*  页面初始化
