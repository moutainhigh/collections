 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="user_trendchart.chart">
					用户发稿量走势图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="" WCMAnt:param="user_trendchart.timeunit">
					时间单位：
				</div>
				<div class="" id="time-steps">
					...
					<input type="radio" name="time-step" id="season-units" value="4"><label for="season-units" WCMAnt:param="user_trendchart.season"> 季度 </label>
					<input type="radio" name="time-step" id="year-units" value="3"><label for="year-units" WCMAnt:param="user_trendchart.year"> 年 </label>
				</div>
				<div class="data-desc" WCMAnt:param="user_trendchart.method">统计方式：
				</div>
				<div id="data-select">
				</div>
  ...
  <!--
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"user_trendchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options",default_time_step:<%=getBestTimeStep(currRequestHelper)%>});
