...
<html>
 <head>
  <title WCMAnt:param="user_barchart.title"> 用户发稿量柱状图 </title>
 ...
 <body>
  <div class="container">
	...
	<div class="content">
		<div class="data-title">
			<div class="r">
				<div class="c" WCMAnt:param="user_barchart.chart">
					用户发稿量柱状图
				</div>
			</div>
		</div>
		...
		<div class="rightdata" id="rightdata">
			<div class="data-info-div">
				<div class="data-desc" WCMAnt:param="user_barchart.count">统计方式：</div>
  ...
  <!--
	...
	Event.observe(window,"load",function(){
		...
		Flash.Data.Render.init({data_url:"user_barchartdata.jsp",flash_render_el:"_flash_chart_",select_el:"data-select",options_el:"data-options"});
