...
var OfficeActiveX = {
	...
	Init : function(){//初始化ActiveX控件
		document.write("<OBJECT id=\"WORD_CLIENT\" CLASSID=\"clsid:D6641A7A-B6F8-4FC7-A382-624DDBAEF96F\"  codeBase=\"WCMOffice.cab#Version=1,0,0,22\" style=\"display:none\"></OBJECT>");
...
//	html = html.replace( /<FONT\s*>(.*?)<\/FONT>/gi, '$1' ) ;
	...
	function(a0,a1,a2,a3){
		if(a2.indexOf("/WCMV6/editor/editor/fckeditor.jsp?InstanceName=TRS_Editor&amp;Toolbar=WCM6")!=-1){
			return a1+'href="'+a3+'"';
		}
		return a0;
	});
