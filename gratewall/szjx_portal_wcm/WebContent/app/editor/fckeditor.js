...
{
	var sFile = this.editorPage || 'fckeditor.jsp' ;
	...
	if (this.ToolbarLocation) {
		sLink += '&amp;ToolbarLocation=' + this.ToolbarLocation;
	}
	if(this.MoreParams){
		try{
			for(var sName in this.MoreParams){
				sLink += '&amp;' + sName + '=' + encodeURIComponent(this.MoreParams[sName]);
			}
		}catch(ex){
			//Just Skip it.
		}
