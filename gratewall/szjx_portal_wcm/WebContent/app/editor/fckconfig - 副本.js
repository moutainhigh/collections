...
FCKConfig.ToolbarSets["WCM6"] = [
	[
		'SysConfig','Accessibility',
		'-',
		'Print',/*'SpellCheck',*/
		'Cut','Copy','Paste','PasteText','PasteTextPic',/*'OfficeDoc',*/'PasteWord',
		'-',
		'Find','Replace',
		'-',
		'Undo','Redo',
		...
		'Table','Comment',
		'-',
		'FitWindow','ContentLink','ContentUnLink','Smiley','SpecialChar','Static'
	],
	'/',
	[
		/*'Style',*//*'FontFormat',*/'FontName','FontSize','LineHeight','Bold','Italic','Underline','TextColor','BGColor','RemoveFormat',
		'-',
		'JustifyLeft','JustifyFull','JustifyCenter','JustifyRight','OrderedList','UnorderedList',
		'-',
		'Outdent','Indent','OfficeDoc',
		'-',
		'WCM6AdvToolbar'
	]
] ;
FCKConfig.ToolbarSets["WCM6_ADV"] = [
	[
		...
		'-',
		'Image','PhotoLib','Flash','FlashLib','ImportFlash',
		'-',
		'Templates',
		'-',
		'Table','Comment',
	...
	[
		...
		'-','PageBreak','InsertSepTitle','AdInTrs','CKMSpellCheck','AutoSaveHistory','OfficeDoc',
		'-',
		'WCM6Toolbar'
	]
] ;
