...
/*被关联的视图id*/
var m_nRelatedViewId = FloatPanel.dialogArguments.RelatedViewId;
/*是否从被关联的文档id反选使用到此的源文档的序列*/
var m_bFromBackSelect = FloatPanel.dialogArguments.FromBackSelect || false;
/*被相关的文档id*/
var m_nRelatedDocId = FloatPanel.dialogArguments.RelatedDocId || 0;
/*关联的视图id*/
var m_nRelatingViewId = FloatPanel.dialogArguments.RelatingViewId || 0;
