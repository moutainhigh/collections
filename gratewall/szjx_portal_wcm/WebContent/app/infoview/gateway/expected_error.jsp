...
if (exception instanceof CMyException) {
	...
	sErrType = LocaleServer.getString("expected_error.jsp.label.unknown","未知");
	sErrMsg = LocaleServer.getString("expected_error.jsp.label.unknownerror","未知错误！");
...
sErrDetail = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrDetail : LocaleServer.getString("expected_error.jsp.label.occurerror","系统出现错误");
sErrMsg = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrMsg : LocaleServer.getString("expected_error.jsp.label.occurerror","系统出现错误");
out.clear();
%>
<HTML>
<HEAD>
<META http-equiv="Content-Type" content="text/html; charset=UTF-8">
<TITLE WCMAnt:param="expected_error.jsp.wcmsysinfo">TRS WCM系统提示信息::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::</TITLE>
...
<script language="javascript">
	...
	function copyToClipboard(){
		...
		alert(wcm.LANG.expected_error_3000 || "已经复制到剪切板中！");
	}
	...
	function showDetail( ){
		...
		if( bCurrShowed ){
			sDisplay = "none";
			sTitle = wcm.LANG.expected_error_4000 || "显示详细信息";
			...
			sDisplay = "inline";
			sTitle = wcm.LANG.expected_error_5000 || "隐藏详细信息";
				...
				<TABLE id = tbinfo width="100%" height="100%" bgcolor="#FFFFFF" align="center"
					...
					<TR>
						<TD  width="100%" id=tdinfo align="center" valign="top"><IMG src="../../images/error.gif" align="absmiddle" valign="top"><SPAN class="font_redbold style7">
							<%
								out.println(CMyString.format(LocaleServer.getString("expected_error.jsp.sysmessage", "系统提示信息:{0}"), new String[]{CMyString.transDisplay(sErrMsg)}));
							%>
						</SPAN> （<A id="id_linkShowDetail" href="#"
							class="navigation_page_link" onclick="showDetail();return false;" WCMAnt:param="expected_error.jsp.showdetails">显示详细信息</A>）</TD>
					...
					<TR bgcolor="#FFFFFF"> 
						...
						<UL>
							<li><font color="#000000"><b WCMAnt:param="expected_error.jsp.errornum">错误编号：</b></font><%=nErrNo%></li>
							<li><font color="#000000"><b  WCMAnt:param="expected_error.jsp.errotype">错误类型：</b></font><%=sErrType%></li>
							<li><font color="#000000"><b  WCMAnt:param="expected_error.jsp.detailoferror">详细信息：</b></font><br>
							</li>
						</UL>
		...
		<TABLE width="100%" border="0" align="center" cellpadding="0"
			...
			<TR>
				...
				<DIV align="center"><INPUT type="button" name="btnCopy"
					onclick="copyToClipboard()" WCMAnt:paramattr="value:expected_error.jsp.copyto" value="复制到剪切板" class="inputbutton">&nbsp;&nbsp;&nbsp;
				<INPUT type="button" name="btnClose" onclick="window.close()"
					 WCMAnt:paramattr="value:expected_error.jsp.closewindow" value="关闭窗口" class="inputbutton"></DIV>
				</TD>
			</TR>
		</TABLE>
		</TD>
