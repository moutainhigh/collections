...
<%
	int nFilterId = processor.getParam("FilterId", 0);
	Filter myFilter = Filter.findById(nFilterId);
	String sSelectedOptionIds = myFilter.getPropertyAsString("disabledoptions");
	...
	FilterOptions options = (FilterOptions)processor.excute("wcm61_filtercenter", "queryOptionsByFilter");
%>
