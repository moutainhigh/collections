...
<%
	...
	if(nObjId <= 0)
		throw new WCMException(CMyString.format(LocaleServer.getString("auth.label.noviewperssion", "新建模式不允许查看/设置权限!Type:[{0}] Id:[{1}]"), new int[]{nObjType, nObjId}));
		...
		if(nObjType != 1){
			...
			*/
			...
			if(!loginUser.isAdministrator())
				throw new WCMException(CMyString.format(LocaleServer.getString("auth.label.noproppermission", "当前用户[{0}]没有系统属性权限进行设置!"), new String[] {loginUser.getName()}));
