...
<HEAD>
  ...
  <TITLE WCMAnt:param="user_select_left.jsp.title">TRS WCM 用户选择树::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::</TITLE>
...
<TR>
    <TD align="left" valign="top" bgcolor="#FFFFFF">
		...
		<script src="group_tree.jsp?OperType=<%=PageViewConstants.TREE_OPERATION_GRPUSER_SEL_SPECIAL%>&TreeType=<%=nTreeType%>&ShowAll=0&FilterRight=<%=nFilterRight%>"></script>
	 </TD>
</TR>
<!--~- END ROW1 -~-->
</TABLE>
