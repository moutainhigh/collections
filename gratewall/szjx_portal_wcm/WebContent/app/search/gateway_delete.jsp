...
//4.初始化(获取数据)
	String gatewayIds = currRequestHelper.getString("gatewayIds");

//5.权限校验

//6.业务代码
	TRSGateways currTRSGateways = TRSGateways.findByIds(loginUser, gatewayIds);
	currTRSGateways.removeAll(true);
