...
if(nErrNo < 200000) sErrMsg = LocaleServer.getString("error.label.systemerror", "系统出现错误。");
...
sErrDetail = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrDetail : (LocaleServer.getString("error_for_dialog.jsp.label.syserror","系统出现错误"));
sErrMsg = "true".equalsIgnoreCase(sShowDetailInfo) ? sErrMsg : (LocaleServer.getString("error_for_dialog.jsp.label.syserror","系统出现错误"));
out.clear();
%><%
