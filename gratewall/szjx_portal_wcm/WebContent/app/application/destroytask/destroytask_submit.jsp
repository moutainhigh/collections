...
<div class="box" id="data">
	...
	<div id="tabs">
		<ul>
			...
			<%if(nFlowDocId>0){%>
			<li>
				<a href="#tabs-process" WCMAnt:param="destroytask_addedit.jsp.process">工作流处理</a>
			</li>
			<%}%>
		</ul>
...
<div class="buttonBox" id="CommandButtons" >
		<button id="btnSaveAndClose" onclick="submitProcessInfo();return false;" WCMAnt:param="destroytask_addedit.jsp.saveclose">同意撤销</button>&nbsp;&nbsp;&nbsp;
