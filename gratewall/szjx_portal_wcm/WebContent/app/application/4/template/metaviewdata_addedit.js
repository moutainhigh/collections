...
Event.observe(window, 'load', function(event){
		<TRS_XVIEWFIELDGROUPS PARENTID="0" HIDEEMPTYGROUP="true" num="1">
	var box = "tabs-<TRS_XVIEWFIELDGROUP FIELD='METAVIEWFIELDGROUPID'/>";
		</TRS_XVIEWFIELDGROUPS>
	var boxElement = $(box);
	var selectChannelElement = $('selectChannel');
