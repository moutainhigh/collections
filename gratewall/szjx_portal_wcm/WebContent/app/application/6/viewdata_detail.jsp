...
<title WCMAnt:param="viewdata_detail.jsp.watchviewdescdata">查看视图[下级公开信息]数据</title>
...
<div class="box">
	<div id="tabs">
		<ul>
				...
				<li>
					<a href="#tabs-26">下级公开信息</a>
				</li>
			
				<li>
					<a href="#tabs-27">详细内容</a>
				</li>
...
<%=CMyString.transDisplay(obj.getRealProperty("placekey"), true)%>
							...
							<div class="row" style='display:none;'>
								<div class="label">检索的内容</div>
								<div class="sep">：</div>
								<div class="value">
									<!--可视化编辑器-->
<textarea name="SearchContent" id="SearchContent" style="display:none;"><%=CMyString.filterForHTMLValue(makeHtmlCon(obj.getRealProperty("SearchContent")))%></textarea>
<iframe src="../core/com.trs.ui/ckeditor/blank.html?fieldname=SearchContent" style="width:520px;height:250px;border:1px solid silver;" frameborder="0" class="editorIframe"></iframe>
								</div>
							</div>
...
<%=CMyString.transDisplay(obj.getRealProperty("acesmthd"), true)%>
							...
							<div class="row" style=''>
								...
								<div class="value">
									<!--默认-->
<%=CMyString.transDisplay(obj.getRealProperty("svobjcat"), true)%>
								</div>
							</div>
