...
<%
	...
	String sFieldValue ="";
%>	
<FIELDSET style="margin:10px 30px 10px 30px;"><legend WCMAnt:param="advance_search.jsp.queryfield">检索字段:</legend>
<%
...
%>
		<div class="row">
			...
			<div class="value" style="margin-left:80px;display:block;">
				<input type="text" name="_sqlWhere_" id="_sqlWhere_" value="" style="width:300px;" title="额外条件写法如：field1=a or field2 like '%aa%'" WCMAnt:paramattr="title:advance_search.jsp.conditionAddTip">
...
<%
	...
	tx.printStackTrace();
	throw new WCMException(LocaleServer.getString("advance_search.jsp.label.runtimeexception","metaviewdata_query.jsp运行期异常!"), tx);
}
%>