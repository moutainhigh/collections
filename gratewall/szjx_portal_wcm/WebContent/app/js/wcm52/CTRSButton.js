...
function CTRSButton_toHTML(){		
	...
	switch(this.nType){
		...
		case TYPE_ROMANTIC_BUTTON:
			...
			sHTML = sHTML +'		<TD width="4"><img src="../images/wcm52/button_left.gif" width="4" height="24"></TD>' 
			+'		<TD nowrap align="center" background="../images/wcm52/button_bg_line.gif">'+this.sText+'</TD>'
			+'		<TD width="4"><IMG src="../images/wcm52/button_right.gif" width="4" height="24"></TD>'
			+"	</TR>" 
			+"</TABLE>";
			break;
...
function CTRSButton(_sText, _sClickFunc, _sButtonImgSrc, _sToolTip,  _sStyleName){
	...
	this.sButtonImgSrc	= _sButtonImgSrc|| "../images/wcm52/button_default.gif";
