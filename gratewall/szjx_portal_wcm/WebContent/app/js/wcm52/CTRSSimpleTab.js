...
function CTRSItem_toHTML() {
	...
	var nHeight = this.sTitle.length*10;
	...
	var sHTML = "<TR>"
			...
			+'<table width="31" height="90" border="0" cellpadding="0" cellspacing="0" class="navtitle12">\
			   <tr> \
				  <td width="31" height="16"><img src="../images/auth/card1'+sImgAfter+'.gif" width="31" height="21"></td>\
				</tr>\
				<tr>\
				  <td height="48" align="center" valign="middle" name="valid" background="../images/auth/card2'+sImgAfter+'.gif">';
	if (this.bDisabled)
	{
...
//		+">"+this.sTitle.split('').join('<br>')+"</A>"	;		
		+" title='" + this.sTitle + "'>"+this.sTitle+"</A>"	;		
	}
	sHTML = sHTML +
		   '</td>\
        </tr>\
        <tr>\
          <td height="16"><img src="../images/auth/card3'+sImgAfter+'.gif" width="31" height="21"></td>\
        </tr>\
      </table>'
			+"</TD></TR>";
	if(this.isLast()){
		...
		/*
		sHTML += "<TR><TD " + height + " style='BACKGROUND:url(\"../images/auth/card2a.gif\");' width='100%'></TD>"
			+"</TR>";
		*/
		sHTML += "<TR><TD " + height + " style='BACKGROUND:url(\"../images/auth/card4.gif\") repeat-y; width:2px;'></TD></TR>";
	}
