...
if(!opt.isCtrl && opt.isShift && this.lastRowIndex>=0){
...
oper.desc, "title='"+(oper.title||oper.desc)+"'",
(bInMore?'oper_item_more':''),
(oper.quickKey?this.getQuickKeyTip(oper.quickKey):'')
);
},
