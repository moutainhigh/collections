...
//5.权限校验
	if(!(loginUser.isAdministrator() || AuthServer.hasRight(loginUser,currGroup))){
		throw new WCMException(ExceptionNumber.ERR_USER_NORIGHT, "对不起，您没有权限添加用户到本组织！");
	}
//6.业务代码
	IGroupService currGroupService = (IGroupService)DreamFactory.createObjectById("IGroupService");
	currGroupService.setGroupUsers(nGroupId, sUserIds);
//7.结束
...
<HEAD>
    ...
    <TITLE>TRS WCM 5.2 添加用户到组织页面::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::</TITLE>
	<BASE TARGET="_self">
...
<SCRIPT LANGUAGE="JavaScript">
	//window.close();
	//window.history.back();
	window.location.href = "grpuser_list.jsp?GroupId=<%=nGroupId%>";
</SCRIPT>
</BODY>
</HTML>