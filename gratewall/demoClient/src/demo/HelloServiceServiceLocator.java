...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements demo.HelloServiceService {
    ...
    private java.lang.String HelloService_address = "http://localhost:8080/demo/services/HelloService";
    ...
    public demo.HelloService getHelloService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            demo.HelloServiceSoapBindingStub _stub = new demo.HelloServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (demo.HelloService.class.isAssignableFrom(serviceEndpointInterface)) {
                demo.HelloServiceSoapBindingStub _stub = new demo.HelloServiceSoapBindingStub(new java.net.URL(HelloService_address), this);
                _stub.setPortName(getHelloServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo", "HelloService"));
        }
