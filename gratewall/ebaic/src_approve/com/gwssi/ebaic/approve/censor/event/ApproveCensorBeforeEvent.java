...
@Service("censorBeforeEvent")
public class ApproveCensorBeforeEvent implements OnEventListener{
	...
	public void execQuery(TorchController controller,
		...
		params.put("orgCodeFk", sysmgrUser.getOrgCodeFk());
		...
		String appDateTemp = params.get("appDateTemp");
		//查询条件中截止日期天数+1
