...
@Entity
@Table(name = "T_PT_YH")
public class TPtYhBO extends AbsDaoBussinessObject implements java.io.Serializable{
	
	private static final long serialVersionUID = -6160073379322669910L;
...
//	}
	...
	public void setCheckState(String checkState) {
		...
		markChange("checkState",checkState);
	}
	@Column(name = "MOB_CHECK_STATE")
	public String getMobCheckState() {
		return mobCheckState;
	}
	public void setMobCheckState(String mobCheckState) {
		this.mobCheckState = mobCheckState;
		markChange("mobCheckState",mobCheckState);
	}
	@Column(name = "IDENTITY_CHECK_STATE")
	public String getIdentityCheckState() {
		return identityCheckState;
	}
	public void setIdentityCheckState(String identityCheckState) {
		this.identityCheckState = identityCheckState;
		markChange("identityCheckState",identityCheckState);
	}
