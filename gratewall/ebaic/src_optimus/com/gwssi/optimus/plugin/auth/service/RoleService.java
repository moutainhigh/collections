...
import com.gwssi.optimus.plugin.auth.model.TPtJsgnBO;
...
public class RoleService extends BaseService{
	...
	public List queryRole(Map params) throws OptimusException{
        ...
        List list = dao.pageQueryForList(TPtJsBO.class, sql, null);
        return list;
    }
    ...
    public void saveRole(TPtJsBO jsBO, List<String> funcIds) throws OptimusException{
        ...
        if(StringUtils.isNotEmpty(jsBO.getJsId())){
            dao.update(jsBO);
            String sql = "delete from t_pt_jsgn t where t.js_id='"+jsBO.getJsId()+"'";
    ...
    public TPtJsBO getRole(String jsId) throws OptimusException{
        IPersistenceDAO dao = getPersistenceDAO();
