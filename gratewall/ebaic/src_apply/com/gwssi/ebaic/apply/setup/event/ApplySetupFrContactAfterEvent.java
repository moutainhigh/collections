...
@Service("applySetupFrContactAfterEvent")
public class ApplySetupFrContactAfterEvent implements OnEventListener{
	...
	public void execEdit(TorchController controller,
		...
		/*String cerValFrom = params.get("applySetupFrContact_Form.fcerValFrom");
		String cerValTo = params.get("applySetupFrContact_Form.fcerValTo");*/
		String cerNo = params.get("applySetupFrContact_Form.cerNo");
