 ...
 *
 */
@Service("accountManagerDetailAfterEvent")
public class AccountManagerDetailAfterEvent implements OnEventListener {
	...
	public void execQuery(TorchController controller,
		...
		while(iterator.hasNext()){
			...
			ReqStateMappingUtil.changeOperationText(map);
		}
