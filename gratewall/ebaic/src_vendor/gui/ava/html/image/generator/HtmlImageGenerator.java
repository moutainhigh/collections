...
public class HtmlImageGenerator {
	...
	static final Dimension A4_SIZE = new Dimension(1200,1697);
...
//			}
	...
	public BufferedImage getBufferedImage() {
		Dimension prefSize = HtmlImageGenerator.A4_SIZE;//editorPane.getPreferredSize();
		BufferedImage img = new BufferedImage(prefSize.width, prefSize.height, BufferedImage.TYPE_INT_BGR);
