...
<body>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十七条  公司设监事会，成员   <U>&nbsp;&nbsp;${(susp.suspCnt)!'0'}&nbsp;</U>人，由股东选举产生。监事会设主席一人，由全体监事过半数选举产生。监事会中股东代表监事与职工代表监事的比例为  <U>&nbsp;&nbsp; ${(bsc)!"0"}&nbsp;</U>：<U>&nbsp;&nbsp;${(sc)!"0"}&nbsp;</U>。
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十八条  监事会行使下列职权：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）检查公司财务；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）对执行董事、高级管理人员执行公司职务的行为进行监督，对违反法律、行政法规、公司章程或者股东决定的执行董事、高级管理人员提出罢免的建议；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）当执行董事、高级管理人员的行为损害公司的利益时，要求执行董事、高级管理人员予以纠正；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（四）向股东议提出提案；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（五）依照《公司法》第一百五十二条的规定，对执行董事、高级管理人员提起诉讼；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十九条 监事会每年度至少召开一次会议，监事可以提议召开临时监事会会议。 <br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十条 监事会决议应当经半数以上监事通过。　<br>
	</div>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十四条  公司的营业期限 <U>&nbsp;&nbsp;<#if ((ent.tradeTerm)!"")=="长期">${(ent.tradeTerm)!""}<#else>${(ent.tradeTerm)!""}&nbsp;</U>年</#if>，自公司营业执照签发之日起计算。<br>
