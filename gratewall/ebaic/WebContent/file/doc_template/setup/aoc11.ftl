...
<body>
	...
	<br><br><br><br><br>
	<div class='little-title'>第一章  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;则</div><br>
	<div class='left-text'>
	...
	<#if unnatInvList??><#list unnatInvList as unni><#if isFirst><#assign isFirst=false><#else>、</#if>${(unni.inv)!""}</#list></#if>&nbsp;</U>等<U>&nbsp;&nbsp;${((natInvList?size)!0)+((unnatInvList?size)!0)}&nbsp;</U>方共同出资，设立<U>&nbsp;&nbsp; ${(ent.entName)!""}&nbsp;</U>，（以下简称公司）特制定本章程。<br>
	</div>
	<br><br>
	...
	<div class='little-title'>第四章	公司注册资本及股东的姓名（名称）、出资方式、
	出资额、出资时间</div>
	<div class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第六条  公司注册资本：<U>&nbsp;&nbsp; ${(ent.regCap)!""}&nbsp;</U>万元人民币。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第七条  股东的姓名（名称）、认缴的出资额、出资期限、出资方式如下：<br>	
	</div>	
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）决定公司的经营方针和投资计划；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）选举和更换非由职工代表担任的董事、监事，决定有关董事、监事的报酬事项；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）审议批准董事会的报告；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（四）审议批准监事会的报告；<br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;召开股东会会议，应当于会议召开十五日以前通知全体股东。定期会议按每年定时召开。代表十分之一以上表决权的股东，三分之一以上的董事，监事会提议召开临时会议的，应当召开临时会议。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十二条  股东会会议由董事会召集，董事长主持；董事长不能履行职务或者不履行职务的，由副董事长主持；副董事长不能履行职务或者不履行职务的，由半数以上董事共同推举一名董事主持。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;董事会不能履行或者不履行召集股东会会议职责的，由监事会召集和主持；监事会不召集和主持的，代表十分之一以上表决权的股东可以自行召集和主持。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十三条  股东会会议作出修改公司章程、增加或者减少注册资本的决议，以及公司合并、分立、解散或者变更公司形式的决议，必须经代表三分之二以上表决权的股东通过。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十四条  公司设董事会，成员为<U>&nbsp;&nbsp;<#if board??>${(board.boardCnt)!"0"}</#if>&nbsp;</U>人，由股东会选举产生。董事任期<U>&nbsp;3&nbsp;</U>年，任期届满，可连选连任。<br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（十）制定公司的基本管理制度；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十六条  董事会会议由董事长召集和主持；董事长不能履行职务或者不履行职务的，由副董事长召集和主持；副董事长不能履行职务或者不履行职务的，由半数以上董事共同推举一名董事召集和主持。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十七条  董事会决议的表决，实行一人一票。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;三分之一以上的董事可以提议召开董事会会议，并于会议召开前十日通知全体董事。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;董事会对所议事项应由二分之一以上的董事表决通过方为有效，并应做成会议记录，出席会议的董事应当在会议记录上签名。<br>
	</div>
	<div class='paging_separator' />
	<div class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十八条  公司设经理，由董事会决定聘任或者解聘。经理对董事会负责，行使下列职权：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）主持公司的生产经营管理工作，组织实施董事会决议；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）组织实施公司年度经营计划和投资方案；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）拟订公司内部管理机构设置方案；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（四）拟订公司的基本管理制度；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（五）制定公司的具体规章；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（六）提请聘任或者解聘公司副经理、财务负责人；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（七）决定聘任或者解聘除应由董事会决定聘任或者解聘以外的负责管理人员；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（八）董事会授予的其他职权。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经理列席董事会会议。<br>
	<#assign bsc=0>
	<#assign sc=0>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十九条  公司设监事会，成员<U>&nbsp;&nbsp;${(susp.suspCnt)!'0'}&nbsp;</U>人，由股东会选举产生。监事会设主席一人，由全体监事过半数选举产生。监事会中股东代表监事与职工代表监事的比例为<U>&nbsp;&nbsp;${(bsc)!""}&nbsp;</U>：<U>&nbsp;&nbsp;${(sc)!""}&nbsp;</U>。
           监事的任期每届为三年，任期届满，可连选连任。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十条  监事会行使下列职权：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）检查公司财务；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）对董事、高级管理人员执行公司职务的行为进行监督，对违反法律、行政法规、公司章程或者股东会决议的董事、高级管理人员提出罢免的建议；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）当董事、高级管理人员的行为损害公司的利益时，要求董事、高级管理人员予以纠正；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（四）提议召开临时股东会会议，在董事会不履行本法规定的召集和主持股东会会议职责时召集和主持股东会会议；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（五）向股东会会议提出提案；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（六）依照《公司法》第一百五十二条的规定，对董事、高级管理人员提起诉讼；<br> 
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;监事可以列席董事会会议。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十一条　监事会每年度至少召开一次会议，监事可以提议召开临时监事会会议。 <br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十二条　监事会决议应当经半数以上监事通过。<br>
	</div>
	<div class='little-title'>第六章  公司的法定代表人</div>
	<div class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十三条  <U>&nbsp;${((le.leRepName)!"")}&nbsp;</U>为公司的法定代表人。<br>
	</div>
	<div class='little-title'>第七章  股东会会议认为需要规定的其他事项</div>
	<div class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十四条  股东之间可以相互转让其部分或全部出资。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十五条  股东向股东以外的人转让股权，应当经其他股东过半数同意。股东应就其股权转让事项书面通知其他股东征求同意，其他股东自接到书面通知之日起满三十日未答复的，视为同意转让。其他股东半数以上不同意转让的，不同意的股东应当购买该转让的股权；不购买的，视为同意转让。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经股东同意转让的股权，在同等条件下，其他股东有优先购买权。两个以上股东主张行使优先购买权的，协商确定各自的购买比例；协商不成的，按照转让时各自的出资比例行使优先购买权。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十六条  公司的营业期限<U>&nbsp;&nbsp;${(ent.tradeTerm)!""}&nbsp;</U>年，自公司营业执照签发之日起计算。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二十七条  有下列情形之一的，公司清算组应当自公司清算结束之日起30日内向原公司登记机关申请注销登记：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）公司被依法宣告破产；<br>
