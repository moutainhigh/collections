...
<body>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十三条  公司设监事会，成员 <U>&nbsp;&nbsp;${(susp.suspCnt)!'0'}&nbsp;</U>人，由股东<U>&nbsp;&nbsp;<#assign isFirst=true><#if suspInfo??><#list suspInfo as susp><#if isFirst><#assign isFirst=false>${(susp.posBrForm)!""}</#if></#list></#if>&nbsp;</U>产生；监事会设主席一人，由全体监事过半数选举产生。监事会中股东代表监事与职工代表监事的比例为<U>&nbsp;&nbsp;${(bsc)!"0"}&nbsp;</U>：<U>&nbsp;&nbsp;${(sc)!"0"}&nbsp;</U> 。
	...
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十五条 监事会每年度至少召开一次会议，监事可以提议召开临时监事会会议。 <br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十六条 监事会决议应当经半数以上监事通过。<br>
	</p>
	<div class='little-title'>第六章  公司的法定代表人</div>
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十七条&nbsp;&nbsp;&nbsp;&nbsp; <U>${((le.leRepJob)!"")}</U>为公司的法定代表人。
	 </p>
	<div class='little-title'>第七章  股东认为需要规定的其他事项</div>
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十八条&nbsp;&nbsp;&nbsp;&nbsp;公司的营业期限<#if ((ent.tradeTerm)!"")=="长期"><U>长期</U><#else><U>${(ent.tradeTerm)!""}</U>年</#if>，自公司营业执照签发之日起计算。<br>
	</p>
	<p class='left-text'>
