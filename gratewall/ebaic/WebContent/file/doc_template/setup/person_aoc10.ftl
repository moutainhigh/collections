...
<body>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十条  公司设董事会，成员为<U>&nbsp;&nbsp;${(board.boardCnt)!"0"}&nbsp;</U>人，由股东<U>&nbsp;&nbsp;<#assign isFirst=true><#if boardInfo??><#list boardInfo as board><#if isFirst><#assign isFirst=false>${(board.posBrForm)!""}</#if></#list></#if>&nbsp;</U>产生。董事任期   <#assign isFirst=true><#if boardInfo??><#list boardInfo as board><#if isFirst><#assign isFirst=false>${(board.offYears)!""}</#if></#list></#if> &nbsp;</U>年，任期届满，可连选连任。董事会设董事长一人，由董事会选举产生。<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十一条  董事会行使下列职权：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）负责向股东报告工作；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（二）执行股东的决议；<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（三）审定公司的经营计划和投资方案；<br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十五条  公司不设监事会，设监事<U>&nbsp;&nbsp; ${(susp.suspCnt)!'0'}&nbsp;</U>人，由股东<U>&nbsp;&nbsp;<#assign isFirst=true><#if suspInfo??><#list suspInfo as susp><#if isFirst><#assign isFirst=false>${(susp.posBrForm)!""}</#if></#list></#if>&nbsp;</U>产生；监事的任期每届为三年，任期届满，可连选连任。<br>
	</p>
	<div class='paging_separator' />
	<p class='left-text'>
	<br>
	...
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十七条&nbsp;&nbsp;&nbsp;&nbsp; ${((le.leRepJob)!"")}为公司的法定代表人。
	 </p>
	<div class='little-title'>第七章  股东认为需要规定的其他事项</div>
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十八条&nbsp;&nbsp;&nbsp;&nbsp;公司的营业期限<#if ((ent.tradeTerm)!"")=="长期">长期<#else><U>${(ent.tradeTerm)!""}</U>年</#if>，自公司营业执照签发之日起计算。<br>
	</p>
	<p class='left-text'>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第十九条&nbsp;&nbsp;&nbsp;&nbsp;有下列情形之一的，公司清算组应当自公司清算结束之日起30日内向原公司登记机关申请注销登记：<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（一）公司被依法宣告破产；<br>
