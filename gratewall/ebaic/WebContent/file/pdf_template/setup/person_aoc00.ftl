...
<div class='second-title'> <span class='u'>&nbsp;${(ent.entName)!""}&nbsp;</span>章程 </div>
	...
	</div><div class='person-aoc-text'>
	  第二条  本章程中的各项条款与法律、法规、规章不符的，以法律、法规、规章的规定为准。</div>
	<br/>
	<div class='person-aoc-subtitle'>  &nbsp;&nbsp;&nbsp;&nbsp;第二章  公司名称和住所</div>
	<div class='person-aoc-text'> 
	  第三条  公司名称： <span class='u'>&nbsp;${(ent.entName)!""}&nbsp;</span>。</div><div class='person-aoc-text'>
	  第四条  住所： <span class='u'>&nbsp;${(ent.opLoc)!""}&nbsp;</span>。</div>
	<br/>
	<div class='person-aoc-subtitle'>&nbsp;&nbsp;&nbsp;&nbsp;第三章  公司经营范围</div>
	<div class='person-aoc-text'>
	  第五条  公司经营范围：<span class='u'>${(ent.businessScope)!""}</span>（以工商行政管理机关核定的经营范围为准。）</div>
	<br/>
	...
	<div class='person-aoc-text'>
	  ...
	  第七条  股东的姓名（名称）、认缴的出资额、出资期限、出资方式如下：</div>	<br/>
	...
	<div class='split'></div>
	  ...
	  第十三条  公司不设监事会，设监事<span class='u'>&nbsp;${(susp.suspCnt)!'0'}&nbsp;</span>人，由股东<span class='u'>&nbsp;<#assign isFirst=true><#if suspInfo??><#list suspInfo as susp><#if isFirst><#assign isFirst=false>${(susp.posBrForm)!""}</#if></#list></#if>&nbsp;</span>产生；监事的任期每届为三年，任期届满，可连选连任。</div>
	<div class='person-aoc-text'>
	  第十四条  监事行使下列职权：</div><div class='person-aoc-text'>
	...
	<div class='person-aoc-text'>
	  第十五条  <span class='u'> ${((le.leRepJob)!"")}</span>为公司的法定代表人。
	 </div>
	<div class='person-aoc-subtitle'>第七章  股东认为需要规定的其他事项</div>
	<div class='person-aoc-text'>
	  第十六条  公司的营业期限<#if ((ent.tradeTerm)!"")=="长期"><span class='u'>&nbsp;长期&nbsp;</span><#else><span class='u'>&nbsp;${(ent.tradeTerm)!""}&nbsp;</span>年</#if>，自公司营业执照签发之日起计算。</div>
	<div class='person-aoc-text'>
	  第十七条  有下列情形之一的，公司清算组应当自公司清算结束之日起30日内向原公司登记机关申请注销登记：</div><div class='person-aoc-text'>
	  （一）公司被依法宣告破产；</div><div class='person-aoc-text'>
