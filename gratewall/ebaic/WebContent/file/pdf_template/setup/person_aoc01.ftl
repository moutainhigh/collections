...
<div class='chapter-aoc'>
	 ...
	 <div class='person-aoc-subtitle'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;第二章  公司名称和住所</div><br/>
	 <div class='person-aoc-text'> 
	...
	<div class='person-aoc-subtitle'>&nbsp;&nbsp;&nbsp;第三章  公司经营范围</div><br/>
	<div class='person-aoc-text'>
	  	  第五条  公司经营范围：<span class='u'>${(ent.businessScope)!""}</span>（以工商行政管理机关核定的经营范围为准。）
	</div>
	<div class='person-aoc-subtitle'>第四章	公司注册资本及股东的姓名（名称）、出资方式、出资额</div><br/>
	<div class='person-aoc-text'>
	...
	<div class='aoc-notes1'>
	   ...
	   <div class='person-aoc-text'>
	   （二）选举和更换非由职工代表担任的执行董事、监事，决定有关执行董事、监事的报酬事项；</div><div class='person-aoc-text'>
	   （三）审议批准执行董事的报告；</div><div class='person-aoc-text'>
	   （四）审议批准监事会的报告；</div>
	   ...
	   （十）修改公司章程。</div><div class='person-aoc-text'>
	    ...
	    第十条  公司不设董事会，设执行董事一人，由股东<span class='u'>&nbsp;<#assign isFirst=true><#if boardInfo??><#list boardInfo as board><#if isFirst><#assign isFirst=false>${(board.posBrForm)!""}</#if></#list></#if>&nbsp;</span>产生。执行董事任期<span class='u'>&nbsp;&nbsp;<#assign isFirst=true><#if boardInfo??><#list boardInfo as board><#if isFirst><#assign isFirst=false>${(board.offYears)!""}</#if></#list></#if>&nbsp;&nbsp;</span>年，任期届满，可连选连任。</div><div class='person-aoc-text'>
	    第十一条  执行董事行使下列职权：</div><div class='person-aoc-text'>
	   ...
	   （十）制定公司的基本管理制度；</div><div class='person-aoc-text'>
	    ...
	    第十二条  公司设经理，由执行董事决定聘任或者解聘。经理对执行董事负责，行使下列职权：</div><div class='person-aoc-text'>
	   （一）主持公司的生产经营管理工作；</div><div class='person-aoc-text'>
	   （二）组织实施公司年度经营计划和投资方案；</div><div class='person-aoc-text'>
	   （三）拟订公司内部管理机构设置方案；</div><div class='person-aoc-text'>
	   ...
	   （七）决定聘任或者解聘除应由股东决定聘任或者解聘以外的负责管理人员；</div>
	...
	<div class='person-aoc-text'>
	    第十三条  公司设监事会，成员 <span class='u'>&nbsp;${(susp.suspCnt)!'0'}&nbsp;</span>人，由股东<span class='u'>&nbsp;<#assign isFirst=true><#if suspInfo??><#list suspInfo as susp><#if isFirst><#assign isFirst=false>${(susp.posBrForm)!""}</#if></#list></#if>&nbsp;</span>产生；监事会设主席一人，由全体监事过半数选举产生。监事会中股东代表监事与职工代表监事的比例为<span class='u'>&nbsp;${(bsc)!"0"}&nbsp;</span> ：<span class='u'>&nbsp;${(sc)!"0"}&nbsp;</span> 。</div><div class='person-aoc-text'>
        监事的任期每届为三年，任期届满，可连选连任。</div>
	<div class='person-aoc-text'>
	    第十四条  监事会行使下列职权：</div><div class='person-aoc-text'>
	   （一）检查公司财务；</div>
	    
	   <div class='person-aoc-text'>
	   （二）对执行董事、高级管理人员执行公司职务的行为进行监督，对违反法律、行政法规、公司章程或者股东会决议的执行董事、高级管理人员提出罢免的建议；</div>
	   
	   <div class='person-aoc-text'>
	   （三）当执行董事、高级管理人员的行为损害公司的利益时，要求执行董事、高级管理人员予以纠正；</div><div class='person-aoc-text'>
	   （四）向股东提出提案；</div><div class='person-aoc-text'>
	   （五）依照《公司法》第一百五十二条的规定，对执行董事、高级管理人员提起诉讼。</div>
	<div class='person-aoc-text'>
	    第十五条 监事会每年度至少召开一次会议，监事可以提议召开临时监事会会议。</div><div class='person-aoc-text'>
	    第十六条 监事会决议应当经半数以上监事通过。</div>
	...
	<div class='person-aoc-text'>
	    第十八条  公司的营业期限<#if ((ent.tradeTerm)!"")=="长期"><span class='u'>长期</span><#else><span class='u'>&nbsp;${(ent.tradeTerm)!""}&nbsp;</span>年</#if>，自公司营业执照签发之日起计算。
	</div>
	...
	<div class='person-aoc-text'>
	   ...
	   （六）法律、行政法规规定的其他解散情形。</div><div class='person-aoc-text'>
	    第二十条  一人有限责任公司的股东不能证明公司财产独立于自己的财产的，应当对公司债务承担连带责任。</div>
	<div class='person-aoc-subtitle'>第八章  附    则</div>
	<div class='person-aoc-text'>
	    第二十一条  公司登记事项以公司登记机关核定的为准。<br/>
	</div>
	 <#if ((req.state)!"")=="8">
			<div class="page-and-pages">第[page]页  &nbsp;&nbsp;共[sumPage]页</div>
	</#if>
