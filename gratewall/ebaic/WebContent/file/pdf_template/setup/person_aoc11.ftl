...
<div class='second-title'><span class='u'>&nbsp;${(ent.entName)!""}&nbsp;</span>章程 </div>
	...
	<div class='person-aoc-text'>
	  ...
	  （一）决定公司的经营方针和投资计划；</div><div class='person-aoc-text'>
	...
	<div class='aoc-notes1'>
	  ...
	  <div class='person-aoc-text'>
	  （五）审议批准公司的年度财务预算方案、决算方案；</div>
	 
	  <div class='person-aoc-text'>
	  （六）审议批准公司的利润分配方案和弥补亏损的方案；</div>
	  ...
	  <div class='person-aoc-text'>
	  （十一）公司章程规定的其他职权。</div><div class='person-aoc-text'>
	  第十二条  董事会会议由董事长召集和主持；董事长不能履行职务或者不履行职务的，由半数以上董事共同推举一名董事召集和主持。</div><div class='person-aoc-text'>
	  第十三条  董事会决议的表决，实行一人一票。</div><div class='person-aoc-text'>三分之一以上的董事可以提议召开董事会会议，并于会议召开前十日通知全体董事。</div><div class='person-aoc-text'>董事会对所议事项应由二分之一以上的董事表决通过方为有效，并应做成会议记录，出席会议的董事应当在会议记录上签名。</div><div class='person-aoc-text'>
	...
	<#list suspInfo as s>
	  ...
	  第十五条  公司设监事会，成员<span class='u'>&nbsp;${(susp.suspCnt)!'0'}&nbsp;</span>人，由股东<span class='u'>&nbsp;&nbsp;<#assign isFirst=true><#if suspInfo??><#list suspInfo as susp><#if isFirst><#assign isFirst=false>${(susp.posBrForm)!""}</#if></#list></#if>&nbsp;</span>产生；监事会设主席一人，由全体监事过半数选举产生。监事会中股东代表监事与职工代表监事的比例为<span class='u'>&nbsp;${(bsc)!"0"}&nbsp;</span> ：<span class='u'>&nbsp;${(sc)!"0"}&nbsp;</span> 。</div><div class='person-aoc-text'>
	...
	<div class='person-aoc-text'>
	  ...
	  （五）依照《公司法》第一百五十二条的规定，对董事、高级管理人员提起诉讼。　</div><div class='person-aoc-text'>
	  监事可以列席董事会会议。</div><div class='person-aoc-text'>
	  第十七条 监事会每年度至少召开一次会议，监事可以提议召开临时监事会会议。</div><div class='person-aoc-text'> 
	  第十八条 监事会决议应当经半数以上监事通过。
	</div>
	<div class='person-aoc-subtitle'>第六章  公司的法定代表人</div>
	<div class='person-aoc-text'>
	  第十九条   <span class='u'>${((le.leRepName)!"")}</span>为公司的法定代表人。
	 </div>
	  
	<div class='person-aoc-subtitle'>第七章  股东认为需要规定的其他事项</div>
	<div class='person-aoc-text'>
	  第二十条  公司的营业期限<#if ((ent.tradeTerm)!"")=="长期"><span class='u'>&nbsp;长期&nbsp;</span><#else><span class='u'>&nbsp;${(ent.tradeTerm)!""}&nbsp;</span>年</#if>，自公司营业执照签发之日起计算。</div><div class='person-aoc-text'>
	</div>
	<div class='person-aoc-text'>
	  第二十一条  有下列情形之一的，公司清算组应当自公司清算结束之日起30日内向原公司登记机关申请注销登记：</div><div class='person-aoc-text'>
	  ...
	  第二十二条   一人有限责任公司的股东不能证明公司财产独立于自己的财产的，应当对公司债务承担连带责任。
	</div>
	 <#if ((req.state)!"")=="8">
			<div class="page-and-pages">第[page]页  &nbsp;&nbsp;共[sumPage]页</div>
	</#if>
