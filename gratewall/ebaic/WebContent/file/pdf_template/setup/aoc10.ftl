...
<div class='second-title'><span class='u'>${(ent.entName)!""}</span>章程</div>
	...
	<div class='aoc-text'>
	 ...
	 <span class='u'> 
	 	 <#assign isFirst=true>
	 	  <#if natInvList??> 
	  		<#list  natInvList as ni><#if isFirst>
	  			<#assign isFirst=false><#else>、</#if>${(ni.inv)!""}
	  		</#list>
	  	 </#if>
		<#if unnatInvList??>
	...
	<div class='aoc-subtitle'>第四章	公司注册资本及股东的姓名（名称）<br/>、出资方式、出资额、出资时间</div><div class='aoc-text'>
	...
	<div class='aoc-text'>
	 ...
	 第十一条  股东会会议分为定期会议和临时会议。 召开股东会会议，应当于会议召开十五日以前通知全体股东。</div><div class='aoc-text'>
	 定期会议按每年定时召开。代表十分之一以上表决权的股东，三分之一以上的董事，监事提议召开临时会议的，应当召开临时会议。</div><div class='aoc-text'>
	 第十二条  股东会会议由董事会召集，董事长主持；董事长不能履行职务或者不履行职务的，由半数以上董事共同推举一名董事主持。
	董事会不能履行或者不履行召集股东会会议职责的，由监事召集和主持；监事不召集和主持的，代表十分之一以上表决权的股东可以自行召集和主持。</div>
	<#if ((req.state)!"")=="8">
			<div class="page-and-pages">第[page]页  &nbsp;&nbsp;共[sumPage]页</div>
	</#if>
	<div class='split'></div>
	...
	<div class='aoc-text'>
	 ...
	 <div class='aoc-text'>
	 第十四条  公司设董事会，成员为<span class='u'>&nbsp;${(board.boardCnt)!"0"}&nbsp;</span>人，由股东会选举产生。董事任期<span class='u'>&nbsp;3&nbsp;</span>年，任期届满，可连选连任。<br/>
	 ...
	 <br/>
	 <div class='aoc-notes1'>
	  本章程内容由股东在《股东确认暨指定（委托）书》中予以确认。<hr/></div>
	 <div class='aoc-text'>
	...
	<div class='aoc-text'>
	 ...
	 第十九条  公司不设监事会，设监事<span class='u'>&nbsp;${(susp.suspCnt)!'0'}&nbsp;</span>人，由股东会选举产生；监事的任期每届为三年，任期届满，可连选连任。</div>
	 
	 <div class='aoc-text'>
	 第二十条  监事行使下列职权：</div><div class='aoc-text'>
	 （一）检查公司财务；</div>
