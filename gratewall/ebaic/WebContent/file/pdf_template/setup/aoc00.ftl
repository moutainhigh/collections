...
<div class='chapter-aoc'>
	...
	<br/><div class='aoc-subtitle'>第一章    &nbsp;总     &nbsp;则&nbsp;</div>
	<div class='aoc-text'>
		第一条  依据《中华人民共和国公司法》（以下简称《公司法》）及有关法律、法规的规定，由 
			<span class='u'>
				<#assign isFirst=true>
				<#if natInvList??> <#list  natInvList as ni><#if isFirst><#assign isFirst=false><#else>、</#if>${(ni.inv)!""}</#list></#if>
				<#if unnatInvList??><#list unnatInvList as unni><#if isFirst><#assign isFirst=false><#else>、</#if>${(unni.inv)!""}</#list></#if>
	...
	<br/><div class='aoc-subtitle'>&nbsp;&nbsp;&nbsp;&nbsp;第二章  公司名称和住所</div>
	<div class='aoc-text'> 
	...
	<br/><div class='aoc-subtitle'>&nbsp;&nbsp;&nbsp;&nbsp;第三章  公司经营范围</div>
	<div class='aoc-text'>
	第五条  公司经营范围： <span class='u'>${(ent.businessScope)!""}</span>（以工商行政管理机关核定的经营范围为准。）<br/>
	</div>
	
	<br/><div class='aoc-subtitle'>第四章	公司注册资本及股东的姓名（名称）、<br />出资方式、出资额、出资时间</div>
	<div class='aoc-text'>
	...
	<div class='aoc-text'>
		...
		<table class='aoc-table'>
			...
			<tr>
				<td>认缴出资数额<br />（万元）</td><td>出资期限</td><td>出资方式</td>
			</tr>
			...
			<tr>
				<td>合计</td><td>${(sum)!"0"}</td><td colspan='2'>&nbsp;</td>
			</tr>
		</table>
	</div>
	...
	（四）审议批准监事的报告；</div><div class='aoc-text'>
	...
	定期会议按每年定时召开。代表十分之一以上表决权的股东，执行董事，监事提议召开临时会议的，应当召开临时会议。</div><div class='aoc-text'>
	...
	<div class='aoc-text'>
	第十四条  公司不设董事会，设执行董事一人，由股东会选举产生。执行董事任期 <span class='u'>&nbsp; 3 &nbsp;</span>年，任期届满，可连选连任。</div>
	
	<div class='aoc-text'>
	第十五条  执行董事行使下列职权：</div><div class='aoc-text'>
	（一）负责召集股东会，并向股东会议报告工作；</div>
	<br/>
	<div class='aoc-notes1'>
		本章程内容由股东在《股东确认暨指定（委托）书》中予以确认。
		<hr/>
	...
	<div class='aoc-text'>
	第十七条  公司不设监事会，设监事 <span class='u'>&nbsp; ${(susp.suspCnt)!'0'} &nbsp;</span>人，由股东会选举产生；监事的任期每届为三年，任期届满，可连选连任。
	</div>
	
	<div class='aoc-text'>
	第十八条  监事行使下列职权：</div><div class='aoc-text'>
	...
	<div class='aoc-text'>
	（四）提议召开临时股东会会议，在执行董事不履行本法规定的召集和主持股东会会议职责时召集和主持股东会会议；</div><div class='aoc-text'>
	（五）向股东会会议提出提案；</div><div class='aoc-text'>
	（六）依照《公司法》第一百五十二条的规定，对执行董事、高级管理人员提起诉讼。　</div><div class='aoc-text'>
	</div>
	...
	<div class='aoc-text'>
		第十九条 <span class='u'> &nbsp;${((le.leRepJob)!"")}&nbsp;</span>为公司的法定代表人。
	</div>
	 <br/><br/>
	...
	<div class='aoc-text'>
	第二十一条  股东向股东以外的人转让股权，应当经其他股东过半数同意。股东应就其股权转让事项书面通知其他股东征求同意，其他股东自接到书面通知之日起满三十日未答复的，视为同意转<br/>让。其他股东半数以上不同意转让的，不同意的股东应当购买该转让的股权；不购买的，视为同意转<br/>让。
	经股东同意转让的股权，在同等条件下，其他股东有优先购买权。两个以上股东主张行使优先购买权的，协商确定各自的购买比例；协商不成的，按照转让时各自的出资比例行使优先购买权。
	</div>
	
	<div class='aoc-text'>
	第二十二条  公司的营业期限 <span class='u'>&nbsp;${(ent.tradeTerm)!""}&nbsp;</span>年，自公司营业执照签发之日起计算。</div><div class='aoc-text'>
	第二十三条  有下列情形之一的，公司清算组应当自公司清算结束之日起30日内向原公司登记机关申请注销登记：</div><div class='aoc-text'>
