define(['require','jquery','entCommon','util'], function(require, $,entCommon,util){
	var applyDetail = {
		...
		getApplyDetailEnt : function(){
			var url = "../../../torch/service.do?fid=entAccountDetail&wid=entAccountDetail01&gid="+jazz.util.getParameter('gid');
			$("div[name='accountDetail_Form']").formpanel("option", "dataurl",url);
			$("div[name='accountDetail_Form']").formpanel("reload");
		},
		/**
		 * 以下几个方法均是采用模板渲染页面样式
		 */
