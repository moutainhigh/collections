...
function save() {
	if(pkFunction==null||pkFunction==""){//保存
		...
		var params = {
			...
			url:rootPath+'/auth/saveSmfunction2.do',//修改为最后提交时候增加功能 主键 和层次码
			...
			callback : function(data, r, res) {
				if (res.getAttr("back") == 'success') {
					...
					$('div[name="pkFunction"]').hiddenfield('setValue',res.getAttr("functionCode"));	 //设置功能代码和层次码
					//jazz.info("新增成功");
					window.parent.refreshright(pkSysIntegration,res.getAttr("functionCode"));
					jazz.info("新增成功");
				} else {
 					jazz.info("保存失败"); ;
				}
