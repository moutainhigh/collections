...
<body>
   <div id="formpanel" name="formpanel" vtype="formpanel" titledisplay="false" showborder="false" width="100%" layout="table" 
		...
		<div name='levelCode' id='levelCode' vtype="radiofield" label="显示为第一层" labelalign="right" labelwidth="100" width="80%" itemwidth="60" dataurl="[{value: '1',text: '是'},{checked: true,value: '2',text: '否'}]"></div>
