...
public class QueryUtils {
	...
	public String getHuaWuNum(List<Map> num) {
		...
		sb.append("<table border=0 cellpadding=0 cellspacing=0 width=1872 style='border-collapse:\n"
				...
				+ "  <td colspan=26 height=35 class=xl635167 width=1872 style='border-right:1.0pt solid black;\n"
	...
	public String getDjMoney(List<Map> num) {
		StringBuffer sb = new StringBuffer();
		sb.append("<html xmlns:o=\"urn:schemas-microsoft-com:office:office\"\n"
				+ "xmlns:x=\"urn:schemas-microsoft-com:office:excel\"\n"
				+ "xmlns=\"http://www.w3.org/TR/REC-html40\">\n"
	...
	public String getXwhMoney(List<Map> num) {
		...
		sb.append("<html xmlns:o=\"urn:schemas-microsoft-com:office:office\"\n"
				...
				+ "<meta name=ProgId content=Excel.Sheet>\n"
				+ "<meta name=Generator content=\"Microsoft Excel 15\">\n"
				+ "<link rel=File-List href=\"消委会登记信息涉及金额统计表.files/filelist.xml\">\n"
		...
		for (int i = 0; i < num.size(); i++) {
			sb.append("<tr height=20 style='height:15.0pt'>\n"
					+ " <td height=20 class=xl6416545 width=530 style='height:15.0pt;width:398pt'>　"
					+ num.get(i).get("消费类型")
					+ "</td>\n"
					+ " <td class=xl6316545 width=90 style='width:68pt'><span lang=EN-US>　"
					+ num.get(i).get("涉及金额")
					+ "</span></td>\n"
					+ " <td class=xl6316545 width=88 style='width:66pt'><span lang=EN-US>　"
					+ num.get(i).get("案值")
					+ "</span></td>\n"
					+ " <td class=xl6316545 width=87 style='width:65pt'><span lang=EN-US>　"
					+ num.get(i).get("经济损失") + "</span></td>\n" + "</tr>");
		}
		sb.append("</table>\n" + "</div>\n" + "</body>\n" + "</html>");
		return sb.toString();
