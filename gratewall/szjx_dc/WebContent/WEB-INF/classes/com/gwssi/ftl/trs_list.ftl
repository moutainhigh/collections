				 ...
				 <#else>
					...
					<div style="text-align: left;background-color:#BEBEBE;" class="sous_list">
						...
						<div >
							<h3>
								<a href="#"
									onclick="openWin('${trsbo.url?default("")}?enttype=${trsbo.r_enttype?default("")}&flag=0&economicproperty=${trsbo.changeType?default("")}&priPid=${trsbo.pid_pripid?default("")}') ">
									${trsbo.a_entName?default("")} (登记) &nbsp;&nbsp;
								</a>
							</h3>
							<p>
								<b>统一社会信用代码:</b>${trsbo.c_uniscid?default("")}&nbsp;&nbsp;&nbsp;&nbsp;<b>企业状态:</b>${trsbo.d_regstate?default("")}&nbsp;&nbsp;&nbsp;&nbsp;<b>企业类型:</b>${trsbo.r_cn_enttype?default("")}
