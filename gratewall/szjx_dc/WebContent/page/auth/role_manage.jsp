...
function fixColumn(event, obj) {//维护
	...
	for(var i=0;i<data.length;i++){
		var htm = '<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="维护" onclick="fixRole(\''+data[i]["pkSysIntegration"]+'\');"><img src="'+rootPath+'/static/images/other/forma-1.png" width="11px" height="11px" border="0"/></a>&nbsp;&nbsp;&nbsp;'
				+'</div>';
		data[i]["fix"] = htm; 
	}
	return data;
...
var fixwin;
function fixRole(pkSysIntegration) {
	$("iframe", parent.document).attr("src", rootPath+'/auth/getRole_fixHtml.do?pkSysIntegration='+pkSysIntegration);
}
