...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/receiveMode.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="接收方式_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>接收方式分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_jieshoufangshi_down.jsp", "_blank");
