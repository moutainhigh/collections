...
function initData(res){
	imporgid = res.getAttr("imporgid");
	loadData(imporgid);
}
function loadData(imporgid){
$('div[name="formpanel"]').formpanel('option','dataurl',rootPath+
		'/trsquery/querynzwzgqchuzhixxdata.do?imporgid='+imporgid);
...
<body>
    <div id="formpanel" name="formpanel" vtype="formpanel" showborder="false" titledisplay="false" height="100%" width="100%" layout="table" layoutconfig="{border:false,columnwidth:['50%','*']}">
        <div name="imporgid" vtype="textfield" label="股权出质信息ID" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
