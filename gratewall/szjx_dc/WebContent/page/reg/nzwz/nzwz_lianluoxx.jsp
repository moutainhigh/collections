	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["lmid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	}
	function viewDataSource(lmid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzlianluoxxform.do?lmid='+lmid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		title="联络员信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='lmid' text="联络员ID" textalign="center" width="0%"></div>
				...
				<div name='tel' text="联系电话" textalign="center" width="20%"></div>
				<div name='mobtel' text="移动电话" textalign="center" width="20%"></div>
