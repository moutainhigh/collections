...
<body>
	<div class="title_nav">当前位置：日志管理 > <span>业务流程日志</span></div>
		   ...
		   <div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" showborder="false" 
				...
				<div name='participantName' vtype="textfield" label="参与者姓名" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
				<div name='businessName' vtype="textfield" label="工作项名称" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
		   ...
		   <div vtype="gridpanel" name="gridpanel" id="gridpanel" width="100%" height="100%" layout="fit" showborder="false"
			 	 ...
			 	 <div vtype="gridcolumn" name="grid_column" id="grid_column">
					<div> <!-- 单行表头 -->
						...
						<div name="businessName"  text="工作项名称" textalign="center" sort="true" width="15%"></div>
						<div name="participantName" text="参与者" textalign="center" sort="true" width="10%"></div>
						<div name="processName" text="所在机构" textalign="center" sort="true" width="14%"></div>
						<div name="activityName" text="当前环节" textalign="center" sort="true" width="10%"></div>
						<div name="startTime" text="到达时间" textalign="center" sort="true" datatype="date" dataformat="YYYY-MM-DD HH:mm:ss" width="15%"></div>
