...
<body>
	<div class="title_nav">当前位置：日志管理 > <span>接口调用日志</span></div>
		   ...
		   <div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" 
				...
				<div name='reqPkSys' vtype="comboxfield" label="请求系统" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
				<div name='resPkSys' vtype="comboxfield" label="目标系统" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
