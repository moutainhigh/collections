...
<#list weaponMap?keys as key> 
 	<#--<#if weaponMap[key]??>--> 
		<#if cou%2==0>
			<#if key=="案件相关企业(机构)名称">
				<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td id="entnameurl" colspan="3" style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("")}</td>
		 	<#elseif key=="案件名称">
		 ...
		 <#else>
		 	<#if key=="案件相关企业(机构)名称">
		 		...
		 		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td id="entnameurl" style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;" colspan="3">${weaponMap[key]?default("")}</td></tr>
		 	<#elseif key=="案件名称">
		 		<td style="text-align: right;padding-right: 1px;"></td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;"></td></tr>
