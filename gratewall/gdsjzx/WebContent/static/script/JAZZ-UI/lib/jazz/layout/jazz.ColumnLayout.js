        ...
        _switch: function(cthis, $pre, $next, index, cols, e, num){
			if((index == 0 && this.iswest) || (this.iscolumnlayout && index == 0)){
				...
				if(this.west_open){
					...
					this.switchLeft.removeClass("jazz-column-btn-l").addClass("jazz-column-btn-r");
				}else{
					...
					this.west_open = true;
					this.switchLeft.removeClass("jazz-column-btn-r").addClass("jazz-column-btn-l");
				}
				if(e){
				...
				if(this.east_open){
					...
					this.switchRight.removeClass("jazz-column-btn-r").addClass("jazz-column-btn-l");
				}else{
					...
					this.east_open = true;
					this.switchRight.removeClass("jazz-column-btn-l").addClass("jazz-column-btn-r");
				}
				if(e){
