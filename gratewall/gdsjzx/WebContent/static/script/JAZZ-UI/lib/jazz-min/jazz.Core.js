			...
			if(!obj.state){
				...
				if(ruleType != 2){
					...
					$this.inputtext.off("mouseover.tooltip mouseout.tooltip blur.tooltip")
					  .on("mouseover.tooltip", function(){ $this.inputtext.tooltip("show"); })
					  .on("mouseout.tooltip",  function(){ $this.inputtext.tooltip("hide"); })
					  .on("blur.tooltip",  function(){ $this.inputtext.tooltip("hide"); });
				}
			}else{
		...
		fitlistener: {
			...
			start: function(){
				...
				var fitobject = null, parentobject = null, bodyobject = null, 
				    cacheFitHeight = [], parentHeight=0, siblingheight = 0, overflow_x = null, overflow_x = null;			
