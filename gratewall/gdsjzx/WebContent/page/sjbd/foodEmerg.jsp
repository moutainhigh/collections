...
<body>
			...
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='qymc' vtype="comboxfield" label="密级" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='zch' vtype="comboxfield" label="级别" dataurl="[{checked: true,value: '1',text: '分公司'},{value: '2',text: '总公司'},{value: '3',text: '集团'}]"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='ztfl' vtype="comboxfield" label="性质" dataurl="[{checked: true,value: '1',text: '分公司'},{value: '2',text: '总公司'},{value: '3',text: '集团'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="突发事件信息"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='orgno' text="标题" textalign="center" width="20%" ></div>
						<div name='registerno' text="区县" textalign="left" width="10%"></div>
						<div name='principal' text="性质" textalign="left" width="20%"></div>
						<div name='corpname' text="级别" textalign="left" width="25%"></div>
						<div name='subentitytype' text="密级" textalign="center" width="20%" ></div>
