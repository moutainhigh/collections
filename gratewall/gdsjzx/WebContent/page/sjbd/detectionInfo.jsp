...
<body>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="检测信息"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='orgno' text="样品名称" textalign="center" width="15%" ></div>
						<div name='registerno' text="商品分类" textalign="left" width="10%"></div>
						<div name='principal' text="生产企业名称" textalign="left" width="15%"></div>
						<div name='corpname' text="被检测企业名称" textalign="left" width="20%"></div>
						<div name='subentitytype' text="抽样区县" textalign="center" width="10%" ></div>
						<div name='certificatesno' text="抽样日期" textalign="center"  width="10%"></div>
						
						<div name='orgname' text="是否合格" textalign="left" width="10%"></div>
