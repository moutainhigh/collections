...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='czrq' vtype="datefield" label="登录日期自"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="datefield" label="至"  labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				...
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						...
						<div name='yhzh' text="访问次数" textalign="center" width="15%"></div>
					</div>
				</div>
				<!-- 表格 -->
				<!-- ../../grid/reg3.json -->
