...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='yhxm' vtype="comboxfield" label="用户名称" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="datefield" label="起始时间"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="datefield" label="结束时间"  labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="数据交换统计列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='czrq' text="用户名称" textalign="center" width="15%" ></div>
						<div name='czsj' text="用户代码" textalign="center" width="15%" ></div>
						<div name='yhzh' text="接口名称" textalign="center" width="15%"></div>
						<div name='yhxm' text="接口代码" textalign="center" width="15%"></div>
						<div name='jgmc' text="总记录数" textalign="center" width="15%"></div>
					</div>
				</div>
				<!-- 表格 -->
				<!-- ../../grid/reg3.json -->
