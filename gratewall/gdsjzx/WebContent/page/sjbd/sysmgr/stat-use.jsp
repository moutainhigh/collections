...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='ssjg' vtype="datefield" label="日期自" labelAlign="right" labelwidth='100px' width="410"></div>
				<div name='js' vtype="datefield" label="至"  labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="使用情况统计"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='orgno' text="机构名称" textalign="center" width="20%" ></div>
						<div name='registerno' text="数据查询条数" textalign="center" width="20%"></div>
						<div name='principal' text="登陆次数" textalign="center" width="20%"></div>
						<div name='corpname' text="下载次数" textalign="center" width="20%"></div>
						<div name='subentitytype' text="下载条数" textalign="center" width="20%" ></div>
					</div>
				</div>
				<!-- 表格 -->
				<!-- ../../grid/reg3.json -->
