...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='yhxm' vtype="textfield" label="用户代码" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="用户状态"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="用户类型"  labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="数据库共享对象列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='czrq' text="用户账号" textalign="center" width="15%" ></div>
						<div name='czsj' text="用户姓名" textalign="center" width="15%" ></div>
						<div name='yhzh' text="用户密码" textalign="center" width="15%"></div>
						<div name='yhxm' text="创建人" textalign="center" width="15%"></div>
						<div name='jgmc' text="创建日期" textalign="center" width="15%"></div>
						<div name='jgmc' text="用户类型" textalign="center" width="15%"></div>
						<div name='jgmc' text="状态" textalign="center" width="15%"></div>
						<div name='jgmc' text="是否配置" textalign="center" width="15%"></div>
