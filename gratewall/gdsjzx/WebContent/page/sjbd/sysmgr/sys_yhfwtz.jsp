...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='yhxm' vtype="comboxfield" label="所属机构" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label=""  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="登陆日期自"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="登陆日期至"  labelAlign="right"  labelwidth='100px' width="410"></div>
			...
			<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid'
				titledisplay="true" title="用户访问统计列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
				<!-- 表头 -->
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='czrq' text="机构名称" textalign="center" width="15%" ></div>
						<div name='czsj' text="用户姓名" textalign="center" width="15%" ></div>
						<div name='jgmc' text="访问次数" textalign="center" width="15%"></div>
					</div>
				</div>
				<!-- 表格 -->
				<!-- ../../grid/reg3.json -->
