...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='yhxm' vtype="comboxfield" label="角色名称" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="角色描述"  labelAlign="right"  labelwidth='100px' width="410"></div>
