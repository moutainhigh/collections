...
<body>
			<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
				...
				<div name='yhxm' vtype="textfield" label="视图代码" labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="textfield" label="视图名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
				<div name='czrq' vtype="comboxfield" label="创建日期自"  labelAlign="right"  labelwidth='100px' width="410"></div>
