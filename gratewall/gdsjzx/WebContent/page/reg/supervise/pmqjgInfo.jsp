...
<div vtype="gridpanel" name="jbxxGrid" height="230" width="100%"  id='jbxxGrid' dataloadcomplete=""  datarender="renderdata()" selecttype="1"	titledisplay="true" title="守重信息"  showborder="false" isshowselecthelper="false"  selecttype="2">
	<div vtype="gridcolumn" name="grid_column" width="98%">
		<div> 
			...
			<div name='attn' text="企业经办人" textalign="center"  width="20%"></div>
				<div name='consultingnumber' text="业务咨询与办理进度查询电话" textalign="center"  width="10%"></div>
			<div name='filenumber' text="文件字号" textalign="center"  width="17%"></div>
			<div name='accper' text="受理人员" textalign="center"  width="20%"></div>
			<div name='sector' text="受理机关" textalign="center"  width="20%"></div>
				<div name='totalfile' text="委托人的数量" visible="false" textalign="center"  width="10%"></div>
			<div name='type' text="结果类型" textalign="center"  width="17%"></div>
				<div name='date' text="备案结束日期" textalign="center"  width="10%"></div>
				<div name='result' text="如果驳回把原因写入这个result字段" visible="false" textalign="center"  width="10%"></div>
				<div name='requestid' text="对应的拍前备案请求的id" visible="false" textalign="center"  width="10%"></div>
		</div>
	</div>
