...
<div vtype="gridpanel" name="jbxxGrid" height="98%" width="100%"  id='jbxxGrid' dataloadcomplete=""  datarender="renderdata()"
	...
	<div vtype="gridcolumn" name="grid_column" width="100%">
		...
		<div name='resparmsign' text="执行事务合伙人（投资人、负责人）是否党员" textalign="center"  width="25%"></div>
		<div name='parinsisshow' text="是否公示" textalign="center" ></div>
		<div name='resparsecsign' text="执行事务合伙人（投资人、负责人）是否党组织书记" textalign="center" width="25%"></div>
