...
<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"  id='jbxxGrid' dataloadcomplete=""  datarender="renderdata()"
	...
	<div vtype="gridcolumn" name="grid_column" width="100%">
		...
		<div name='numparmisshow' text="是否公示" textalign="center"  width="0%"></div>
		<div name='parins' text="党组织建制" textalign="center" width="25%"></div>
		<div name='parinsisshow' text="是否公示" textalign="center" width="0%"></div>
		<div name='resparmsign' text="经营者/法定代表人/执行事务合伙人（投资人、负责人）/负责人是否党员" textalign="center"  width="25%"></div>
		<div name='parinsisshow' text="是否公示" textalign="center"  width="0%"></div>
		<div name='resparsecsign' text="经营者/法定代表人/执行事务合伙人（投资人、负责人）/负责人是否党组织书记" textalign="center" width="25%"></div>
		<div name='resparsecsignisshow' text="是否公示" textalign="center"  width="0%"></div>
	</div>
	</div>
	<!-- 表格 -->
