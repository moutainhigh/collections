...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/sczt/scztTable.js"></script>
	...
	<div vtype="paginator" name="grid_paginator" theme="2" pagerows="10"></div> 	
  	...
  	<div id="formpanel" class="formpanel_table1" style="height:250px;">
			...
			<table id="datashow" class="font_table" >
				...
				<tr><th class="class_td1">迁移类型:</th><th class="class_td5" id="row8"></th><th class="class_td1">备注:</th><th class="class_td2" id="row9"></th></tr>
			</table>
	</div>
</body>
</html>