...
<body>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div name="toolbar" vtype="toolbar">
			<div name="btn1" align="right" vtype="button" text="下载" click="download()"></div>
			<div name="btnq" align="right" vtype="button" text="返回" click="back()"></div>
    	</div>
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='regno' text="申请编号" textalign="center"  width="25%"></div>
				<div name='cbuitem' text="申请名称" textalign="center"  width="25%"></div>
				<div name='regorg' text="归档编号" textalign="center"  width="25%"></div>
				<div name='apprdate' text="归档日期" textalign="center"  width="25%"></div>
			</div>
		</div>
		<!-- 表格 -->
		<!-- ../../grid/reg3.json -->
