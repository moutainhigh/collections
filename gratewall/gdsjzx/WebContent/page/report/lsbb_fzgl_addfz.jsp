...
<body>
	...
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='zjhm' vtype="textfield" label="分组代码"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbsjq' vtype="textfield" label="分组名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='ggmc' vtype="textfield" label="分组主题"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="textfield" label="英文全称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt2' vtype="textfield" label="英文简称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt1' vtype="textfield" label="中文简称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		...
		<div name='fbmt22' vtype="radiofield" label="描述" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
