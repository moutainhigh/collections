...
function add(){
		window.open("<%=request.getContextPath()%>/page/report/lsbb_zbgl_addzb.jsp");
	}
</script>
</head>
<body>
	<div>位置:报表管理>历史报表>指标管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggmc' vtype="comboxfield" label="指标类型" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="comboxfield" label="计量单位" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt1' vtype="textfield" label="父指标" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='name' text="指标代码" textalign="center"  width="15%"></div>
				<div name='bbmc' text="指标名称" textalign="center"  width="15%"></div>
				<div name='regorg' text="父指标" textalign="center"  width="15%"></div>
				<div name='sex' text="指标类型" textalign="center"  width="15%"></div>
				<div name='regno' text="计量单位" textalign="center"  width="20%"></div>
				<div name='regno1' text="使用状态" textalign="center"  width="20%"></div>
