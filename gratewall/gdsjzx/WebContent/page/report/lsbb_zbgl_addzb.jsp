...
<body>
	<div>位置:报表管理>历史报表>指标管理>新增指标</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq555' vtype="textfield" label="指标名称" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		...
		<div name='fbmt2' vtype="radiofield" label="季度指标" dataurl="[{checked: true,value: '1',text: '是'},{value: '2',text: '否'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt3' vtype="radiofield" label="月度指标"  labelAlign="right" dataurl="[{checked: true,value: '1',text: '是'},{value: '2',text: '否'}]" labelwidth='100px' width="410"></div>
		<div name='fbmt4' vtype="radiofield" label="是否启用" dataurl="[{checked: true,value: '1',text: '是'},{value: '2',text: '否'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
