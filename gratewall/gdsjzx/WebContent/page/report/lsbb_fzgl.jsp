...
function add(){
		window.open("<%=request.getContextPath()%>/page/report/lsbb_fzgl_addfz.jsp");
	}
</script>
</head>
<body>
	<div>位置:报表管理>历史报表>分组管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggmc' vtype="comboxfield" label="主题" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='name' text="分组代码" textalign="center"  width="15%"></div>
				<div name='bbmc' text="分组名称" textalign="center"  width="20%"></div>
				<div name='regorg' text="简称" textalign="center"  width="15%"></div>
				<div name='sex' text="主题" textalign="center"  width="20%"></div>
				<div name='regno' text="使用状态" textalign="center"  width="20%"></div>
