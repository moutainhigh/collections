...
<body>
	...
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggmc3' vtype="textfield" label="使用状态" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='sex' text="主题" textalign="center"  width="15%"></div>
				<div name='bbmc' text="报告期别" textalign="center"  width="15%"></div>
				<div name='regorg' text="创建人" textalign="center"  width="15%"></div>
				<div name='regorg1' text="创建时间" textalign="center"  width="15%"></div>
				<div name='regno' text="使用状态" textalign="center"  width="15%"></div>
