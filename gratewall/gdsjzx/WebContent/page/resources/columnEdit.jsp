...
<body>
	<div id="formpanel_edit" name="formpanel_edit" vtype="formpanel"
		...
		<div name='regno' vtype="textfield" label="物理表" labelAlign="right"
			rule="must" width="400" labelwidth="130"></div>
		<div name='entname' vtype="comboxfield" label="业务系统名称"
			labelAlign="right" rule="must" width="400" labelwidth="130"
			dataurl='[{"text":"登记","value":"1"},{"text":"执法","value":"2"}]'></div>
		<div name='dmccb' vtype="textfield" label="数据量" labelAlign="right"
			width="400" labelwidth="130"></div>
		<div name='dmlMc' vtype="textfield" label="主键" labelAlign="right"
			width="400" labelwidth="130"></div>
			
		<div name='industryphy' vtype="comboxfield" label="表类型"
			labelAlign="right" rule="must" width="400" labelwidth="130"
			dataurl='[{"text":"业务","value":"1"},{"text":"系统","value":"2"},{"text":"历史","value":"3"}]'></div>
		
		<div name='industryco' vtype="textareafield" label="说明" labelAlign="right"
			width="850" labelwidth="130" height="60" colspan="2"></div>
		<div name='servicestate' vtype="textareafield" label="用途" labelAlign="right"
			width="850" labelwidth="130" height="60" colspan="2"></div>
