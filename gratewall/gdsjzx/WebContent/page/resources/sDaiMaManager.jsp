...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './sDaiMaEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改代码',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './sDaiMaAdd.jsp?update=true',
	  			name: 'win',
	  	    	title: '新增代码',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<body>
<div>位置：资源管理>数据标准管理>标准代码集管理>标准代码管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='regno1' vtype="textfield" label="代码值" labelAlign="right" labelwidth='100px' width="410"></div>
		<div name='estdate1' vtype="datefield" label="代码内容" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='regno' text="代码值" textalign="center"  width="25%"></div>
				<div name='regorg' text="代码内容" textalign="center"  width="25%"></div>
				<div name='enttype' text="说明" textalign="center"  width="25%"></div>
				<div name='custom' text="操作" textalign="center"  width="23%"></div>
			</div>
		</div>
		<!-- 表格 -->
		<!-- ../../grid/reg3.json -->
