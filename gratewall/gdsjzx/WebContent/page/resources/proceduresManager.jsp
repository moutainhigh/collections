...
function manager(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './proceduresEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改存储过程',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function query(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './proceduresDetail.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '查看存储过程',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<div>位置：资源管理>数据资源管理>存储过程管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='estdate' vtype="datefield" label="存储过程名称" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='regorg' text="存储过程名称" textalign="center"  width="15%"></div>
				<div name='servicestate' text="存储过程用途" textalign="center"  width="25%"></div>
