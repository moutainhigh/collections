...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './resourcesEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改代码集',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './resourcesEdit.jsp?update=true',
	  			name: 'win',
	  	    	title: '新增代码集',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<body>
<div class="page_place">位置：资源管理>数据源管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		showborder="false" layoutconfig="{cols:2, columnwidth: ['50%','*'],border:false}"  title="查询条件">

		<div name='regno' vtype="comboxfield" dataurl='[{"text":"国家标准","value":"1"},{"text":"行业标准","value":"2"}]' label="数据源类型" labelAlign="right" labelwidth='100px' width="410"></div>
		<div name='estdate' vtype="datefield" label="数据源IP" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='enttype' text="所属对象" textalign="center"  width="15%"></div>
				<div name='servicestate' text="业务系统" textalign="center"  width="10%"></div>
				<div name='regcap' text="数据源IP" textalign="center"  width="10%"></div>
				<div name='estdate' text="创建人" textalign="center"  width="15%"></div>
				<div name='regcap1' text="创建时间" textalign="center"  width="10%"></div>
