...
function renderdata(event, obj){
	...
	for(var i=0;i<data.length;i++){
		...
		data[i]["custom"] = '<div class="jazz-grid-cell-inner"><a href="javascript:void(0);" onclick="update(\''+pripid+'\')">修改</a>  <a href="javascript:void(0);" onclick="del(\''+pripid+'\')">删除</a> <a href="javascript:void(0);" onclick="query(\''+pripid+'\')">标准代码集</a></div>';
		data[i]["regorg"] = '<div class="jazz-grid-cell-inner"><a href="javascript:void(0);" onclick="detail(\''+pripid+'\')">'+a+'</a></div>';
	}
	return data;
}
function query(dmbId){
	window.open("<%=request.getContextPath()%>/page/resources/sDaiMaManager.jsp");     
}
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './sDaiMaJiEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改代码集',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './sDaiMaJiAdd.jsp?update=true',
	  			name: 'win',
	  	    	title: '新增代码集',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<body>
<div>位置：资源管理>数据标准管理>标准代码集管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='regno' vtype="textfield" label="代码集标识符" labelAlign="right" labelwidth='100px' width="410"></div>
		<div name='estdate' vtype="datefield" label="代码集名称" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='regorg' text="代码集标识符" textalign="center"  width="10%"></div>
				<div name='enttype' text="代码集名称" textalign="center"  width="15%"></div>
				<div name='servicestate' text="代码集类型" textalign="center"  width="10%"></div>
				<div name='regcap' text="标识符" textalign="center"  width="10%"></div>
				<div name='estdate' text="代码表" textalign="center"  width="15%"></div>
