...
function renderdata(event, obj){
	...
	for(var i=0;i<data.length;i++){
		...
		data[i]["custom"] = '<div class="jazz-grid-cell-inner"><a href="javascript:void(0);" onclick="update(\''+pripid+'\')">修改</a>  <a href="javascript:void(0);" onclick="del(\''+pripid+'\')">删除</a> <a href="javascript:void(0);" onclick="query(\''+pripid+'\')">维护主题库</a></div>';
	}
	return data;
}
function query(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './themeAlert.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '维护主题库',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './themeEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改主题库',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './themeEdit.jsp?update=true',
	  			name: 'win',
	  	    	title: '新增主题库',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<div>位置：资源管理>主题库管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='regno' vtype="comboxfield" dataurl='[{"text":"市场主体","value":"1"},{"text":"12315","value":"2"}]' label="主题库" labelAlign="center" labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='regno' text="主题库名称" textalign="center"  width="33%"></div>
				<div name='regorg' text="说明" textalign="center"  width="33%"></div>
				<div name='custom' text="操作" textalign="center"  width="33%"></div>
			</div>
		</div>
		<!-- 表格 -->
		<!-- ../../grid/reg3.json -->
