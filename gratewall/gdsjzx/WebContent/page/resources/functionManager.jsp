...
function manager(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './functionEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改函数',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function query(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './functionDetail.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '查看函数',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<div>位置：资源管理>数据资源管理>函数管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='estdate' vtype="datefield" label="函数名称" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='regorg' text="函数名称" textalign="center"  width="15%"></div>
				<div name='servicestate' text="函数用途" textalign="center"  width="25%"></div>
