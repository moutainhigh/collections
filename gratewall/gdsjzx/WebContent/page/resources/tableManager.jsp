...
function renderdata(event, obj){
	...
	for(var i=0;i<data.length;i++){
		...
		data[i]["regorg"] = '<div class="jazz-grid-cell-inner"><a href="javascript:void(0);" onclick="query()">'+a+'</a></div>';
	}
	return data;
}
function manager(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './tableEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改表信息',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<div>位置：资源管理>数据资源管理>表管理</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='entname' vtype="comboxfield" label="业务系统名称" dataurl="[{checked: true,value: '1',text: '登记'},{value: '2',text: '执法'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='enttype' text="业务系统" textalign="center"  width="10%"></div>
				<div name='regorg' text="物理表" textalign="center"  width="10%"></div>
				<div name='servicestate' text="物理表中文名" textalign="center"  width="10%"></div>
				<div name='estdate' text="表类型" textalign="center"  width="10%"></div>
				<div name='industryco' text="字段名" textalign="center"  width="10%"></div>
				<div name='industryphy' text="字段中文名" textalign="center"  width="10%"></div>
