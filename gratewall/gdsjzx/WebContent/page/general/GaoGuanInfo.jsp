...
<body>
	...
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggryxm' vtype="textfield" label="高管人员姓名"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm' vtype="textfield" label="证件号码"  labelAlign="right"  labelwidth='100px' width="410"></div>
