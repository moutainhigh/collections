...
<body>
	...
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq' vtype="textfield" label="社团名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbsjq1' vtype="textfield" label="法定代表人"  labelAlign="right"  labelwidth='100px' width="410"></div>
		
		<div name='zjhm' vtype="comboxfield" label="社团性质1" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="comboxfield" label="社团性质2" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
