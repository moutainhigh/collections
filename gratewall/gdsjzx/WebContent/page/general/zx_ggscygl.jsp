...
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq' vtype="textfield" label="姓名"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm' vtype="textfield" label="身份证号"  labelAlign="right"  labelwidth='100px' width="410"></div>
