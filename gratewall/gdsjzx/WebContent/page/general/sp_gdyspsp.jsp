...
function rowclick(event,data){
	window.open("<%=request.getContextPath()%>/page/general/sp_detail_gdyspsp.jsp?priPid="+data.pripid);
}
</script>
</head>
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggmc' vtype="textfield" label="广告经营许可证"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="comboxfield" label="所属分局" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='djdw' vtype="datefield" label="审批日期"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='djdw2' vtype="datefield" label="至"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='spmc' vtype="datefield" label="有效起始日期"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='djdw3' vtype="datefield" label="至"  labelAlign="right"  labelwidth='100px' width="410"></div>
