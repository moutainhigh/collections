...
<body>
	<div><a >位置:通用查询>12315信息>咨询</a></div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='zjhm' vtype="datefield" label="登记时间起"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm12' vtype="datefield" label="至登记时间"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm1' vtype="datefield" label="办结上报时间起"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm3' vtype="datefield" label="办结上报时间至"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm42' vtype="textfield" label="被咨询方注册号"  labelAlign="right"  labelwidth='100px' width="410"></div>
