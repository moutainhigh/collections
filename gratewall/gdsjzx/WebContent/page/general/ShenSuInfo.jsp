...
<body>
	<div><a >位置:通用查询>12315信息>申诉</a></div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='ggryxm1' vtype="textfield" label="登记单编号"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='ggryxm2' vtype="textfield" label="申诉人"  labelAlign="right"  labelwidth='100px' width="410"></div>
		...
		<div name='zjhm45' vtype="textfield" label="被投诉方注册号"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm6' vtype="textfield" label="被投诉方名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
