...
<hr style="color:#FCFCFC;"><hr  style="color:#FCFCFC;margin-left:-2px;">
	...
	<div name='estdate' vtype="textfield" label="登记单位" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='email' vtype="textfield" label="发布起始日期" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='abuitemco' vtype="textfield" label="发布截止日期" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='regorg' vtype="textfield" label="电视台发布次数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='postalcode' vtype="textfield" label="电视设计制作数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='tel' vtype="textfield" label="电视投入金额" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='cbuitem' vtype="textfield" label="电台发布次数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opscope' vtype="textfield" label="电台设计制作数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='localadm' vtype="textfield" label="电台投入金额" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opfrom' vtype="textfield" label="报纸发布次数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opto' vtype="textfield" label="报纸设计制作数" labelAlign="right" labelwidth='102px'  width="410"></div>
	...
	<div name='tel' vtype="textfield" label="网络投入金额" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opscope' vtype="textfield" label="网络设计制作数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='localadm' vtype="textfield" label="网络投入金额" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opto' vtype="textfield" label="短信设计制作数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='cbuitem' vtype="textfield" label="短信投入金额" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opfrom' vtype="textfield" label="短信发布次数" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='opfrom' vtype="textfield" label="备注" labelAlign="right" labelwidth='102px'  width="410"></div>
</div>
