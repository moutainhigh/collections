...
<hr style="color:#FCFCFC;"><hr  style="color:#FCFCFC;margin-left:-2px;">
	...
	<div name='regcap' vtype="textfield" label="发证日期" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='industryphy' vtype="textfield" label="培训单位名称" labelAlign="right" labelwidth='102px'  width="410"></div>
	<div name='industryco' vtype="textfield" label="工作单位" labelAlign="right" labelwidth='102px'  width="410"></div>
	...
	<div name='abuitemco' vtype="textfield" label="登记日期" labelAlign="right" labelwidth='102px'  width="410"></div>
</div>
