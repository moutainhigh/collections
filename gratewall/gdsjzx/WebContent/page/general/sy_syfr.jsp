...
<div>位置:通用查询>广告监管信息>事业法人</div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq' vtype="textfield" label="单位名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbsjq1' vtype="textfield" label="法定代表人"  labelAlign="right"  labelwidth='100px' width="410"></div>
		
		<div name='zjhm' vtype="comboxfield" label="事业法人类型" dataurl="[{checked: true,value: '1',text: '省局'},{value: '2',text: '广州市局'},{value: '3',text: '深圳市局'}]" labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="textfield" label="办公地址"  labelAlign="right"  labelwidth='100px' width="410"></div>
