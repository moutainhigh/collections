...
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		showborder="false" layoutconfig="{cols:2, columnwidth: ['50%','*'],border:false}" height="220" title="查询条件">

		<div name='ggryxm' vtype="textfield" label="媒体名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm1' vtype="textfield" label="媒体编号"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm2' vtype="textfield" label="负责人"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm3' vtype="textfield" label="单位名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
