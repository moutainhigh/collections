...
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq' vtype="textfield" label="活动名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm' vtype="datefield" label="发布时间"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='ggmc' vtype="datefield" label="至"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='fbmt' vtype="textfield" label="活动主题"  labelAlign="right"  labelwidth='100px' width="410"></div>
