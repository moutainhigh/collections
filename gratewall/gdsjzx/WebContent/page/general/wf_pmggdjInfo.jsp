...
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='fbsjq' vtype="datefield" label="发布时间起"   labelwidth='100px' width="410"></div>
		<div name='zjhm' vtype="datefield" label="发布时间至"   labelwidth='100px' width="410"></div>
		<div name='ggmc' vtype="textfield" label="广告名称"   labelwidth='100px' width="410"></div>
		...
		<div name='spmc' vtype="textfield" label="商品名称"   labelwidth='100px' width="410"></div>
