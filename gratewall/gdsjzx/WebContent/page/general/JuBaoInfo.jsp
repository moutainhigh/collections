...
<body>
	<div><a >位置:通用查询>12315信息>举报</a></div>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel" titledisplay="true" width="100%" layout="table" 
		...
		<div name='zjhm44' vtype="datefield" label="登记时间起"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm1' vtype="datefield" label="至登记时间"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm2' vtype="datefield" label="办结上报时间起"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm34' vtype="datefield" label="办结上报时间至"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm5' vtype="textfield" label="被举报方注册号"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<div name='zjhm6' vtype="textfield" label="被举报方名称"  labelAlign="right"  labelwidth='100px' width="410"></div>
		<
