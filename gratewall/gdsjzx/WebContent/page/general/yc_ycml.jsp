...
<body> 
		<div><a >位置:通用查询>异常名录</a></div>
		<div id="demo">
		<div name="tab_name" vtype="tabpanel" overflowtype="2" tabtitlewidth="130"  width="100%"  height="90%"
		layout="fit" layoutconfig="{height:['*']}" orientation="top" id="tab_name" >     
		    <ul>    
		        <li></li>    
		    </ul>    
		    <div > 
