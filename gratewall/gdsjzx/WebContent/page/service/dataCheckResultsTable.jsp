...
<body> 
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		titledisplay="true" title=">>数据总量一致性检查结果列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='sex' text="物理表" textalign="center"  width="25%"></div>
				<div name='regorg' text="数据量(基准数据源)" textalign="center"  width="25%"></div>
				<div name='regno' text="数据量（比对数据源）" textalign="center"  width="25%"></div>
				<div name='regno1' text="数据差异值" textalign="center"  width="25%"></div>
			</div>
		</div>
		<!-- 表格 -->
		<!-- ../../grid/reg3.json -->
