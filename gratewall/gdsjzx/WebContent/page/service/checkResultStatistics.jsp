					...
					<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender=""
						...
						<div vtype="gridcolumn" name="grid_column" width="100%">
							<div>
								...
								<div name='regno' text="业务系统" textalign="center"  width="12%"></div>
								<div name='enttype' text="期初问题点" textalign="center"  width="12%"></div>
								<div name='regorg' text="期初问题点" textalign="center"  width="12%"></div>
								<div name='servicestate' text="修改数量" textalign="center"  width="11%"></div>
								<div name='estdate' text="核实数量" textalign="center"  width="11%"></div>
								...
								<div name='custom' text="数据处理率" textalign="center"  width="20%"></div>
							</div>
						</div>
						<!-- 表格 -->
						<!-- ../../grid/reg3.json -->
		        ...
		        <div id="tab3">    
					...
					<div vtype="gridpanel" name="zzjgGrid2" height="400" width="100%"  id='zzjgGrid2' datarender=""
						...
						<div vtype="gridcolumn" name="grid_column" width="100%">
							<div>
								<div name='pripid'  width="0%"></div>
								<div name='regno' text="规则类型" textalign="center"  width="12%"></div>
								<div name='enttype' text="期初问题点" textalign="center"  width="10%"></div>
								<div name='regorg' text="期初问题点" textalign="center"  width="10%"></div>
								<div name='servicestate' text="修改数量" textalign="center"  width="12%"></div>
								<div name='estdate' text="核实数量" textalign="center"  width="12%"></div>
								<div name='industryco' text="留存问题数" textalign="center"  width="12%"></div>
								<div name='industryphy' text="检查点数量" textalign="center"  width="12%"></div>
		        ...
		        <div id="tab2">    
					...
					<div vtype="gridpanel" name="zzjgGrid1" height="400" width="100%"  id='zzjgGrid1' datarender=""
						...
						<div vtype="gridcolumn" name="grid_column" width="100%">
							<div>
								<div name='pripid'  width="0%"></div>
								<div name='regno' text="区县名称" textalign="center"  width="12%"></div>
								<div name='enttype' text="期初问题点" textalign="center"  width="12%"></div>
								<div name='regorg' text="期初问题点" textalign="center"  width="12%"></div>
								<div name='servicestate' text="修改数量" textalign="center"  width="12%"></div>
								<div name='estdate' text="核实数量" textalign="center"  width="11%"></div>
								<div name='industryco' text="留存问题数" textalign="center"  width="11%"></div>
								<div name='industryphy' text="检查点数量" textalign="center"  width="10%"></div>
								<div name='custom' text="数据处理率" textalign="center"  width="18%"></div>
							</div>
						</div>
