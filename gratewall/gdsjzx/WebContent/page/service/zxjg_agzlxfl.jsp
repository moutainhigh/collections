...
<body>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		titledisplay="true" title=">>按规则类型查看"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='name' text="主题" textalign="center"  width="25%"></div>
