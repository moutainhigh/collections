...
function detail(dmbId){
	winEdit = jazz.widget({
	     vtype: 'window',
	   	     frameurl: './routineExaminationDetail.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function run(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './checkExecutionProcess.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './routineExaminationEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改常规检查',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
	     vtype: 'window',
	     frameurl: './routineExaminationEdit.jsp',
	  			name: 'win',
	  	    	title: '新增常规检查',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='entname' text="创建人" textalign="center"  width="15%"></div>
				<div name='regorg' text="创建日期" textalign="center"  width="15%"></div>
				<div name='entname' text="活动类型" textalign="center"  width="15%"></div>
