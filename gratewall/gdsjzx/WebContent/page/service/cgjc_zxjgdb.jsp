...
<body>
	...
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div name="toolbar" vtype="toolbar">
			<div name="btn1" align="right" vtype="button" text="关闭" click="back()"></div>
    	</div>
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				
				<div name='name' text="区县代码" textalign="center"  width="10%"></div>
				<div name='sex' text="区县名称" textalign="center"  width="15%"></div>
				<div name='regorg' text="第一次检查总数" textalign="center"  width="15%"></div>
				<div name='regno' text="第二次检查总数" textalign="center"  width="15%"></div>
				<div name='name' text="新增问题点数" textalign="center"  width="15%"></div>
				<div name='sex' text="未修改的问题点数" textalign="center"  width="15%"></div>
				<div name='regorg' text="已修改的问题点数" textalign="center"  width="15%"></div>
