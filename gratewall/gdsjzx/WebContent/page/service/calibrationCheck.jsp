...
function detail(dmbId){
	winEdit = jazz.widget({
	     vtype: 'window',
	   	     frameurl: './dataCheckDetail.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function run(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './calibrationCheckTable.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './calibrationCheckEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改数据',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function add(){
	winEdit = jazz.widget({
	     vtype: 'window',
	     frameurl: './calibrationCheckEdit.jsp',
	  			name: 'win',
	  	    	title: '新增合标性检查',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<body>
<div>位置：数据服务>数据治理>合标性检查</div>
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		titledisplay="true" title="查询合标性检查活动列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
		<div name="toolbar" vtype="toolbar">
			<div name="btn1" align="right" vtype="button" text="增加合标性检查" click="add()"></div>
    	</div>
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='pripid' width="0%" ></div>
				<div name='regno' text="活动名称" textalign="center"  width="20%"></div>
				<div name='regorg' text="创建人" textalign="center"  width="18%"></div>
				<div name='regorg' text="创建日期" textalign="center"  width="20%"></div>
				<div name='entname' text="活动状态" textalign="center"  width="20%"></div>
