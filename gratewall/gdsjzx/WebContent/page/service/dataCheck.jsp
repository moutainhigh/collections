...
function run(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './dataExecutionProcess.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '检查数据量一致性检查过程 ',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,	
...
<body>
<div>位置：数据服务>数据治理>数据量一致性检查</div>
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		titledisplay="true" title="查询数据量检查活动列表"  dataurl="" layout="fit" showborder="false" isshowselecthelper="false" selecttype="2">
		<div name="toolbar" vtype="toolbar">
			<div name="btn1" align="right" vtype="button" text="新增数据量一致活动" click="add()"></div>
    	</div>
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='pripid' width="0%" ></div>
				<div name='regno' text="活动名称" textalign="center"  width="15%"></div>
				<div name='regorg' text="活动状态" textalign="center"  width="15%"></div>
				<div name='regorg' text="创建日期" textalign="center"  width="15%"></div>
				<div name='entname' text="基准数据源" textalign="center"  width="18%"></div>
				<div name='entname' text="比对数据源" textalign="center"  width="17%"></div>
