...
function detail(dmbId){
	winEdit = jazz.widget({
	     vtype: 'window',
	   	     frameurl: './customCheckDetail.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function run(dmbId){
	winEdit = jazz.widget({
 	     vtype: 'window',
	   	     frameurl: './customCheckExecutionProcess.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '执行',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
function update(dmbId){
	winEdit = jazz.widget({
  	     vtype: 'window',
	   	     frameurl: './customCheckEdit.jsp?dmbId='+dmbId+'&update=true',
	  			name: 'win',
	  	    	title: '修改自定义检查',
	  	    	titlealign: 'left',
	  	    	titledisplay: true,
...
<div>位置：数据服务>数据治理>自定义检查</div>
	<div vtype="gridpanel" name="zzjgGrid" height="400" width="100%"  id='zzjgGrid' datarender="renderdata()"
		...
		<div name="toolbar" vtype="toolbar">
			<div name="btn1" align="right" vtype="button" text="增加自定义检查" click="add()"></div>
    	</div>
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='entname' text="创建人" textalign="center"  width="20%"></div>
				<div name='regorg' text="创建日期" textalign="center"  width="20%"></div>
				<div name='regorg' text="活动状态" textalign="center"  width="19%"></div>
