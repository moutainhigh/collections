...
<frameset rows="*" cols="*" frameborder="no" border="no" framespacing="0" scrolling="no">
	<frame src="http://10.1.2.124/ibmcognos/cgi-bin/cognosisapi.dll?b_action=cognosViewer&ui.action=run&ui.object=%2fcontent%2ffolder%5b%40name%3d%27report%27%5d%2freport%5b%40name%3d%27%e4%b8%9a%e5%8a%a1%e5%88%86%e6%9e%90%27%5d&CAMUsername=<%=user%>&CAMPassword=<%=password%>&p_stDt=<%=stDt%>&p_edDt=<%=edDt%>&p_measure=<%=measure%>" />
</frameset>
<body>  
</body>
