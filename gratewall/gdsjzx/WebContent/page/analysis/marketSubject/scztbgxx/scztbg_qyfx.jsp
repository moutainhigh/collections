...
$(function(){
		var qsgsfx={
					tabid: 'qsgsfx',	
			 		...
			 		tabindex: '1',	
			 		taburl: '../qysldj/qysldj_qyfx_qsgsfx.jsp?at=${param.at}&bt=${param.bt}'
		};
		var qsgshcyfx={
					tabid: 'qsgshcyfx',	
			 		tabtitle: '各地产业分布情况-产业',	
			 		tabindex: '2',	
			 		taburl: '../qysldj/qysldj_qyfx_qsgshcyfx.jsp?at=${param.at}&bt=${param.bt}'
		};
		var qyhjjfx={
					tabid: 'qyhjjfx',	
			 		tabtitle: '企业及分布情况-经济性质',	
			 		tabindex: '3',	
			 		taburl: '../qysldj/qysldj_qyfx_qyhjjfx.jsp?at=${param.at}&bt=${param.bt}'
		};
