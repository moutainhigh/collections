...
function initCharts(){
	...
	getData(function(data){
		...
		drawHighCharts(xs,y1,y2,y3,$("#busType option:selected").text(), getSelectedMeasureCode());
	});
}
//获取measureCode
...
<div id="Container">
    <div class="headertop" id="Header" style="background:url(<%=request.getContextPath()%>/static/images/system/index/B-05.png); height:78px; width:98.5%;">
		...
		<!-- <label id="areaScopeLabe" for="区域范围">区域范围:</label><select class="btu" id="areaScope" name="dept_1" style="width: 150px;"></select> -->
