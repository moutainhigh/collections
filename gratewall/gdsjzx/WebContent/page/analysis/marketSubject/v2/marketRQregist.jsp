...
<body>
<!-- 时间维度:
    <input class="btu _first"  type="radio" id="dateType" name="gender" id="x" value="0" checked="checked"><label class="_first" style="" for="x">日</label>
    <input class="btu _first"  type="radio" id="dateType" name="gender" id="y" value="1"><label class="_first"  style="" for="y">月</label>
	<label id="showstart" class="just_endtime" style="" for="开始">从 </label><input style="" class="just_endtime btu" id="showstarttime" type="text" readonly="readonly" class="Wdate"
			value='2016-05-01' onclick="createWdatePickerStart();" /> 
	<label id="showend" class="just_endtime" style="" for="结束">至 </label><input  class="btu" id="showendtime" type="text" readonly="readonly" class="Wdate"
			value='2016-06-01' onclick="createWdatePickerEnd();"/> -->
<div id="Container">
	...
	<table id="header_table">
		<tr class="box_bgc_ef">
			...
			<td class='td2' colspan='3'>
              ...
              <input style="width:35%;background: #eff6fa" class='btu form-control3' id="showstarttime" type="text" readonly="readonly" class="Wdate" value='2016-05-01' onclick="createWdatePickerStart();" /> 
			  <span id="showend"  for="结束">至 </span>
			  <input style="width:35%;background: #eff6fa" class='btu form-control3' id="showendtime" type="text" readonly="readonly" class="Wdate" value='2016-06-01' onclick="createWdatePickerEnd();"/> </td>
			<!-- <td class="td1">指标:</td>
		...
		success : function(data_all) {
			if(data_all != null){
				...
				$('#container2').highcharts({
			        ...
			        subtitle: {
			            text: "本期登记户数-总数: " + sumS + " 本期登记注册资本(金)(万元)-总数: " + sumS1
			        },
			        credits:{
			        	enabled:false,
			        	text:'企业设立登记',
			        ...
			        yAxis: [{ title: {text: "本期登记注册资本(金)(万元)",style: {color: Highcharts.getOptions().colors[1]}},
			            ...
			            title: {text: "本期登记户数",style: {color: Highcharts.getOptions().colors[0]}}
			        }],
			        tooltip: {shared: true},
			        legend: {
			        	title:{text:'本期登记:'},
			        	labelFormatter:function(){
			        		...
			        		return this.name.replace('本期登记','').replace('(金)(万元)','<br>(金)(万元)');
			            },
			        	layout: 'vertical',
			            align: 'right',
			            verticalAlign: 'top',
...
function initCharts(){
	...
	requestData.out = 'time'; //双Y轴输出列需要time字段
		...
		success : function(data_all) {
			if(data_all != null){
				...
				$('#container').highcharts({
			        ...
			        yAxis: [{ min:0,
			        	 title: {text:"本期登记注册资本(金)(万元)",style: {color: Highcharts.getOptions().colors[1]}},
			            labels: {format: '{value} 万元',style: {color: Highcharts.getOptions().colors[1]}},
			            opposite: true
			        },{ // 户数
			        	min:0,
