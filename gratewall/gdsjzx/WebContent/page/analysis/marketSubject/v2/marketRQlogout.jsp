...
function initSecondCharts(time){
	...
	var measureCode = "001003,001004,002009" ;
	var isBG = '0'; //变更表
	...
	var titleNames = $("#dataType").val() == '1' ? 
			["期末实有户数","期末实有注册资本(金)(万元)"]:["本期注吊销户数","本期主体注销注册资本(金)(万元)"];
	$.ajax({
		...
		success : function(data_all) {
			if(data_all != null){
				var x = new Array();//各级地市
				var s = new Array(); //本期注销户数
				var s1 = new Array();//本期吊销户数
				var s2 = new Array();//本期注销注册资本(金)(万元)
				var sumS = 0;//本期注销户数总和
				var sumS1 = 0;//本期吊销户数总和
				var sumS2 = 0;//本期注销注册资本(金)(万元)总和
				var t;
				...
				$('#container2').highcharts({
			        ...
			        subtitle: {
			            text: "本期注销户数-总数: " + sumS + "   本期吊销户数-总数: " + sumS1 +"  本期主体注销注册资本(金)(万元)-总数: " + sumS2
			        },
			        xAxis: [{
			            categories: x,
			            crosshair: true
			        }],
			        yAxis: [{ title: {text: "本期主体注销注册资本(金)(万元)",style: {color: Highcharts.getOptions().colors[2]}},
			            labels: {format: '{value} 万元',style: {color: Highcharts.getOptions().colors[2]}},
			            opposite: true
			        },{ // 户数
			            labels: {format: '{value} ',style: {color: Highcharts.getOptions().colors[0] }},
			            title: {text: "本期户数",style: {color: Highcharts.getOptions().colors[0]}}
			        }],
			        tooltip: {shared: true},
			        legend: {
			        	title:{text:'本期:'},
			        	labelFormatter:function(){
			        		...
			        		return this.name.replace('本期','').replace('(金)(万元)','<br>(金)(万元)');
			            },
			        	layout: 'vertical',
			            align: 'right',
			            verticalAlign: 'top',
		...
		success : function(data_all) {
			if(data_all != null){
				...
				$('#container').highcharts({
			        ...
			        subtitle: {
			            text: "本期注销户数-总数: " + sumS + "   本期吊销户数-总数: " + sumS1 +"  本期主体注销注册资本(金)(万元): " + sumS2
			        },
			        credits:{
			        	enabled:false,
			        	text:'市场主体注吊销情况',
