	...
	$.ajax({
		...
		success : function(data) {
			...
			if(seriesName==data[i].v1){
				...
				$("#indusType").append("<option value='" + data[i].c + "'>" + data[i].v + "</option>");
				}
			}
...
<div id="Container">
	...
	<!-- 二级经济性质：<select id="indusType" multiple name="dept_1" style="width: 150px;"></select> -->
		<label id="indusTypeLabe" for="二级经济性质">二级经济性质:</label><select class="btu_select" id="indusType" name="dept_1" style="width: 150px;"></select>
