...
function getData(exe){
	...
	var data={measureCode:measureCode,enterpriseCode:enterpriseCode,startTime:showstarttime};
	if(_data_type_table)
		data.isBG = 1;
	$.ajax({
		url: '<%=request.getContextPath()%>/analysis/industryWithEnterPageInfo.do',
	    //	async : false,
		dataType : 'json',
		type : "POST", //请求方式
		data:data,
...
<div id="Container">
    <div class="headertop" id="Header">
		...
		</label><input class="btu" id="showstarttime" type="text" readonly="readonly" class="Wdate"
			value='2016-05-01' onclick="createWdatePickerStart();" /> 
		<label style="display:none" id="showend" for="结束">结束:</label><input style="display:none" class="btu_select Wdate" id="showendtime" type="text" readonly="readonly" 
		...
		<!-- 企业类型：<select id="enterpriseType" multiple name="dept_1" style="width: 150px;"></select> -->
