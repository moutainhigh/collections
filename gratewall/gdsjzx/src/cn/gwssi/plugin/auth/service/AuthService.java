...
public class AuthService extends BaseService {
     ...
     * @throws OptimusException
     */
    public List<Map> login(String login_name,String user_pwd) throws OptimusException {
//      boolean flag = false;
        IPersistenceDAO dao = getPersistenceDAO();
        String sql = "SELECT * from t_pt_yh t where login_name = '" + login_name 
            + "' and user_pwd = '" + user_pwd + "'  ";
        List<Map> list_user= dao.queryForList(sql, null);
    ...
    public List queryMenu(String login_name,boolean flag) throws OptimusException {
        ...
        if(Constants.SECURITY_AUTHCHECK && !flag){
            sqlSbf = new StringBuffer("select gn.gn_id as id, " +
                    "gn.sjgn_id as pid, gn.gn_mc as title ,gn.url as url,gn.xh as xh ,gn.sfcd as sfcd "
                    + "from t_pt_gn gn,t_pt_yhjs yhjs,t_pt_jsgn jsgn,t_pt_yh yh " 
                    + "WHERE gn.sf_yx='1' and sfcd='1'");
            ...
            sqlSbf = new StringBuffer("select t.gn_id as id, t.sjgn_id as pid, " +
                "t.gn_mc as title ,t.url as url ,t.xh,t.sfcd from t_pt_gn t where t.sf_yx='1' and sfcd='1'");
//        	  sqlSbf = new StringBuffer("select t.gn_id as id, t.sjgn_id as pid, " +
//                  "t.gn_mc as title ,t.url as url ,t.xh,t.sfcd, t.sf_yx from t_pt_gn t ");
        }
...
//  }
    ...
    public TPtJsBO getDefaultRole() throws OptimusException{
     ...
     //  List<Map> list= dao.queryForList("", null);
        return defaultJsBO;
    }
	 ...
	 * @throws OptimusException
	 */
	public List queryAppMenu(String login_name,boolean flag,String id) throws OptimusException {
		// TODO Auto-generated method stub
		IPersistenceDAO dao = getPersistenceDAO();
		StringBuffer sqlSbf = null;
		if(Constants.SECURITY_AUTHCHECK && !flag){
			...
			sqlSbf = new StringBuffer("select t.gn_id as id, t.sjgn_id as pid, " +
					"t.gn_mc as title ,t.url as url ,t.xh  from t_pt_gn t WHERE t.sjgn_id='"+id+"' ");
		}
		sqlSbf.append(" order by xh");
		List funcList = dao.queryForList(sqlSbf.toString(), null);
		return funcList;
