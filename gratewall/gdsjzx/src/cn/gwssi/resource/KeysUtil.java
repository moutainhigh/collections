...
public class KeysUtil {
	...
	public static void main(String[] args) throws Exception {
		//String str ="T10";
		String str ="10.1.7.246";
		System.out.println("原始："+str);
		String data = KeysUtil.desEncrypt("admin",KeysUtil.KEY);
		System.out.println("加密："+ data);
		System.out.println("解密："+KeysUtil.desDecrypt(data,KeysUtil.KEY));
		
		System.out.println(KeysUtil.desEncrypt("/440100"));
		/*ftp://10.21.5.177/440100/
		 * wghbm6efLh3v+kFp2OBf0w== 10.21.5.177
		 172.26.0.14 IFtnwxiJ6rwD78kV6i7Fiw==
		 /casefiles fIrLVLZ+4yMFev8Z9YMZPA==
		 uftp C3Pf8/Qn/HA=
		 desDecrypt
