			...
			_init: function(){
				...
				require(['domReady'], function (domReady) {
					    domReady(function () {
				    		...
				    		if(sExtSequence){
				    			$_this.queryFunctionConfig(sExtSequence);
				    		}
			 ...
			 /**
				 ...
				 */
			 queryFunctionConfig : function(sExtSequence){
				 var params = {
						 sExtSequence:sExtSequence
			    		};
				   //查询失信被执行人信息（DC_BL_LAOLAI）
				  //   var panelUrl="../../otherselect/getQueryById.do";
				     var panelUrl="../../otherselect/getQueryById.do?sExtSequence="+sExtSequence;
