	...
	torch = {
		 ...
		 */
	    	...
	    	exportFunc : function(){
	    		...
	    		$_this.post("../../BlackEntSelect/exportExcel.do", {address:address,houseCode:houseCode});
	    	},
	    	...
	    	queryPortalAppList : function(){
	    		...
	    		var gridUrl="../../BlackEntSelect/BlackEntQueryList.do";
	    		$("#blackEntQueryListGrid").gridpanel("option",'datarender',torch.backFunction);
	    		$("#blackEntQueryListGrid").gridpanel("option",'dataurl',gridUrl);
	    		$("#blackEntQueryListGrid").gridpanel('query', ['blackEntQueryListPanel'],null);
	    	...
	    	detailFunc:function(id){ 
	    		var type="detail";
	    		util.openWindow("portalApp_editOrAdd","详情",$_this.getContextPath()+"/page/comselect/blackEnt_editOrAdd.html?id="+id+"&type="+type,800,400);
	    	},
	    	editFunc:function(id){ 
	    		var type="edit";
	    		util.openWindow("portalApp_editOrAdd","编辑",$_this.getContextPath()+"/page/comselect/blackEnt_editOrAdd.html?id="+id+"&type="+type,800,400);
	    	},
	    	addFunc:function(){ 
	    		var type="add";
	    		util.openWindow("portalApp_editOrAdd","新增",$_this.getContextPath()+"/page/comselect/blackEnt_editOrAdd.html?type="+type,800,400);
	    	},
	    	/*
	    	 * 清除指定funcConfig
	    	 */
	    	delFunc:function(id){
	    		jazz.confirm("确认要删除该地址吗？",function(){
	    			var params = {
		    				url : '../../BlackEntSelect/BlackEntDelete.do',
		    				params:{
		    					"id":id
		    				},
...
//	    		alert(pathName);
	    	...
	    	edit_fromNames : [ 'blackEntQueryListPanel']
