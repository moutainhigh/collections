	...
	torch = {
		 ...
		 */
	    	...
	    	queryNBDetail : function(){
	    		var pripid = jazz.util.getParameter('pripid')||'';
	    		...
	    		$("#NBQueryDetailGrid").gridpanel("option",'datarender',torch.backFunction);
	    		$("#NBQueryDetailGrid").gridpanel("option","dataurlparams",params);
	    		$("#NBQueryDetailGrid").gridpanel("option",'dataurl',gridUrl);
	    		$("#NBQueryDetailGrid").gridpanel("reload");
			...
			backFunction:function (event, obj) {
	    		...
	    		for (var i = 0; i < data.length; i++) {
	    			...
	    			data[i]["opt"] = '<a href="javascript:void(0);" onclick="ebaic.NBDetailList(\''+data[i].ancheid+'\')">' + "查看" + '</a>'
