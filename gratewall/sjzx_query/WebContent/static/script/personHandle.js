...
function uploadSuccess(file, serverData) {
	try {
		...
		$.ajax({
			url:"../../readTxt/getStatus.do",
			type:"post",
			dataType:"json",
			success:function(data){
				$("#PersonQueryListGrid").gridpanel("option", "dataurl","../../readTxt/list.do");
				$("#PersonQueryListGrid").gridpanel("option", "datarender",createLoading);
				$("#PersonQueryListGrid").gridpanel("reload");
			},
			error:function(){
