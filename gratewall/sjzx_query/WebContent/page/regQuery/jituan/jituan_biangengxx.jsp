...
function initData(res){
	grpchangeid = res.getAttr("grpchangeid");
	loadData(grpchangeid);
}
function loadData(grpchangeid){
$('div[name="formpanel"]').formpanel('option','dataurl',rootPath+
		'/trsquery/queryjituanbiangengxxdata.do?grpchangeid='+grpchangeid);
...
<body>
    <div id="formpanel" name="formpanel" vtype="formpanel" showborder="false" titledisplay="false" height="100%" width="100%" layout="table" layoutconfig="{border:false,columnwidth:['50%','*']}">
        ...
        <div name="altdate" vtype="datefield" dataformat="YYYY-MM-DD" label="变更日期" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
