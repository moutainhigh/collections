...
.slideTxtBox .bd li span.region{width:250px;}
						...
						success:function(data){
							...
							for (var i = 0; i < dataStr.length; i++) {
								if(dataStr[i].operationDescribe == "快速查询"){
									...
									html ="<li><span>"+(q1)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l1").append(html);
								}
								if(dataStr[i].operationDescribe == "商事主体查询"){
									...
									html ="<li><span>"+(q2)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l2").append(html);
								}
								if(dataStr[i].operationDescribe == "重复地址查询"){
									...
									html ="<li><span>"+(q3)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l3").append(html);
								}
								if(dataStr[i].operationDescribe == "年报查询"){
									...
									html ="<li><span>"+(q4)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l4").append(html);
								}
								...
								if(dataStr[i].operationDescribe == "异常名录查询"){
									...
									html ="<li><span>"+(q5)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l5").append(html);
								}
								if(dataStr[i].operationDescribe.indexOf("证照")>0){
									...
									html ="<li><span>"+(q6)+"</span><span class='num uid'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l6").append(html);
								}
								 if(dataStr[i].operationDescribe.indexOf("电话")>0){
										...
										html ="<li><span>"+(q7)+"</span><span class='num uid'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
										$("#l7").append(html);
								}
								...
								if(dataStr[i].operationDescribe == "黑牌企业查询"){
									...
									html ="<li><span>"+(q8)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l8").append(html);
								}
								...
								if(dataStr[i].operationDescribe == "一人责任有限公司查询"){
									...
									html ="<li><span>"+(q9)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l9").append(html);
								}
								if(dataStr[i].operationDescribe == "失信被执行人查询"){
									...
									html ="<li><span>"+(q10)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l10").append(html);
								}
								if(dataStr[i].operationDescribe.indexOf("导出")>0){
									...
									html ="<li><span>"+(q11)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span><span class='num'>"+description+"</span></li>";
									$("#l11").append(html);
								}
							}
