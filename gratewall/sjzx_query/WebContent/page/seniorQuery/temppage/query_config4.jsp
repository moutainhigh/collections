...
<body>
<div class="title_nav">当前位置：高级查询> 高级查询> 高级查询> <span>新增高级查询</span></div>
		...
		<tr>
			...
			<tr>
				...
				<td align="center" valign="middle" width="5%" valign="top">
	   			...
	   			<td valign="top">
	   				<style>
	   					.selectColumsWrap{height: 200px;overflow-y:scroll; }
	   					.selectColumsWrap th{font-weight: normal;font-size: 12px}
	   					#getColumDetail td{border-bottom: 1px solid #f6f6f6;text-align: center;padding:4px 5px}
	   				</style>
