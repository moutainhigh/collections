...
$(function() {
   ...
   var toBackUrl = getUrlParam("toBackUrl");//跳转到后台的地址
   var headTitle = getUrlParam("headTitle");//标题
   var entityNo = getUrlParam("entityNo");
    if(entityNo ==null){
	   entityNo=1;
   } 
    if(toBackUrl==null){
    	toBackUrl="/NBselect/NBQYGTInfoQuery.do";
    } 
    if(headTitle !=null && headTitle.toString().length>1){
    	 headTitle=decode(headTitle);
    }else if(headTitle==null){
    	 headTitle="基本信息";
    } 
    var id = decode(parent.id);
...
<colgroup>
<col align="right" height="40px" width="165px" style="vertical-align: middle;background-color:#DCEEEF;border:1px solid #AFB0B1;border-left: 0px solid #AFB0B1;">
<col width="255px" style="vertical-align: middle;background-color:white;border:1px solid #AFB0B1;">
<col align="right" height="40px" width="165px" style="vertical-align: middle;background-color:#DCEEEF;border:1px solid #AFB0B1;">
<col width="255px" style="vertical-align: middle;background-color:white;border:1px solid #AFB0B1;">
</colgroup>
<tbody>
</tbody></table>
