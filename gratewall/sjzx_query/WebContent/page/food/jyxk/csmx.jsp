...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="场所模型项信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='placeName' text="场所地点" textalign="center" width="20%"></div>
				<div name='technologyName' text="工艺" textalign="center" width="20%"></div>
				<div name='processName' text="工序名称" textalign="center" width="20%"></div>
				<div name='processPlace' text="工序所在地" textalign="center" width="*"></div>
				<!--  <div name='licenseType' text="许可证类型" textalign="center" width="20%" dataurl="../code/xukezheng.json"></div> -->
