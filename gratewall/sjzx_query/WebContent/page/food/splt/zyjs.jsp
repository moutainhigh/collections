...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="专业技术人员信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='name' text="姓名" textalign="center" width="10%"></div>
				<div name='personType' text="人员类型" textalign="center" width="10%"></div>
				<div name='credentialType' text="证件类型" textalign="center" width="15%"></div>
				<div name='credentialNo' text="证件号码" textalign="center" width="15%"></div>
				<div name='telephone' text="联系电话" textalign="center" width="10%"></div>
				<div name='sex' text="性别" textalign="center" width="7%"></div>
				<div name='nationality' text="民族" textalign="center" width="7%"></div>
				<div name='detailAddress' text="户籍地址" textalign="center" width="15%"></div>
				<div name='duty' text="职务" textalign="center" width="*"></div>
			</div>
		</div>
		<!-- 表格 -->
