...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="检验产品信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='categoryUnit' text="申证单元" textalign="center" width="25%"></div>
				<div name='productionName' text="产品名称" textalign="center" width="25%"></div>
				<div name='bzmc' text="标准名称" textalign="center" width="25%"></div>
				<div name='standardNo' text="标准内容" textalign="center" width="25%"></div>
			</div>
		</div>
		<!-- 表格 -->
