	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["illegactid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	}
	function viewDataSource(illegactid){
		var title="详细信息";
		var frameurl=""+'/casequery/queryweifaxxform.do?illegactid='+illegactid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="违法行为及处罚信息" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- 案件当事人信息 -->
				<div name='illegactid' text="案件处罚ID" textalign="center" width="0%"></div>
				<div name='caseid' text="案件记录ID" textalign="center" width="0%"></div>
				<div name='illegact' text="违法行为" textalign="center" width="30%"></div>
				<div name='penbasis' text="处罚依据" textalign="center" width="30%"></div>
				<div name='penresult' text="处罚结果" textalign="center"></div>
