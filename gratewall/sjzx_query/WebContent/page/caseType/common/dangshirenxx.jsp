	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["casepartyid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	}
	function viewDataSource(casepartyid){
		var title="详细信息";
		var frameurl=""+'/casequery/querydangshirenxxform.do?casepartyid='+casepartyid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="当事人信息" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- 案件当事人信息 -->
				<div name='casepartyid' text="案件当事人ID" textalign="center" width="0%"></div>
				<div name='caseid' text="案件记录ID" textalign="center" width="0%"></div>
				<div name='unitname' text="当事人名称" textalign="center" width="30%"></div>
				<div name='regno' text="注册号" textalign="center" width="30%"></div>
				<div name='uniscid' text="统一社会信用代码" textalign="center"></div>
