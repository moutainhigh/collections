...
$('div[name="formpanel"]').formpanel('option','dataurl',rootPath+
		'/trsquery/queryYZWFSXData.do?id='+id);
...
<body>
 	<div id="formpanel" name="formpanel" vtype="formpanel" showborder="false" titledisplay="false" height="100%" width="100%" layout="table" layoutconfig="{border:false,columnwidth:['50%','*']}">
        	<div id="illrea" name="illrea" vtype="textfield" label="列入严重违法失信原因" labelwidth="150" labelalign="right" width="90%" rowspan="1" colspan="2" readonly="true"
			 tooltip="" rule="" ></div>
		 	...
		 	<div id="resoleunit" name="resoleunit" vtype="textfield" label="列入决定机关" labelwidth="150" labelalign="right" width="80%"  readonly="true"
		 	 tooltip="" rule=""></div>
		 	  ...
		 	  <div id="removereason" name="removereason" vtype="textfield" label="移出严重违法失信原因" labelwidth="150" labelalign="right" width="90%" rowspan="1" colspan="2" readonly="true"
			 tooltip="" rule=""></div>
		 	...
		 	<div id="removedept" name="removedept" vtype="textfield" label="移出决定机关" labelwidth="150" labelalign="right" width="80%" readonly="true"
		 	 ...
		 	 <div id="etype" name="etype" vtype="textfield" label="严重违法失信状态" labelwidth="150" labelalign="right" width="90%" readonly="true"
			 tooltip="" rule="" ></div>
