...
<script type="text/javascript">	
	...
	function viewDataSource(recid){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzqingsuanxxform.do?recid='+recid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		selecttype="1" titledisplay="true" title="清算信息" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='recid' text="清算信息编号" textalign="center" width="20%"></div>
