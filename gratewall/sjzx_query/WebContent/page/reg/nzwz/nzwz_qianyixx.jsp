...
<script type="text/javascript">
	...
	function viewDataSource(id){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzqianyixxform.do?id='+ id;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		title="迁移信息" defaultview="table" showborder="false"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='area' text="迁入/迁出地区" textalign="center" width="22%"></div>
				<div name='id' text="迁入/迁出id" textalign="center" width="0%"></div>
				<div name='pripid' text="主体身份代码" textalign="center" width="0%"></div>
				<div name='reason' text="原因" textalign="center" width="0%"></div>
				<div name='areregorg' text="所在地登记机关" textalign="center" width="20%"></div>
				<div name='rqdate' text="日期" textalign="center" width="20%"></div>
	...
	<div id="formpanel" class="formpanel_table" style="height: 150px;">
