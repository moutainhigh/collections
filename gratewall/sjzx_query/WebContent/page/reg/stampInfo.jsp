...
<script>
	...
	//数据渲染函数
      ...
      function handler(){
      //alert($('.jazz-grid-row').html()+"html...");
      //alert(document.getElementsByClassName('.jazz-grid-row')[0].innerHTML);
     // console.info(document.getElementsByClassName('.jazz-grid-row')[0]);
