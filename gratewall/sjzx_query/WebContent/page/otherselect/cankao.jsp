...
<body>
<div class="title_nav">当前位置：通用查询> 通用查询> <span>登记查询</span></div>
...
<input type="hidden" id="coditions" name="sky">
					...
					<tr>
						...
						<!-- <input type="text" style="height:25px; width:300px" name="estdate_start" value="" /> -->
							<div name="estdate_start" vtype="datefield" label="成立起始日期"  labelwidth="120" labelalign="right" width="350" height = "50" tooltip="" 
									rule="" readonly=""></div>
						...
						<!-- <input type="text" style="height:25px; width:300px" name="estdate_end" value="" /> -->
							<div name="estdate_end" id = "estdate_end" vtype="datefield" label="成立结束日期"  labelwidth="120" labelalign="right" width="350" height = "50" tooltip="" 
									rule="" readonly=""></div>
					...
					<tr>
						...
						<th class="class_td5 thleft" colspan="3">
							<div name="apprdate_start" vtype="datefield" label="核准起始日期"  labelwidth="120" labelalign="right" width="350" height = "50" tooltip="" 
										rule="" readonly=""></div>
						...
						<!--	<div  id ="div1" style="width:30px;height:1px;margin:5px auto;padding:0px;background-color:black;overflow:hidden;"></div> -->
							...
							<div name="apprdate_end" id = "apprdate_end" vtype="datefield" label="核准结束日期"  labelwidth="120" labelalign="right" width="350" height = "50" tooltip="" 
									rule="" readonly=""></div>
					...
					<tr>
						...
						<th class="class_td5 thleft" id="row5" >
							...
							至&nbsp;&nbsp;&nbsp;
							<input type="text" style="height:25px; width:38%" name="reccap_end" value="" />
						</th>
						<th class="class_td4">币种:</th>
						<th class="class_td5 thleft">
							<select name="regcapcur" id="regcapcur" style="height:25px; width:80%">
					...
					<tr>
						...
						<th class="class_td5 thleft" colspan="3"  >
							<div class="hangjianju">
								...
								<font class="fontwidth"> <input name="regstate"  class="inputjuzhong" type="checkbox" value="1" /> 存续</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="2" /> 吊销</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="3" /> 注销</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="4" /> 迁出</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="6" /> 停业</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="7" /> 个体暂时吊销</font>
								<font class="fontwidth"> <input name="regstate"     class="inputjuzhong" type="checkbox" value="8" /> 撤销登记</font>
								<font class="fontwidth" style="width:100px;"> <input name="regstate"      class="inputjuzhong" type="checkbox" value="9" /> 其他</font>		
