...
$('div[name="formpanel"]').formpanel('option','dataurl',rootPath+
		'/blackent/blackenttouzirenxxdata.do?id='+personid);
...
<body>
    <div id="formpanel" name="formpanel" vtype="formpanel" showborder="false" titledisplay="false" height="100%" width="100%" layout="table" layoutconfig="{border:false,columnwidth:['50%','*']}">
        <div name="inv" vtype="textfield" label="投资人" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        ...
        <div name="blictype" vtype="textfield" label="证照类型" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="blicno" vtype="textfield" label="证照号码" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="country" vtype="textfield" label="国家（地区）" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="currency" vtype="textfield" label="币种" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        ...
        <div name="conform" vtype="textfield" label="出资方式" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="condate" vtype="textfield" label="出资日期" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="baldelper" vtype="textfield" label="余额缴付期限" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
        <div name="conam" vtype="textfield" label="出资额" maxlength="50" labelwidth="100" labelAlign="right" width="90%"></div>
