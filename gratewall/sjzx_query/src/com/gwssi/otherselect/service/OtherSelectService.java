...
public class OtherSelectService extends BaseService{
	...
	public List<Map> getNbStatisticsInfo(String code,String time) throws OptimusException {
		...
		if(code == null&&isEmpty(time)){
			...
			stringBuffer.append("select y.type,y.code, y.codename,nz_ybnum+wz_ybnum as qy_ybnum,(y.nz_wbnum+y.wz_wbnum)  as qy_yjnbnum ,round(((y.nz_wbnum+y.wz_wbnum)/(nz_ybnum+wz_ybnum))*100,2)||'%' as qy_nbl,y.nz_ybnum,y.nz_wbnum as nz_yjnbnum,round((y.nz_wbnum / y.nz_ybnum) * 100, 2) || '%' as nz_nbl,")
					.append(" y.wz_ybnum, y.wz_wbnum as wz_yjnbnum,round((y.wz_wbnum/ y.wz_ybnum) * 100, 2) || '%' as wz_nbl,y.gt_ybnum,y.gt_wbnum as gt_yjnbnum,round((y.gt_wbnum / y.gt_ybnum) * 100, 2) || '%' as gt_nbl,t.codename as parentCodeName")
					.append(" from (select a.code,a.codename,a.sort,a.type,sum(b.nz_ybnum) as nz_ybnum,sum(b.nz_wbnum) as nz_wbnum,sum(b.wz_ybnum) as wz_ybnum,")
					.append(" sum(b.wz_wbnum) as wz_wbnum,sum(gt_ybnum) as gt_ybnum,sum(gt_wbnum) as gt_wbnum,a.parentcode,b.fjcode from dc_bm_gxqy a, dc_nb_tj b where a.code = b.fjcode and a.type = '5' ")
					.append(" and b.tj_date = (select max(tj_date) from dc_nb_tj) group by a.code, a.codename, a.sort, a.type,a.parentcode,b.fjcode union all select a.code, a.codename, a.sort,")
					.append(" a.type,sum(b.nz_ybnum) as nz_ybnum, sum(b.nz_wbnum) as nz_wbnum, sum(b.wz_ybnum) as wz_ybnum, sum(b.wz_wbnum) as wz_wbnum,")
					.append(" sum(gt_ybnum) as gt_ybnum, sum(gt_wbnum) as gt_wbnum,a.parentcode,b.fjcode from dc_bm_gxqy a, dc_nb_tj b where a.code = b.gsscode and a.type = '6' ")
					.append(" and b.tj_date = (select max(tj_date) from dc_nb_tj) group by a.code, a.codename, a.sort, a.type，a.parentcode,b.fjcode) y left join dc_bm_gxqy t on y.parentcode = t.code  where y.type = '5' order by y.sort");
			...
			//前台如果传有time过来的话，并且time 不为空的话，进如下的内容
			stringBuffer.append("select y.type,y.code, y.codename,nz_ybnum+wz_ybnum as qy_ybnum,(y.nz_wbnum+y.wz_wbnum)  as qy_yjnbnum ,round(((y.nz_wbnum+y.wz_wbnum)/(nz_ybnum+wz_ybnum))*100,2)||'%' as qy_nbl,y.nz_ybnum,y.nz_wbnum as nz_yjnbnum,round((y.nz_wbnum / y.nz_ybnum) * 100, 2) || '%' as nz_nbl,")
			.append(" y.wz_ybnum, y.wz_wbnum as wz_yjnbnum,round((y.wz_wbnum/ y.wz_ybnum) * 100, 2) || '%' as wz_nbl,y.gt_ybnum,y.gt_wbnum as gt_yjnbnum,round((y.gt_wbnum / y.gt_ybnum) * 100, 2) || '%' as gt_nbl,t.codename as parentCodeName")
			.append(" from (select a.code,a.codename,a.sort,a.type,sum(b.nz_ybnum) as nz_ybnum,sum(b.nz_wbnum) as nz_wbnum,sum(b.wz_ybnum) as wz_ybnum,")
			.append(" sum(b.wz_wbnum) as wz_wbnum,sum(gt_ybnum) as gt_ybnum,sum(gt_wbnum) as gt_wbnum,a.parentcode,b.fjcode from dc_bm_gxqy a, dc_nb_tj b where a.code = b.fjcode and a.type = '5' ")
			.append(" and b.tj_date = ? group by a.code, a.codename, a.sort, a.type,a.parentcode,b.fjcode union all select a.code, a.codename, a.sort,")
			.append(" a.type,sum(b.nz_ybnum) as nz_ybnum, sum(b.nz_wbnum) as nz_wbnum, sum(b.wz_ybnum) as wz_ybnum, sum(b.wz_wbnum) as wz_wbnum,")
			.append(" sum(gt_ybnum) as gt_ybnum, sum(gt_wbnum) as gt_wbnum,a.parentcode,b.fjcode from dc_bm_gxqy a, dc_nb_tj b where a.code = b.gsscode and a.type = '6' ")
			.append(" and b.tj_date = ? group by a.code, a.codename, a.sort, a.type，a.parentcode,b.fjcode) y left join dc_bm_gxqy t on y.parentcode = t.code  where y.type = '5' order by y.sort");
			...
			.append(" a.type,sum(b.nz_ybnum) as nz_ybnum, sum(b.nz_wbnum) as nz_wbnum, sum(b.wz_ybnum) as wz_ybnum, sum(b.wz_wbnum) as wz_wbnum,")
			.append(" sum(gt_ybnum) as gt_ybnum, sum(gt_wbnum) as gt_wbnum,a.parentcode,b.fjcode from dc_bm_gxqy a, dc_nb_tj b where a.code = b.gsscode and a.type = '6' ")
			.append(" and b.tj_date = (select max(tj_date) from dc_nb_tj) group by a.code, a.codename, a.sort, a.type，a.parentcode,b.fjcode) y left join dc_bm_gxqy t on y.parentcode = t.code where y.parentcode = ?  and y.fjcode  = ? order by y.sort");
