...
public class YCSelectController{
	...
	@RequestMapping("/YCEntList")
	public void YCEntList(OptimusRequest req, OptimusResponse resp) throws OptimusException {
			Map<String, String> form = req.getForm("CFQueryListPanel");
			List<Map> lstParams= ycSelectService.getEntList(form,req.getHttpRequest());
	...
	public void CFQueryList(OptimusRequest req, OptimusResponse resp) throws OptimusException {
			...
			List<Map> lstParams= ycSelectService.getSXList(entid,req.getHttpRequest());
			//System.out.println(lstParams.toString());
			resp.addGrid("CFQueryListGrid",lstParams);
		}
