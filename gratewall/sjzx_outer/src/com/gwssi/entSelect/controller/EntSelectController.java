...
public class EntSelectController {
	...
	public void detailedInfo(OptimusRequest req, OptimusResponse resp)
	...
	public void detailByLike(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String ip = IPUtil.getIpPropAddr(req.getHttpRequest());
		int count = safeService.count(ip);
	...
	@SuppressWarnings("rawtypes")
	@RequestMapping("/tag")
	public void getEntDetailBytagSwitchId(OptimusRequest req,
			OptimusResponse resp) throws OptimusException {
	...
	public void getEntMother(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
	...
	public void getEntBGDetail(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String id = req.getParameter("id").trim();
		String alttime = req.getParameter("alttime").trim();
		List<Map> res = typeChange(entSelectService.queryBiangengDetail(id, alttime));
		resp.addAttr("data", res);
	}
	...
	public void getEntBGDetail2(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String altitemcode = req.getParameter("altitemcode").trim();
		String regino = req.getParameter("regino").trim();
		List<Map> res = entSelectService.queryBiangengDetail2(altitemcode,regino);
		resp.addAttr("data", res);
	}

	//企业是否有异常名录，用于显示当前企业是否正常
	@RequestMapping("/entStatus")
	public void getEntIsNormal(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String id = req.getParameter("id").trim();
		String count = entSelectService.getEntIsNormal(id);
		resp.addAttr("data", count);
	}
	...
	//年检
	@RequestMapping("/nj")
	public void entnj(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
	...
	//年报
	@RequestMapping("/nb")
	public void entnb(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
	...
	public void queryFDDBR(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String id = req.getParameter("id");
	...
	//经营者姓名
	@RequestMapping("/jyz")
	public void queryJYZ(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String id = req.getParameter("id");
	...
	public void queryZXHHR(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
		String id = req.getParameter("id");
	...
	public void wpdb(OptimusRequest req, OptimusResponse resp) throws OptimusException {
		...
		/*if(!(invatt.equals("自然人"))){
			List list = entSelectService.wpdb(id);
			resp.addAttr("data", list);
		}else{
			resp.addAttr("data","0");
		}*/
	...
	public void entListDetail(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
			String unifsocicrediden = req.getParameter("unifsocicrediden");
		    String entname = req.getParameter("entname");
		    String regno = req.getParameter("regno");
	...
	public void entPrint(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
	...
	public void getEntPrint(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
	 ...
	 */
	@RequestMapping("/dcdy")
	public void getDCDY(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
			String id = req.getParameter("id");
			String flag = req.getParameter("flag");
	...
	public void queryBranch(OptimusRequest req, OptimusResponse resp)
			throws OptimusException {
			String id = req.getParameter("id");
