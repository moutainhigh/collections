...
@Service
public class SafeFoodVisitService  extends BaseService {
	...
	public void saveIPLog(String ip) throws OptimusException {
		...
		pramas.add("1");
		pramas.add("0");
		String sql = "insert into dc_t_outer_food_ip_log_t (ipuid, ipadd, visittime, isdele, isbackmenu) values (?,?,sysdate,?,?)";
	...
	public Integer count(String ip) throws OptimusException {
		...
		StringBuffer sql = new StringBuffer("select count(1) as count from v_outer_food_ip_log t ");
