...
<body>
	<div class="title_nav">当前位置：日志管理 > <span>数据交换日志</span></div>
		   ...
		   <div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" showborder="false" 
				...
				<div name='requestSystem' vtype="comboxfield" label="目标数据源" labelalign="right" labelwidth="120" 
				  	 dataurl='[{"text":"中心库","value":"0"},{"text":"主题库","value":"1"}]' width="90%" editable="true"></div>
				<div name='targetSystem' vtype="textfield" label="任务名称" labelalign="right" labelwidth="120" width="90%" editable="true"></div>
