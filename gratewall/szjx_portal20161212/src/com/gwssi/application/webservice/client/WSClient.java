...
public class WSClient {
	...
	public static final String targetNamespace = "http://www.gwssi.com.cn";

	// 服务名 serviceName
	public static final String serName = "authority";

	// 端口名 portName
	public static final String pName = "webServices";

	// 服务地址 endpointAddress
	public static final String endpointAddress = "http://localhost:8888/authority/webServices?wsdl";

	// 方法名 operationName
	public static final String OPER_NAME = "getFunc";

	// 参数名 @WebParam
	public static final String INPUT_NMAE = "xmlParam";

	public static String param() {
		HashMap dataMap = new HashMap();
		dataMap.put("APP_CODE", "SZBZ");
		dataMap.put("POST", "des87b33d0344ecb354afd64c859717,de9991b8d44ecb354afd64c859717");
