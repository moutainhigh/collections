...
public class AppConstants {
	 ...
	 * 应用系统集成表-类型
	 */
	public final static String SYSTEM_TYPE_SYS="SYS"; //系统类型
	public final static String SYSTEM_TYPE_NOSYS="NOSYS";//业务
	
	/**
	 * 应用系统集成表-层次
	 */	
	public final static String SYSTEM_lEVEL_CODE="1";//第一层
	
	/**
	 * 操作日志类型
	 */
	public final static String LOG_OPERATE_INIT = "00"; //初始化
	public final static String LOG_OPERATE_QUERY = "01"; //查询
	public final static String LOG_OPERATE_ADD = "02"; //添加
	public final static String LOG_OPERATE_DELETE = "03"; //删除
	public final static String LOG_OPERATE_UPDATE = "04"; //修改
	public final static String LOG_OPERATE_SAVE = "05"; //保存
