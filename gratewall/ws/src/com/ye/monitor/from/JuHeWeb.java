...
//https://www.cnblogs.com/jxldjsn/p/5713673.html
/**
*股票查询调用示例代码 － 聚合数据
...
public class JuHeWeb {
	...
	public  String getRequest1(String code){
        String result =null;
        String url ="http://web.juhe.cn:8080/finance/stock/hs";//请求接口地址
        Map params = new HashMap();//请求参数
            params.put("key",APPKEY);//应用APPKEY(应用详细页查询)
            params.put("type","json");//返回数据的格式,xml或json，默认json
            params.put("gid",code);//股票名称
        try {
           ...
           // System.out.println(result);
            ...
            if(object.getInteger("error_code")==0){
               // System.out.println(object.get("result"));
				...
				JSONArray personList = object.getJSONArray("result");
				String str = personList.getJSONObject(0).getString("data");
				JSONObject temp = JSON.parseObject(str);
				System.out.println(temp);
				System.out.println(temp.get("name"));
            	String stockInfo = temp.get("name") + ","  +temp.get("nowPri")+ ","+temp.get("todayStartPri")+ "," + temp.get("yestodEndPri");
                return stockInfo;
            }else{
