...
public class Data03Service extends BaseDao{
   ...
   public List getListByNianChuDaoBenYue(String begTime,String endTime) {
		...
		sql+=
				"select t.*,p.总数 from\n" +
					...
					//	"where X.ESTDATE<=TO_DATE("+endTime+",'YYYY-MM-DD hh24:mi:ss')\n" ;
						...
						sql+= " and to_char( X.ESTDATE,'yyyy-mm-dd') >= "+begTime+"  \n" ;
    ...
    * @return
    */
   public List getListByDangQi(String begTime,String endTime) {
	...
	public static void main(String[] args) throws ParseException {
		...
		Data03Service ss = ac.getBean(Data03Service.class);
		...
		ss.getListByNianChuDaoBenYue(begTime, endTime);
	}
