...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/industryType.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="行业类型_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>行业类型分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_hangyeleixing_down.jsp", "_blank");
