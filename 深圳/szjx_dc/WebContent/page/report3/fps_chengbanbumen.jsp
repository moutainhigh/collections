...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/handleDept.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="承办部门_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>承办部门分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_chengbanbumen_down.jsp", "_blank");
