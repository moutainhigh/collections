...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/issueNature.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="问题性质_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>问题性质分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_wentixingzhi_down.jsp", "_blank");
