...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/registrant.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="登记人_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>登记人分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_dengjiren_down.jsp", "_blank");
	...
	$(document).ready(function getCode() {
		...
		$.ajax({
			type : "post",
			url : rootPath + "/queryFenPai/regCode.do",
			dataType : "text",
			async : false,
			cach : false,
			success : function(data) {
...
<body>
	<div vtype="formpanel" id="formpanel" displayrows="1" name="formpanel"
		...
		<div id="inftype" name="inftype" vtype="comboxfield" label="信息件类型" dataurl="inftype.json"
			labelAlign="right" labelwidth="100px" width="310"></div>
		<div id="regcode" name="regcode" vtype="comboxfield" label="登记部门" dataurl="return getCode()"
			labelAlign="right" labelwidth="100px" width="310"></div>
