...
<script type="text/javascript" charset="UTF-8">
	...
	function queryUrl() {
		...
		$.ajax({
			url : rootPath + "/queryFenPai/sourceWay.do",
			type : "post",
			data : {
				"begintime" : begintime,
				"endtime" : endtime,
			...
			success : function(data) {
				...
				htmls = '<div>'
					...
					+ '</div>'
					+ '<div id="来源方式_2360" align=center x:publishsource="Excel">'
					...
					+ '  width:305pt\'>来源方式分派数年度月份对比统计报表</td>'
					+ ' </tr>'
		...
		var newWim = open("fps_laiyuanfangshi_down.jsp", "_blank");
