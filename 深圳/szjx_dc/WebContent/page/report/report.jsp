...
<script src="../../static/script/home/report.js" type="text/javascript"></script>
<style type="text/css">
...
<body>
	<div id="allcontent" vtype="panel" width="100%" height="100%" showborder="false" 
	    ...
	    <div id="west" region="west" style="display: block;">
	...
	<!-- <script type="text/javascript">
		$(function(){
			$("#maincontent").panel("option", "frameurl","../../page/home/index.jsp");	
		})
