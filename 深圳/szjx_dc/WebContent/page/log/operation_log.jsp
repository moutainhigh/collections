...
<script>
	...
	function query(){
		$('div[name="gridpanel"]').gridpanel('option','dataurl',rootPath+'/log/query.do');
...
<body>
	<div class="title_nav">当前位置：日志管理 > <span>操作日志</span></div>
		   ...
		   <div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" showborder="false" 
				...
				<div name='createrName' id='createrName' vtype="textfield" label="操作人姓名" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
				<div name='operationTime' id='operationTime' vtype="datefield" label="操作时间" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
		   ...
		   <div vtype="gridpanel" name="gridpanel" id="gridpanel" width="100%" height="100%" layout="fit" showborder="false"
			 	...
			 	<div vtype="gridcolumn" name="grid_column" id="grid_column">
					<div> <!-- 单行表头 -->
						...
						<div name="systemName" text="业务子系统" textalign="center" sort="true" width="17%"></div>
						<div name="functionName" text="操作功能" textalign="center" sort="true" width="17%"></div>
						<div name="operationType" text="操作类型" textalign="center" sort="true" width="13%"></div>
						<div name="operationTime" text="操作时间" textalign="center" sort="true" datatype="date" dataformat="YYYY-MM-DD HH:mm:ss" width="15%"></div>
