...
<body>
	<div class="title_nav">当前位置：权限管理 > <span>服务管理</span></div>
	   	<div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" showborder="false" layoutconfig="{cols:2, columnwidth: ['50%','*']}" >
			<div name='serviceName' id='serviceName' vtype="textfield" label="服务名称" labelalign="right" labelwidth="200" width="80%" editable="true"></div>
			<div name='pkSysIntegration' id="pkSysIntegration" vtype="comboxfield" label="所属系统" labelwidth="200"   labelAlign="right"
			 		width="80%"		dataurl="<%=contextpath%>/auth/findServicePkSysIntegration.do" ></div>
	   	...
	   	<div vtype="gridpanel" name="gridpanel" id="gridpanel" width="100%" layout="fit" showborder="false" datarender="fixColumn()" 
			...
			<div vtype="gridcolumn" name="grid_column" id="grid_column">
				<div> <!-- 单行表头 -->
					...
					<div name="serviceNo" text="服务编号" textalign="center" sort="true"  width="14%"></div>
					<div name="agreementType" text="协议类型" textalign="center" sort="true"	datatype="comboxfield"				
					 	dataurl="<%=contextpath%>/auth/findAgreementType.do" width="14%"></div>					
