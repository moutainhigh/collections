...
function viewDataSource(altid){
	var title="详细信息";
	var frameurl=""+'/trsquery/querygetibiangengxxform.do?altid='+altid;
	...
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						...
						<div name='altbe' text="变更前内容" textalign="center" width="20%"></div>
						<div name='altaf' text="变更后内容" textalign="center" width="20%"></div>
