...
<script type="text/javascript">
	...
	//	var frameurl=""+'/dataSource/getDataSource_addHtml.do?type='+type+'&pkDcDataSource='+pkDcDataSource;
		var frameurl='/page/regQuery/biangengxx.jsp';
...
<!-- 	<div id="column_id" width="100%" height="100%" vtype="panel"
		name="panel" layout="row"
		layoutconfig="{height:['50%','15' ,'50%']}">
			...
			<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
				...
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						...
						<div name='altbe' text="变更前内容" textalign="center" width="13%"></div>
						<div name='altaf' text="变更后内容" textalign="center" width="13%"></div>
						<div name='altdate' text="变更日期" textalign="center" width="30%"></div>
