...
<script type="text/javascript">
	...
	function viewDataSource(licid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzxukexxform.do?licid='+licid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="100%" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='licid' text="许可文件ID" textalign="center" width="0%"></div>
				<div name='pripid' text="主体身份代码" textalign="center" width="0%"></div>
				<div name='licno' text="许可文件编号" textalign="center" width="15%"></div>
				<div name='licname' text="许可文件名称" textalign="center" width="20%"></div>
				<div name='valfrom' text="有效期自" textalign="center" width="20%"></div>
				<div name='valto' text="有效期至" textalign="center" width="20%"></div>
				<div name='licanth' text="许可机关" textalign="center" width="10%"></div>
