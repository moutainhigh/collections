...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- 市场主体隶属信息 -->
				<div name='brpripid' text="主体身份代码" textalign="center" width="0%"></div>
				<div name='pripid' text="隶属主体身份代码" textalign="center" width="0%"></div>
				<div name='entname' text="企业(机构)名称" textalign="center" width="30%"></div>
