...
<script type="text/javascript">
	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["fpid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	...
	function viewDataSource(fpid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzcaiwufuzexxform.do?fpid='+fpid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		title="财务负责人" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='fpid' text="财务负责人ID" textalign="center" width="15%"></div>
				...
				<div name='cerno' text="证件号码" textalign="center" width="10%"></div>
				<div name='tel' text="固定电话" textalign="center" width="18%"></div>
				<div name='mobtel' text="移动电话" textalign="center" width="18%"></div>
				<div name='email' text="电子邮箱" textalign="center" width="0%"></div>
				<div name='fix' text="操作" textalign="center" width="13%"></div>
			</div>
		</div>
		<!-- 表格 -->
