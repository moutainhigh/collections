		...
		setting : {
			...
			callback : {
				onClick : function onClick(e, treeId, treeNode) {
					if (treeNode.funUrl) {
						var contenturl;
						if (treeNode.funUrl.indexOf("http")!=-1) {
							 contenturl =  treeNode.funUrl;
						}else{
							 contenturl = rootPath + treeNode.funUrl;
						}
...
function createMenu() {
	var params = {
		url:rootPath+"/reportHome/getAppFuncByAppId.do?appCode="+appCode+"&random="+Math.random(), 
						...
						click : function(id,newdata) {
							return function() {
								...
								if(tempName!="首页"){
									...
									$(".jazz-row-element").css("background","white");
									$(".jazz-column-border").css("background","white");
									$(".jazz-row-border").css("background","white");
									$(".jazz-column-element").css("background","white");
									 $("div[region='center']").css("width",winWidth-210);
									 $("#maincontent").css("width",winWidth-210);
									 $("#frame_maincontent").css("width","100%");
										$("#maincontent").panel("option", "frameurl","../.."+tempArray[0]);
									
									//	$(".jazz-panel-content").css("width",winWidth-210);
								}else if(tempName=="首页"){
									$("#west").css("visibility","hidden");
									$("#west").css("display","none");
									$(".jazz-row-element").css("background","#d3d7d4");
									$(".jazz-column-border").css("background","#d3d7d4");
									$(".jazz-row-border").css("background","#d3d7d4");
									$(".jazz-column-element").css("background","#d3d7d4");
									$("div[region='center']").css("width","99%");
									$("div[region='center']").css("height","100%");
									$("div[region='center']").css("margin","0px");
									//$("maincontent").css("width","100%");
									$("#maincontent").css("width","100%");
									$(".jazz-panel-content").css("width","100%");
									 $("#frame_maincontent").css("width","100%");
									...
									// $("div[region='center']").children().find(".jazz-panel-content").css("width","100%");
									 ...
									 //$(".jazz-column-btn-r").css("display","none");
									 //$("#maincontent").css({"width":width,"height":"100%"});
									//var width=$(window).width();
									//$("#maincontent").css({"position":"fixed","display":"block","left":"0px","right":"0px"});
									...
									// $("#maincontent").panel("option", "frameurl","../../page/integeration/data.jsp")
								}
