...
import com.gwssi.datacenter.dataSource.service.DataStructLoadOracle;
...
@Service
public class DataStructLoadBySqlServiceQuartz extends BaseService {
	...
	public List<Map<String, Object>> changDcTableBOToTreeList(
		...
		for (DcTableBO sm : list) {
			...
			if (StringUtils.isEmpty(sm.getTableNameCn())) {
				...
				systemN.put("name",
						sm.getTableNameCn() + "(" + sm.getTableNameEn() + ")");
			}
...
//				dcChangeBo.setCreaterName(user.getUserName());
		...
		System.out.println("needtoInsertDcChange........." + needtoInsertDcChange);
