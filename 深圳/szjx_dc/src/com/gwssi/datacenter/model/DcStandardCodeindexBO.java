...
/**
 * DC_STANDARD_CODEINDEX表对应的实体类
 */
@Entity
@Table(name = "DC_STANDARD_CODEINDEX")
public class DcStandardCodeindexBO extends AbsDaoBussinessObject {
	
	public DcStandardCodeindexBO(){}
	...
	public void setStandardType(String standardType){
		...
		markChange("standardType", standardType);
	}
