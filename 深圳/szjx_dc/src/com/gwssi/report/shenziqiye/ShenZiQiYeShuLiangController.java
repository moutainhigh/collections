...
import com.gwssi.report.shenziqiye.service.ShengZiQiYeShuLiangService;

@Controller
@RequestMapping("szsl")
public class ShenZiQiYeShuLiangController {

	@Autowired
	private ShengZiQiYeShuLiangService query;
	...
	@RequestMapping(value = "/dwonShuliang")
	@ResponseBody
	public void downQianHaiZongLiang(HttpServletRequest req,
		...
		ShuLiangUtil qu = new ShuLiangUtil();
		String str = qu.shuLiangUtils(num);
		String filename = "深资背景企业数量(" + beginTime + "到" + endTime + ")_"
