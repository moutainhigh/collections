...
@Service
public class Data18Service_20190731 extends BaseService {
	...
	public List queryListByDingJianLv(Map map) throws OptimusException {
		...
		String sql = "WITH TMEP AS\r\n" + 
				...
				"    S.CNT_TYPE AS 统计类型,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440304' THEN S.CNT ELSE 0 END) AS 福田局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440303' THEN S.CNT ELSE 0 END) AS 罗湖局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440305' THEN S.CNT ELSE 0 END) AS 南山局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440308' THEN S.CNT ELSE 0 END) AS 盐田局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440306' THEN S.CNT ELSE 0 END) AS 宝安局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440307' THEN S.CNT ELSE 0 END) AS 龙岗局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440309' THEN S.CNT ELSE 0 END) AS 光明局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440310' THEN S.CNT ELSE 0 END) AS 坪山局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440342' THEN S.CNT ELSE 0 END) AS 龙华局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440343' THEN S.CNT ELSE 0 END) AS 大鹏局,              \r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE IN ('440344','440345') THEN S.CNT ELSE 0 END) AS 深汕监管局,  \r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440399' THEN S.CNT ELSE 0 END) AS 未分派,   \r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE IS NOT NULL THEN S.CNT ELSE 0 END) AS 合计,\r\n" + 
				...
				"              -- (SELECT * FROM CODEDATA C WHERE C.CODE_INDEX = 'CA11') C,\r\n" + 
				"               TMEP G\r\n" + 
				"         WHERE  NVL(S.EQU_ADDR_COUNTY_CODE,'440399') = C.CODE_VALUE\r\n" + 
				"           AND SUBSTR(S.EQU_KIND, 1, 1) = SUBSTR(T.ITEM_CODE, 1, 1)\r\n" + 
				"           AND S.STATUS = '1'\r\n" + 
				...
				"         GROUP BY T.ITEM_VALUE,C.CODE_VALUE\r\n" + 
				"        UNION ALL\r\n" + 
				"        SELECT T.ITEM_VALUE,\r\n" + 
				"               '在用总数' AS CNT_TYPE,\r\n" + 
				"               C.CODE_VALUE,\r\n" + 
				...
				"    NVL(S.ITEM_VALUE,'总体') AS 品种种类,\r\n" + 
				"    S.CNT_TYPE AS 统计类型,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440304' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 福田局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440303' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 罗湖局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440305' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 南山局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440308' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 盐田局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440306' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 宝安局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440307' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 龙岗局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440309' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 光明局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440310' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 坪山局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440342' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 龙华局,\r\n" + 
				"    SUM(CASE WHEN S.CODE_VALUE = '440343' THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 大鹏局,              \r\n" + 
			    "    SUM(CASE WHEN S.CODE_VALUE IN ('440344','440345') THEN (1-ROUND(CNT0/CNT,4))*100 ELSE 0 END) AS 深汕监管局,  \r\n" + 
		...
		if (regCode != null && !regCode.equals("")) {
		  ...
		  sql  = "select 品种种类,统计类型, "+titleSql+ " ,"+ titleSql + " 合计   from (WITH TMEP AS\r\n" + 
					...
					"SELECT 品种种类,统计类型,福田局,罗湖局,南山局,盐田局,宝安局,龙岗局,光明局,坪山局,龙华局,大鹏局,深汕监管局,未分派\r\n" + 
					" FROM (\r\n" + 
					"SELECT \r\n" + 
					"    NVL(S.ITEM_VALUE,'总体') AS 品种种类,\r\n" + 
					"    S.CNT_TYPE AS 统计类型,\r\n" + 
					...
					"              -- (SELECT * FROM CODEDATA C WHERE C.CODE_INDEX = 'CA11') C,\r\n" + 
					"               TMEP G\r\n" + 
					"         WHERE S.EQU_ADDR_COUNTY_CODE = C.CODE_VALUE\r\n" + 
					"           AND SUBSTR(S.EQU_KIND, 1, 1) = SUBSTR(T.ITEM_CODE, 1, 1)\r\n" + 
					"           AND S.STATUS = '1'\r\n" + 
					"           AND S.CHECKOUT_STATUS = '在用'\r\n" + 
					"           AND NOT EXISTS ( SELECT 1 FROM DC_SE_EQU_CONTAINER_PARAM P WHERE S.ID = P.EQU_ID AND P.IS_SIMPLE_CONTAINER='1' )\r\n" + 
