...
public class Conts {
	 ...
	 * 主体检索结果显示
	 */
	public static final String SELREGSHOW ="a;b;d;d;e;f;g;h;i,j;k;l;m;n;o;p;q;r";
	
	/**
	 * 市场主体基本信息便签sql
	 */
	public static final String SCZTJBXXSQL ="select * from V_QY_NZ_BASIC " ;//内资视图 
	public static final String SCZTJBXXSQLGT ="select * from  v_qy_gt_basic ";//个体
	public static final String SCZTJBXXSQLWZ ="select * from V_QY_WZ_BASIC ";//外资视图
	...
	public static final String V_GETI_DIAOXIAO ="select  * from v_qy_geti_zhuxiao_xx ";//个体吊销信息	
	...
	public static final String V_NZWZ_QingsuanChengYuanXX="select * from v_qy_nzwz_qingsuan_chengyuanxx";//清算信息
	 ...
	 */
	public static final String T_SCZT_SCZTLSXX ="select *  from e_sub t ";
