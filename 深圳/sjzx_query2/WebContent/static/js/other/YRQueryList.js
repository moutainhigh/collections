		 ...
		 */
			...
			backFunction:function (event, obj) {
	    		...
	    		for (var i = 0; i < data.length; i++) {
	    			data[i]["entname"] = '<a href="javascript:void(0);"  title="'+data[i]["entname"] +'" onclick="ebaic.editFunc(\''+data[i]["pripid"]+'\',\''+data[i]["cerno"]+'\')">' + data[i]["entname"] + '</a>';
	    		}
...
//	    		alert(pathName);
	    	 ...
	    	 */
	    	editFunc:function(pripid,cerno){
	    		var url = $_this.getContextPath()+"/page/otherselect/YRDetail.jsp?pripid="+pripid + "&type=YR" + "&cerno=" +cerno ;
	    		window.open(url);
	    	},
	    	/**
