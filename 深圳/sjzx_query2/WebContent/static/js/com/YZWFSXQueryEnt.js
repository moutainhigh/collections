	...
	torch = {
		 ...
		 */
			_init: function(){
				...
				require(['domReady'], function (domReady) {
					    domReady(function () {
					    	...
					    	document.title = entname +"的严重违法失信信息";
					    	var entid = jazz.util.getParameter("entid");
					    	//TODO
				    		var gridUrl="../../yzwfsx_select/YZWFSXQueryList.do";
	    	...
	    	editFunc:function(id,entid){
	    		util.openWindow("SXQueryDetail","严重违法失信 详情信息",$_this.getContextPath()+"/page/comselect/YZWFSXQueryDetail.html?id="+id+"&entid="+entid,900,500);
	    	},
