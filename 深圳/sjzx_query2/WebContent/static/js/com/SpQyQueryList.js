	...
	torch = {
		 ...
		 */
	    	...
	    	queryListUserRolesByUserId : function() {
	    		var wnb  = "";
	    		var params = {
	    				url : '../../SpQySelect/queryUserRolesByUserId.do',
	    	...
	    	exportFunc : function(){
	    		...
	    		if(isnotquery!=""){
		    		/*if(adminbrancode123==""){
		    			...
		    			$_this.post("../../SpQySelect/exportExcel.do", {entname:entname,regno:regno,regorg:regorg,SpQymark:SpQymark,adminbrancode:adminbrancode,estdate_begin:estdate_begin,estdate_end:estdate_end});
		    		//}
	    	...
	    	//	 $("#totals").text("");
	    		var params = {
	    				url : '../../SpQySelect/SpQyQueryList.do?flag=1',
	    	...
	    	queryNBList : function(){
	    	   ...
	    	   var gridUrl="../../SpQySelect/SpQyQueryList.do";
			...
			backFunction:function (event, obj) {
	    		...
	    		for (var i = 0; i < data.length; i++) {
	    			if(data[i].pripid = null || data[i].pripid == undefined){
	    				data[i]["opt"] = "无证";
	    	...
	    	contactDetail:function(pripid){ 
	    		util.openWindow("SPLicQueryList","食品企业许可证信息",$_this.getContextPath()+"/page/comselect/SPLicQueryList.html?pripid="+pripid,850,412);
	    	},
	    	/*
	    	 * 清除指定funcConfig
	    	 */
