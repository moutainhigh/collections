define([ 'jquery', 'jazz', 'util','ajaxfileupload','print','form' ], function($, jazz, util,ajaxfileupload,PrintArea,form) {
	...
	torch = {
		...
		uploadFile:function(){
			...
			$.ajaxFileUpload({
                url: "../../../batch/bathFDDBRUpload.do?flag="+flag, //用于文件上传的服务器端请求地址
                ...
                success: function (data, status){ //服务器成功响应处理函数
                	if(status=="success"){
                		...
                		$("#LegalPensonQueryListGrid").gridpanel("option",'dataurl',"../../../batch/FDDBRList.do");
        	    		$("#LegalPensonQueryListGrid").gridpanel("reload");
                	}
                },
