 ...
 var torch ={};
	torch = {
		 ...
		 */
	    	...
	    	getLoadingZhuTiYeTai:function(){
	    		$("div[name='ztyt']").comboxfield('addOption', '', '');
	    		$("div[name='ztyt']").comboxfield('addOption', '食品销售经营者', '1');
	    		$("div[name='ztyt']").comboxfield('addOption', '餐饮服务经营者', '2');
	    		$("div[name='ztyt']").comboxfield('addOption', '单位食堂者', '3');
	    		
	    		//$("div[name='ztyt']").comboxfield('option', 'defaultvalue',1);
	    	},
	    	...
	    	exportFunc : function(){
	    		...
	    		var ytsl = $("#ytslhidden").hiddenfield('getValue');
	    		
	    		var fztime_begin =  $("#fztime_beginhidden").hiddenfield('getValue');
	    	    var fztime_end =  $("#fztime_endhidden").hiddenfield('getValue');
	    		...
	    		if(isnotquery!=""){
	    			$_this.post("../../FoodLicController/exportExcel.do", 
	    					{entname:entname,licno:licno,supunitbysup:supunitbysup,supdepbysup:supdepbysup,newflag:newflag,lictype:lictype,street:street,ztyt:ztyt,jyxm:jyxm,ytsl:ytsl,fztime_begin:fztime_begin,fztime_end:fztime_end});		    		
	    		}else{
	    			jazz.warn("请先查询后再导出！！");
	    		}
	    	...
	    	getCount:function(){
	    		var params = {
	    				url : '../../FoodLicController/FoodLicQueryList.do?flag=1',
	    				components: ['FoodLicQueryListPanel'],
	    	...
	    	queryCFList : function(){
	    		...
	    		var ztyt = $("#ztyt").comboxfield('getValue');
	    		var jyxm = $("#jyxm").textfield('getValue');
	    		
	    		var ytsl =  $("#ytsl").textfield('getValue');
	    		var fztime_begin =  $("#fztime_begin").datefield('getValue');
	    		var fztime_end =  $("#fztime_end").datefield('getValue');
	    		...
	    		$('#ytslhidden').hiddenfield('setValue',ytsl);
	    		$('#fztime_beginhidden').hiddenfield('setValue',fztime_begin);
	    		$('#fztime_endhidden').hiddenfield('setValue',fztime_end);
			...
			backFunction:function (event, obj) {
	    		...
	    		for (var i = 0; i < data.length; i++) {
	    			data[i]["entname"] = '<a href="javascript:void(0)" onclick="ebaic.regFood(\''
	    					+ data[i]["id"]
	    					+ '\',\''
							+ data[i]["lictype"]
			    			+ '\',\''
	    	...
	    	regFood:function(id, lictype, licid,licno){
	    		...
	    		var url = $_this.getContextPath() + "/" + urlright + "?flag=" + encode("0")
	    				  ...
	    				  + "&licid=" + encode(licid)+"&licno="+encode(licno);
	    		window.open(url);
