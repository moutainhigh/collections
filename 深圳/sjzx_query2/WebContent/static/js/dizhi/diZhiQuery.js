		 ...
		 */
			_init: function(){
				...
				require(['domReady'], function (domReady) {
					    domReady(function () {
					    	...
					    	$_this.getSelect();
					    	$_this.getSelectOld();
					    	$_this.getSelectsForYiChangType();
	    	...
	    	changeradio:function(event,value){
	    		...
	    		if(isZaiRuYiChang=="否"){
	    			...
	    			$("div[name='yiChangType']").comboxfield('reset');
	    	...
	    	getSelect:function(){
	    		...
	    		$("div[name='bgQianSelect']").comboxfield('option', 'defaultvalue', 0);
	    	},
	    	...
	    	getSelectsForYiChangType:function(){
	    		$("#yiChangContains").comboxfield('addOption', '不包含', '0');
	    		$("#yiChangContains").comboxfield('addOption', '包含', '1');
	    		$("div[name='yiChangContains']").comboxfield('option', 'defaultvalue',0);
	    	},
	    	...
	    	exportFunc : function(){
	    		...
	    		var bgdate_begin = $("#bgdate_beginhidden").hiddenfield('getValue');
	    		var bgdate_end = $("#bgdate_endhidden").hiddenfield('getValue');
	    		...
	    		var yiChangContains = $("#yiChangContainshidden").hiddenfield('getValue');
	    		...
	    		if(isnotquery!=""){
		    		/*if(adminbrancode123==""){
		    			...
		    			$_this.post("../../diZhiQuery/exportExcelDowns.do", {
		    				...
		    				yiChangContains:yiChangContains
		    				});
		    		//}
	    	...
	    	queryNBList : function(){
	    		...
	    		var yiChangContains = $("#yiChangContains").comboxfield('getValue');
	    		...
	    		$('#yiChangContainshidden').hiddenfield('setValue',yiChangContains);
...
*/
	    				...
	    				$('#isZaiRuYiChang').radiofield('option','defaultvalue','全部');
	    				$("div[name='bgHouSelect']").comboxfield('option', 'defaultvalue',1);
	    	    		$("div[name='bgQianSelect']").comboxfield('option', 'defaultvalue', 0);
	    	    		$("div[name='yiChangContains']").comboxfield('option', 'defaultvalue',0);
