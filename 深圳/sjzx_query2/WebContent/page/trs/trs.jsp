	...
	<div style="width:100%; height:40%;" > 
		<div class="float_left imagemenu">
			...
			<!-- 	<input   id="inputBox" type="text" style="padding-right:0;height:40px;width:63%;border: 1px solid #ACACAC;border-radius:5px 5px;">
			 ...
			 -->		
				<div class="sjzx_content" style="width: 900px;margin: 0 auto;">
				<div class="serach" style="z-index:1;margin-top:2%;text-align: center;margin-left: -6px">
					<div class="content"><div onclick="allaction();">搜 &nbsp;&nbsp; 索</div><input id="inputBox" type="text"></div>
				</div>
			</div>
			</div>

			<div  id="tishi" class="cwidth"><span id="countnum"></span><span id="timeuseing"></span></div>
			<div id="result" class="results cwidth" style="margin-top:10px;text-align: center;" ></div>
			...
			-->
			<div class="p" style="margin-right:16.2%;float: right"></div>  
		</div>
	</div>
		</div>
