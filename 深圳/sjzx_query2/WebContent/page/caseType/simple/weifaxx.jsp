	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			var htm ='<div class="jazz-grid-cell-inner">'
				+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+data[i]["brpripid"]+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
				+'</div>';
			data[i]["fix"] = htm; 
		}
		return data;
	}
	function viewDataSource(brpripid){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzlishuxxform.do?brpripid='+brpripid;
