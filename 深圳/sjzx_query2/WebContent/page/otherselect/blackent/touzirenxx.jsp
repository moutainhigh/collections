...
<script type="text/javascript">
	...
	function viewDataSource(personid){
		var title="详细信息";
		var frameurl=""+'/blackent/blackenttouzirenxxform.do?id='+personid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="450" width="100%"
		...
		title="投资人信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='inv' text="投资人" textalign="center" width="11%"></div>
				<div name='invtype' text="投资人类型" textalign="center" width="13%"></div>
				...
				<div name='conprop' text="出资比例" textalign="center" width="11%"></div>
