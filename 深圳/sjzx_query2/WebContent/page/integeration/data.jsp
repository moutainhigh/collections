...
.slideTxtBox .bd li span{display:inline-block;/* width: 136px; */width: 125px;}
		...
		<div class="slideTxtBox">
			...
			<div class="title">
				<dl>
					...
					<dd>用户Id</dd>
					<dd style="width:121px">用户姓名</dd>
					<dd style="width:270px">所属部门</dd>
					<dd id="hitsExp" >查询次数</dd>
					<dd id="ms"  style="display: none;padding-left:10px">描述</dd>
				</dl>
			</div>
			<div class="bd">
				<ul id="l1">
						...
						success:function(data){
							...
							for (var i = 0; i < dataStr.length; i++) {
								if(dataStr[i].operationDescribe == "快速查询"){
									...
									html ="<li><span class='no'>"+(q1)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l1").append(html);
								}
								if(dataStr[i].operationDescribe == "商事主体查询"){
									...
									html ="<li><span class='no'>"+(q2)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l2").append(html);
								}
								if(dataStr[i].operationDescribe == "重复地址查询"){
									...
									html ="<li><span class='no'>"+(q3)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l3").append(html);
								}
								if(dataStr[i].operationDescribe == "年报查询"){
									...
									html ="<li ><span class='no'>"+(q4)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l4").append(html);
								}
								
								if(dataStr[i].operationDescribe == "异常名录企业查询"){
									q5++;
									var html = " ";
									var userId = " ";
									var userName = " ";
									...
									html ="<li><span class='no'>"+(q5)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l5").append(html);
								}
								...
								if(dataStr[i].operationDescribe.indexOf("证照")==0){
									...
									html ="<li><span class='no'>"+(q6)+"</span><span class='num uid'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l6").append(html);
								 ...
								 if(dataStr[i].operationDescribe.indexOf("电话")>0){
										...
										html ="<li><span class='no'>"+(q7)+"</span><span class='num uid'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
										$("#l7").append(html);
								}
								...
								if(dataStr[i].operationDescribe == "黑牌企业查询"){
									...
									html ="<li><span class='no'>"+(q8)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l8").append(html);
								}
								...
								if(dataStr[i].operationDescribe == "一人责任有限公司查询"){
									...
									html ="<li><span class='no'>"+(q9)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l9").append(html);
								}
								if(dataStr[i].operationDescribe == "失信被执行人查询"){
									...
									html ="<li><span class='no'>"+(q10)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region'>"+userDepartName+"</span><span class='num'>"+hits+"</span></li>";
									$("#l10").append(html);
								}
								if(dataStr[i].operationDescribe.indexOf("导出")>0){
									...
									html ="<li><span class='no'>"+(q11)+"</span><span class='num'>"+userId+"</span><span>"+userName+"</span><span class='region' style='width:270px'>"+userDepartName+"</span><span class='num'>"+hits+"</span><span class='num'>"+description+"</span></li>";
									$("#l11").append(html);
								}
							}
