        ...
        <div> 
            <div vtype="gridpanel" name="jbxxGrid1" height="90%" width="100%"
				...
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='licname' text="审批文件名称" textalign="center" width="25%"></div>
						<div name='licno' text="审批文件号" textalign="center" width="25%"></div>
						<div name='valfrom' text="有效期自" textalign="center" width="25%"></div>
						<div name='valto' text="有效期至" textalign="center" width="25%"></div>
