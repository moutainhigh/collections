...
jQuery.extend(Boxy, {
    ...
    cancel: function(message, callback, options) {
        return Boxy.ask(message, ['取消'], callback, options);
    },
    // displays an alert box with a given message, calling after callback iff
    // user selects OK.
    confirm: function(message, after, cancel, options) {
    ...
    ask: function(question, answers, callback, options) {
        ...
        if($('.boxy-content').height() > 450){
        	$('.question').css({"height": $(body).height()*0.4, "overflow-y": "scroll" });
        	$('table.boxy-wrapper').css('top', $(body).height()*0.5);
        }
    },
