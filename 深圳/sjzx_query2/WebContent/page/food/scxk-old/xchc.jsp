...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="现场核查记录信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='investigateResult' text="审查结论" textalign="center" width="10%"></div>
				<div name='inputPerson' text="录入人员信息" textalign="center" width="15%"></div>
				<div name='inputDate' datatype="date" dataformat="YYYY-MM-DD" text="录入时间" textalign="center" width="15%"></div>
				<div name='checkTime' text="审查次数" textalign="center" width="10%"></div>
				<div name='investigateAnnal' text="核查记录" textalign="center" width="50%"></div>
			</div>
		</div>
		<!-- 表格 -->
