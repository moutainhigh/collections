	...
	*/
	 $(function(){
		id=getUrlParam("id");
  		...
  		lictype = getUrlParam("lictype");
  		licid = getUrlParam("licid");
  		licno = getUrlParam("licno");
  		
  		if(lictype=="1"){
  			$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-panel-right-jyxk.jsp");  			
  		}else if(lictype=="3"){
  			$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-panel-right-scxk.jsp");
  		}else if(lictype=="4"){ 
  			$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-panel-right-scxk-old.jsp");
  		}else if(lictype=="5"){
  			$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-panel-right-splt.jsp");
  		}else if(lictype=="6"){
  			$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-panel-right-cyfw.jsp");
  		}
  		$("#left").panel("option","frameurl","<%=request.getContextPath()%>/page/food/query-tree-left.jsp");
 	...
 	function rightPageSet(url){
         ...
         var url2="";
         url2="<%=request.getContextPath()%>/page/food/"+url;
