...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="仪器模型项信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='instrumentName' text="仪器名称" textalign="center" width="35%"></div>
				<div name='accuracyClass' text="精度等级" textalign="center" width="35%"></div>
				<div name='instrumentNum' text="数量" textalign="center" width="30%"></div>
				<!--  <div name='licenseType' text="许可证类型" textalign="center" width="25%" dataurl="../code/xukezheng.json"></div> -->
