...
<script type="text/javascript">
	...
	var id=null;//主键
	var type= null;
	var litiganttype= null;
    var  casesourceno = null;
	 $(function(){
		 id=getUrlParam("id");//主键
		 type=getUrlParam("type");
		 casesourceno=getUrlParam("casesourceno");
		 litiganttype=getUrlParam("litiganttype");
  		if(id==null){
  			jazz.error("从主页中重新检索");
  		}
  		
  		$("#left").panel("option","frameurl","<%=request.getContextPath()%>/page/comselect/query-tree-left.jsp");
  		$("#main").panel("option","frameurl","<%=request.getContextPath()%>/page/comselect/query-panel-right-caseInfo.jsp");
