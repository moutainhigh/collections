	 ...
	 $(function() {
		$.ajax({
			 ...
			 success: function(data) {
				 ...
				 if(isNotEmpty(data.yichangminglu)){
					 var temp = "";
					 var type = data.yichangminglu;
					 if(type=="2"){
						 temp = "【全部】";
					 }else if(type=="1"){
						 temp = "【是】";
					 ...
					 _html += "<li>是否在异常名录中："+temp+"</li>   ";
				 }
				 
				 
				 
				 if(isNotEmpty(data.year)){
					 var temp = "";
					 var type = data.year;
					 _html += "<li>年报时间："+ type+"</li>";
				 }
				 
				 if(isNotEmpty(data.nbflag)){
					 var temp = "";
					 var type = data.nbflag;
					 var text = "全部";
					 if(type=="1"){
						 text = "已年报";
					 }else if(type=="0"){
