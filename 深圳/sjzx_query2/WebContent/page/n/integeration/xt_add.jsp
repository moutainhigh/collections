...
<body>
   <div id="formpanel" name="formpanel" vtype="formpanel" titledisplay="false" showborder="false" width="100%" layout="table" 
		...
		<div name='systemCode' id='systemCode' vtype="textfield" label="子系统编码" labelalign="right" labelwidth="100" width="80%"  maxlength="4" editable="true"  rule="customFunction;changeCode()"></div>
   		<div name='integratedUrl' id='integratedUrl' vtype="textfield" label="集成URL" labelalign="right" labelwidth="100" width="80%" rule="customFunction;changeUrl()" editable="true"></div>
		<div name='systemState' id='systemState' vtype="radiofield" label="是否启用" labelalign="right" labelwidth="100" width="80%" itemwidth="60" dataurl="[{checked: true,value: '0',text: '启用'},{value: '1',text: '停止'}]"></div>
		<div name="systemImgUrlCode" id="systemImgUrlCode" vtype="attachment" label="上传图标" colspan="2" rowspan="1"  title="上传附件" labelwidth="100" width="80%" close="_close()" click="_preview()" 
			description="请上传163*163的JPG/PNG格式的图片作为系统图标" ishidelist="0" theme="1" uploadsuccess="_uploadsuccess()"  allowfiletypes="" allowfiletypesdesc="JPG/PNG" ></div>
		...
		<div name='remarks' id='remarks' vtype="textareafield"  colspan="2" rowspan="1" label="备注" labelalign="right" labelwidth="100" width="80%" height="80" editable="true" maxlength="1500"></div>
   	...
   	<div id="zhezhao"style="text-align: center;position:fixed;z-index:1000;display:none;top:0;left:0;">
		...
		<div id="close-img" style="position:fixed;right:30px;top:30px;color:red;cursor:pointer;">x</div>
