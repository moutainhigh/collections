...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		if(parent.economicproperty=='3' || parent.economicproperty=='2'){//判断是否为外资
			...
			if(parent.opetype == 'FGS' || parent.opetype == 'GRDZFZ' || parent.opetype == 'HHFZ' || parent.opetype == 'HZSFZ'|| parent.opetype == 'NZYY'|| parent.opetype == 'WGDB' || parent.opetype == 'WGJY' || parent.opetype == 'WZFZ' || parent.opetype == 'WZHHFZ'){
				if(parent.entstatus == 3){ //注销
					if(parent.opetype == 'FGS' || parent.opetype == 'HHFZ' || parent.opetype == 'GRDZFZ'){
						//url = "regLeftJson/left-chuzi-qianchu-lishu-zhuxiao.json";
						url = "left-lishu-zhuxiao-fuzeren.json";
					}else if(parent.opetype == 'GRDZ'){
						url = "left-lishu-zhuxiao-touziren.json";
					}else if(parent.opetype == 'HHQY' || parent.opetype == 'WZHH'){
						url = "left-lishu-zhuxiao-hehuoren.json";
					}else if(parent.opetype == 'WGDB'){
						url = "left-lishu-zhuxiao-shouxidaibiao.json";
					}else{
						url = "left-lishu-zhuxiao.json";
					}
				}else{
					if(parent.opetype == 'FGS' || parent.opetype == 'HHFZ' || parent.opetype == 'GRDZFZ'){
						url = "left-lishu-fuzeren.json";
					}else if(parent.opetype == 'GRDZ'){
						url = "left-lishu-touziren.json";
					}else if(parent.opetype == 'HHQY' || parent.opetype == 'WZHH'){
						url = "left-lishu-hehuoren.json";
					}else if(parent.opetype == 'WGDB'){
						url = "left-lishu-shouxidaibiao.json";
					}else{
						url = "left-lishu.json";
					}
				}
			}else{
				if(parent.entstatus == 3){
					if(parent.opetype == 'FGS' || parent.opetype == 'HHFZ' || parent.opetype == 'GRDZFZ'){
						url = "left-zhuxiao-fuzeren.json";
					}else if(parent.opetype == 'GRDZ'){
						url = "left-zhuxiao-touziren.json";
					}else if(parent.opetype == 'HHQY' || parent.opetype == 'WZHH'){
						url = "left-zhuxiao-hehuoren.json";
					}else if(parent.opetype == 'WGDB'){
						url = "left-zhuxiao-shouxidaibiao.json";
					}else{
						url = "left-zhuxiao.json";
					}
				}else{
					if(parent.opetype == 'FGS' || parent.opetype == 'HHFZ' || parent.opetype == 'GRDZFZ'){
						url = "left-fuzeren.json";
					}else if(parent.opetype == 'GRDZ'){
						url = "left-touziren.json";
					}else if(parent.opetype == 'HHQY' || parent.opetype == 'WZHH'){
						url = "left-hehuoren.json";
					}else if(parent.opetype == 'WGDB'){
						url = "left-shouxidaibiao.json";
					}else{
						url = "left.json";
					}
				}
