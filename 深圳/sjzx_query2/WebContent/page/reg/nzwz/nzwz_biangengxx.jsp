...
<script
	src="<%=request.getContextPath()%>/static/script/jquery-1.8.3.js"	type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/static/script/jazz.js"	type="text/javascript"></script>
<script
	src="<%=request.getContextPath()%>/static/script/jquery.blockUI.js"	type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/static/script/jquery.form.js"	type="text/javascript"></script>
<script	src="<%=request.getContextPath()%>/static/script/slides.min.jquery.js"	type="text/javascript"></script>
<script type="text/javascript"	src="<%=request.getContextPath()%>/static/js/sczt/scztFirstFlow.js"></script>
...
function fixColumn(event, obj) {// 维护按钮
	...
	for(var i=0;i<data.length;i++){
		...
		var regino = data[i].regino;
		
		var htmCompare ='<div class="jazz-grid-cell-inner">'
			+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+priPid+'\',\''+entityNo+'\',\''+economicproperty+'\',\''+data[i]["alttime"]+'\',\''+data[i]["altdate"]+'\',\''+encode(data[i]["entname"])+'\',\''+sign  +'\',\''+regino  +'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
			+'</div>';
...
function viewDataSource(pripid,entityNo,economicproperty,alttime,altdate,entname,sign,regino){
	var title="详细信息";
	var frameurl = ""+'/page/reg/nzwz/nzwz_biangengxx_two.jsp?priPid='+pripid+'&entityNo='+entityNo+'&economicproperty='+economicproperty+'&alttime='+alttime+'&altdate='+altdate+'&entname='+entname+'&sign='+sign+"&regnio="+regino;
