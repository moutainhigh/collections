...
<script type="text/javascript">
	...
	function viewDataSource(recid){
		var title="详细信息";
		var type="view";
		var frameurl=""+'/trsquery/querynzwzcaiwufuzexxform.do?recid='+recid;
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="236" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<!-- <div name='recid' text="财务负责人ID" textalign="center" width="0%"></div>
				...
				<div name='tel' text="固定电话" textalign="center" width="15%"></div>
				<div name='mobtel' text="移动电话" textalign="center" width="20%"></div>
				<div name='email' text="电子邮箱" textalign="center" width="20%"></div>
