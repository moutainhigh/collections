...
$(function() {
	...
	//var regno = getUrlParam("regno"); 
		$('#jbxxGrid').gridpanel(
				'option',
				'dataurl',
				rootPath + '/reg/xzdetail.do?priPid=' + priPid +'&flag='+entityNo
		);
...
function getUrl(name) {
	...
	function viewDataSource(id){
		var url = "<%=request.getContextPath()%>"+"/page/reg/XZQueryDetail.jsp?id="+id;
		window.open(url);	
	}
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="限制信息" defaultview="table" showborder="false"
