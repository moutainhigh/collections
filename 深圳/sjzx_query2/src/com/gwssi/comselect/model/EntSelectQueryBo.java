...
public class EntSelectQueryBo {
	...
	private String entname_logic;//企业名称逻辑 并且 或者
	private String[] entname_term;//企业名称条件  包含 不包含
	private String[] entname; //企业名称
	
	private String opscope_logic;//经营范围逻辑 并且 或者
	private String[] opscope_term;//经营范围条件
	private String[] opscope;
	
	private String dom_logic;//地址逻辑 并且 或者
	...
	private String yichangminglu; //异常名录 
	
	private String gangzi; //港资企业
	
	private String nbflag;//年报标识，0未年报，1已年报
	...
	public void setEntname_logic(String entname_logic) {
		this.entname_logic = entname_logic;
	}

	public String getEntname_logic() {
		return entname_logic;
	}

	public void setOpscope_logic(String opscope_logic) {
		this.opscope_logic = opscope_logic;
	}

	public String getOpscope_logic() {
		return opscope_logic;
	}

	public void setDom_logic(String dom_logic) {
		this.dom_logic = dom_logic;
	}

	public String getDom_logic() {
		return dom_logic;
	}

	public void setYichangminglu(String yichangminglu) {
		this.yichangminglu = yichangminglu;
	}

	public String getYichangminglu() {
		return yichangminglu;
	}

	public void setGangzi(String gangzi) {
		this.gangzi = gangzi;
	}

	public String getGangzi() {
		return gangzi;
	}
