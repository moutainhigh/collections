				 ...
				 <#else>
					...
					<div style="text-align: left;background-color:#e1e1e1;" class="sous_list">
						...
						<div >
							<h3>
								<a href="#"
									onclick="openWin('${trsbo.url?default("")}?enttype=${trsbo.r_enttype?default("")}&flag=0&economicproperty=${trsbo.changeType?default("")}&entstatus=${trsbo.d_regstate?default("")}&opetype=${trsbo.n_opetype?default("")}&priPid=${trsbo.pid_pripid?default("")}&regno=${trsbo.b_regno?default("")}&bregno=${trsbo.b_regno?default("")}&entid=${trsbo.s_entid?default("")}&entname=${trsbo.a_entName?default("")}') ">
