 	...
 	<#--<#if weaponMap[key]??>--> 
		<#if cou%2==0>
			<#if key=="企业(机构)名称" || key=="经营(业务)范围" || key=="一般经营项目" || key=="许可经营项目" || key=="住所" || key=="经营范围" || key=="经营范围及方式" || key=="经营场所" || key=="主要经营场所" || key== "营业场所" || key=="分支机构" ||key == "地址" ||key == "备注">
				<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td colspan="3" style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td>
			<#elseif key=="成立日期" || key=="核准日期" || key=="经营期限自" || key== "经营期限至" || key== "执照有效期限" || key== "注销日期"  || key== "吊销日期" || key== "出生日期" || key== "生产经营期限止" || key== "生产经营期限起" || key == "营业期限自" || key == "营业期限至" ||key =="经营(驻在)期限自" ||key=="经营(驻在)期限至" || key=="合伙期限自" || key=="合伙期限至">
				<#if weaponMap[key]??>
		  			...
		  			<#assign cou=cou+1 />
		  		<#else>
		  			<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td>
		  			<#assign cou=cou+1 />
		  		</#if>
		  	<#elseif key=="认缴注册资本" || key== "实缴注册资本" || key== "注册资本折万人民币" || key == "投资总额折万人民币" || key=="投资总额" ||key == "资金数额" || key == "成员出资总额">
		  		<#if weaponMap[key]??>
			  		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?string("0.##########")} 万元</td>
			  		<#assign cou=cou+1 />
			  	<#else>
		  	...
		  	<#elseif key=="姓名" || key=="财务负责人" || key=="税务代理人名称">
		  		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td id="persname" style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td>
	  			<#assign cou=cou+1 />
		 	<#else>
		 		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td>
		 		<#assign cou=cou+1 />
		 ...
		 <#else>
		 	<#if key=="企业(机构)名称" || key=="经营(业务)范围" || key=="一般经营项目" || key=="许可经营项目" || key=="住所" || key=="经营范围" || key=="经营范围及方式" || key=="经营场所" || key=="主要经营场所" || key== "营业场所" || key=="分支机构" ||key == "地址" ||key == "备注">
		 		...
		 		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;" colspan="3">${weaponMap[key]?default("无")}</td></tr>
		 		<#assign cou=cou+1 />
		 	<#elseif key=="成立日期" || key=="核准日期" || key=="经营期限自" || key== "经营期限至" || key== "执照有效期限" || key== "注销日期"  || key== "吊销日期" || key== "出生日期" || key== "生产经营期限止" || key== "生产经营期限起" || key == "营业期限自"||key == "营业期限至" ||key =="经营(驻在)期限自" ||key=="经营(驻在)期限至"|| key=="合伙期限自" || key=="合伙期限至">
		 		<#if weaponMap[key]??>
		  			...
		  			<#assign cou=cou+1 />
		  		<#else>
		  			<td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td></tr>
		  			<#assign cou=cou+1 />
		  		</#if>
		  	<#elseif key=="认缴注册资本" || key== "实缴注册资本" || key== "注册资本折万人民币" || key == "投资总额折万人民币" || key=="投资总额" ||key == "资金数额" || key == "成员出资总额">
		  		<#if weaponMap[key]??>
			  		<td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?string("0.##########")} 万元</td></tr>
			  		<#assign cou=cou+1 />
		  		<#else>
		  			<td style="text-align: right;padding-right: 1px;">${key}:</td><td style="padding-left: 5px;padding-bottom: 8px;padding-top: 8px;">${weaponMap[key]?default("无")}</td></tr>
		  			<#assign cou=cou+1 />
...
<#list weaponMap?keys as key> 
 	<#--<#if weaponMap[key]??>--> 
		<tr><td style="text-align: right;padding-right: 1px;">${key}:</td><td colspan="3" style="padding-left: 5px;">${weaponMap[key]?default("无")}</td></tr>
     <#--</#if>--> 
</#list>
</#if>