 ...
 */
@Service
public class MarketEntityPrintService extends BaseService{
	private static  Logger log=Logger.getLogger(MarketEntityPrintService.class);
...
/*			String sourceflag=(String)map.get("sourceflag");
	...
	public List<Map> queryXZXX(String priPid) throws OptimusException{
		...
		sql.append("select * from v_dc_gqzy_qyxz_xx t where t.xzlb = '1' ");
		List<String> list = new ArrayList<String>();
		if(!"".equals(priPid)){
