...
<%
	...
	System.out.println("===#############################===\n");
	sTarget = "../document/document_list.html?SiteId=16&SiteType=0&RightValue=111111111111111111111111111111111111111111111111111111111111111&";
	System.out.println("====wcm登录之后页面跳转地址,app\main\portal.jsp=====>  sTarget   " + sTarget +"\n");
	System.out.println("===#############################===\n");
