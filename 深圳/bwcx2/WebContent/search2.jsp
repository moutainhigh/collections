...
.mod-search-dropdown-item:hover{background: #0372A9;}
...
function getXZXKGSList(keyword_, type, pageIndex, getDataType) {
	    ...
	    var cidDefault = 1;
		var cid = getQueryString("cid")||cidQuery||cidDefault;
...
<script>
		/* $(".mod-search a.mod-search-dropdown").hover(function(){
				...
				_this.find("span").click(function(){
					var that = $(this);
					that.addClass("myselect").siblings().removeClass("myselect");
			...
			if(_this.hasClass("isChoose")){
				...
				_this.find("span").css("display","none");
				_this.find(".myselect").css("display","block");
