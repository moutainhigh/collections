...
<body>
	   		<div id="formpanel" name="formpanel" vtype="formpanel" showborder="false" titledisplay="false" 
				...
				<div name='pkSmServices' id="pkSmServices" vtype="hiddenfield"></div>	
			 ...
			 -->	 
        		...
        		<div name='serviceDisc' colspan="2" rowspan="1"    maxlength="1000"
             	vtype="textareafield" label="服务描述" labelalign="right" width="95%" height="85">             	
             	</div> 	
	             <div name="fileName" id="fileName" vtype="attachment"  label="接口文档"  title="请上传接口调用文档" fileuploadlimit="1" single="true"  labelwidth="100" width="80%" close="_close()"  rule="must"
					description="请上传接口文档" ishidelist="0" theme="1" uploadsuccess="_uploadsuccess()"  allowfiletypes="*.doc;*.docx" allowfiletypesdesc="doc" >
				</div>	
