...
var dp = {
	sh :
	{
		...
		Brushes	: {},
		Strings : {
			AboutDialog : '<html><head><title>About...</title></head><body class="dp-about"><table cellspacing="0"><tr><td class="copy"><p class="title">dp.SyntaxHighlighter</p><div class="para">Version: {V}</div><p><a href="http://www.dreamprojections.com/syntaxhighlighter/?ref=about" target="_blank">http://www.dreamprojections.com/syntaxhighlighter</a></p>&copy;2004-2007 Alex Gorbatchev.</td></tr><tr><td class="footer"><input type="button" class="close" value="OK" onClick="window.close()"/></td></tr></table></body></html>'
		},
		ClipboardSwf : null,
		Version : '1.5'
	}
...
dp.sh.Toolbar.Commands = {
	...
	ViewSource: {
		...
		func: function(sender, highlighter)
		{
            ...
            wnd.document.write('<textarea style="width:99%;height:95%" id="textareaId">' + code + '</textarea><div align="center"><input type="button" value="运行代码"  onclick="runCode();"/></div>');
			wnd.document.write('<div style="display:none"><script language="javaScript">');
            wnd.document.write('function runCode(){' +
                               'var code=this.document.getElementById("textareaId").value;' +
	...
	runSHCode:  {
		...
		func: function(sender, highlighter)
		{
			var code = highlighter.originalCode.replace(/&lt;/ig, '<');
			code = code.replace(/&gt;/ig,'>');
			runCode(code);//调用code.js中的代码
		}
	}/*,
