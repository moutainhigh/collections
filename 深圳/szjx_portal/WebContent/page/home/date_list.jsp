...
<script src="<%=contextpath%>/static/script/home/date_list.js" type="text/javascript"></script>
</head>
<body>
   <div vtype="gridpanel" name="gridpanel" id="gridpanel" height="100%" width="100%" layout="fit"  dataurl="<%=contextpath%>/home/getMessage.do?type=1"
	 	...
	 	<div name="toolbar" vtype="toolbar">
			<div id="add_button" name="add_button" vtype="button" align="right" iconurl="../../static/images/other/gridadd3.png" text="增加" click="addDate()"></div>
    	</div>
