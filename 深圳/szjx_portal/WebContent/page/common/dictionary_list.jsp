...
<body>
 <div class="title_nav">当前位置：公共管理 > <span>代码集管理</span></div>
 	...
 	<div vtype="formpanel" id="formpanel" name="formpanel" titledisplay="false" width="100%" layout="table"  showborder="false" 
		...
		<div name='codeTableChName' vtype="textfield" label="代码表中文名" labelalign="right" width="90%" labelwidth="140"></div>
		<div name='codeTableEnName' vtype="textfield" label="代码表英文名" labelalign="right" width="90%" labelwidth="150" ></div>
