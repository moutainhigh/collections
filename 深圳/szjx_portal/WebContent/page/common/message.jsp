...
<body>
<div class="title_nav">当前位置：公共管理 > <span>即时消息</span> </div>   
 	<div vtype="formpanel" id="formpanel" name="formpanel" titledisplay="false" width="100%" layout="table"  showborder="false" 
		...
		<div name='title' vtype="textfield" label="标题" labelalign="right" width="90%" labelwidth="92"></div>
		<div name='createrTime' vtype="datefield" label="创建时间" labelalign="right" width="90%" labelwidth="120"></div>
