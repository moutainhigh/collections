...
<body>
	<div class="title_nav">当前位置：应用集成 > <span>厂商管理</span></div>
	   	...
	   	<div name="formpanel" id="formpanel" vtype="formpanel" titledisplay="false" width="100%" layout="table" showborder="false" 
			...
			<div name='firmName' id='firmName' vtype="textfield" label="厂商名称" labelalign="right" labelwidth="120" width="90%" editable="true"></div>
			<div name='firmNameShort' id='firmNameShort' vtype="textfield" label="厂商简称" labelalign="right" labelwidth="120" width="90%" editable="true"></div>
