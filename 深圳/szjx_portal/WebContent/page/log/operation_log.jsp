		   ...
		   <div vtype="gridpanel" name="gridpanel" id="gridpanel" width="100%" height="100%" layout="fit" showborder="false"
			 	...
			 	<div vtype="gridcolumn" name="grid_column" id="grid_column">
					<div> <!-- 单行表头 -->
						...
						<div name="systemCode" text="业务子系统" textalign="center" dataurl="<%=contextpath%>/log/queryLogCodeValue.do?flag=systemCode" width="17%"></div>
						<div name="functionCode" text="操作功能" textalign="center" dataurl="<%=contextpath%>/log/queryLogCodeValue.do?flag=functionCode"  width="17%"></div>
