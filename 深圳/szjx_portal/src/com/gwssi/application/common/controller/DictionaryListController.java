...
public class DictionaryListController extends BaseController {
	...
	@LogBOAnnotation(systemCode="SM",functionCode="SM0403",operationType="初始化代码集管理页面",operationCode=AppConstants.LOG_OPERATE_INIT )
	...
	@LogBOAnnotation(systemCode="SM",functionCode="SM0403",operationType="显示系统名称",operationCode=AppConstants.LOG_OPERATE_QUERY)
	...
	@LogBOAnnotation(systemCode="SM",functionCode="SM0403",operationType="查询代码表信息",operationCode=AppConstants.LOG_OPERATE_QUERY)
	...
	@LogBOAnnotation(systemCode="SM",functionCode="SM0403",operationType="删除代码集信息",operationCode=AppConstants.LOG_OPERATE_DELETE)
