...
public class SmSysIntegrationBO extends AbsDaoBussinessObject {
	...
	private String pkBusiDomain;	
	private String busiDomainName;	
	...
	@Column(name = "PK_BUSI_DOMAIN")
	public String getPkBusiDomain(){
		return pkBusiDomain;
	}
	public void setPkBusiDomain(String pkBusiDomain){
		this.pkBusiDomain = pkBusiDomain;
		markChange("pkBusiDomain", pkBusiDomain);
	}
	@Column(name = "BUSI_DOMAIN_NAME")
	public String getBusiDomainName(){
		return busiDomainName;
	}
	public void setBusiDomainName(String busiDomainName){
		this.busiDomainName = busiDomainName;
		markChange("busiDomainName", busiDomainName);
	}
	...
	public void setParentCode(String parentCode){
		...
		markChange("parentCode", parentCode);
	}
	...
	public void setSystemType(String systemType){
		...
		markChange("systemType", systemType);
	}
}