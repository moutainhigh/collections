...
<!-- <script type="text/javascript" src="script/pub/public-func.js"></script>
<script type="text/javascript" src="script/pub/gwssi-select.js"></script>
<script type="text/javascript" src="script/pub/gwssi-grid.js"></script>
<script type="text/javascript" src="script/pub/gwssi-form.js"></script>  -->
<style type="text/css">
.sec_left{
}
...
$(function(){
	...
	*/
		...
		onDblclick:function(event,key){
			...
			$.ajax({
				  ...
				  success: function(data){
					  var tableColumnItemData = data.data[0].data;
					  var tableId = key;
					  var tableColumn = {
								data : tableColumnItemData,
								onDblclick : function(event, key) {
									 if (typeof key == "undefined") return false;
								//checkTable(key);
									getTableSelectItemByKey(key,"tab1_col_selected_div",tableId,parentTableKey);
					  ...
					  $('#tab1_col_all_div').dataSelector(tableColumn);
				  }
	...
	var tab1_col_all_div={
		data:tab1ColAllData,
		/* onDblclick:function(event,key){
			backTable(key);
		} */
	}
	$('#tab1_col_all_div').dataSelector(tab1_col_all_div);
...
//			}
		...
		onDelete: function(){
			...
			if(delData){
				...
				//console.log(delData.table.id);=====ye
	...
	var opt_leftTable={
		...
		onChange : function(event,key){
			//alert('change  query_config.jsp里面的274行'+key);
...
<dl class="tabs" id="tabs">
     ...
     <dd><div>
		...
		<tr style="padding-top: 5px;">
      			<td style="" valign="top" width="120px;">
	      			<div style=" width:100%; text-align:left; font-size: 14px; color: 333#;" >选择主题：</div>
      				<div style=" width:100%;" id="busiTopic_div"></div>
      			</td>
      			<td style="" valign="top" width="120px">
      				<div style=" width:100%; text-align:left; font-size: 14px; color: 333#;" >选择数据表：</div>
      				<div style="background-color:white; width:100%;" id="tbl_div"></div>
      			</td>
      			<td style="" valign="top" width="120px">
      				<div style=" width:100%; text-align:left; font-size: 14px; color: 333#;" >已选数据表：</div>
      				<div style="background-color:white; width:100%;" id="checkTbl_div"></div>
      			</td>
      			<td style="" valign="top" width="120px">
      				<div style=" width:100%; text-align:left; font-size: 14px; color: 333#;" >请选择数据列：</div>
  ...
  <dd>  <div>
   <table class="dd_table" border=1 cellpadding=3 cellspacing=0 width="100%" align="center">
		...
		<tr><td>SQL语句:</td><td><div ><textarea id="sql_last" style="width: 96%;min-height:60px;"></textarea></div></td></tr>
...
function getColumnsByTable(id){
	  $.ajax({
		  type: "post",
		  url: "../../advQuery/getColumn.do?tableId=" + id,
		  async: false,
		  dataType:"json",
		  success: function(data){
