...
.integeratrion_footer a{
	color: #fff;
	text-decoration: none;
}
.integeratrion_footer a:hover{
...
<body>
	<div id="footer" class="integeratrion_footer">
		版权所有：深圳市市场和质量监督管理委员会  技术支持：信息中心  电话：83070520，邮箱：<a href="mailto:LinQY1@szmqs.gov.cn">LinQY1@szmqs.gov.cn</a>
	</div>
