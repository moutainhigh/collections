        ...
        <div> 
            <div vtype="gridpanel" name="jbxxGrid1" height="90%" width="100%"
				...
				<div vtype="gridcolumn" name="grid_column" width="100%">
					<div>
						<div name='contermno' text="出资期次" textalign="center" width="15%"></div>
						<div name='confrom' text="出资期限自" textalign="center" width="20%"></div>
						<div name='conto' text="出资期限至" textalign="center" width="20%"></div>
						...
						<div name='acconddte' text="实际出资日期" textalign="center" width="15%"></div>
