...
$(function() {
	...
	//var regno = getUrlParam("regno"); 
		$('#jbxxGrid').gridpanel(
				'option',
				'dataurl',
				rootPath + '/reg/gqzydetail.do?priPid=' + priPid +'&flag='+entityNo
		);
...
function getUrl(name) {
	...
	function fixColumn(event, obj) {// 维护按钮
		...
		if(data.length==0){
			$("div[name='grid_table']").html("<br>&nbsp;&nbsp;说明：未查询到该商事主体的限制信息。");
	...
	function viewDataSource(id){
		var url = "<%=request.getContextPath()%>"+"/page/reg/GQZYQueryDetail.jsp?id="+id;
		window.open(url);	
	}
...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="股权质押信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='limityycode' text="限制原因" textalign="center" width="45%" dataurl="limityycode.json"></div>
				<div name='limititemcode' text="限制事项" textalign="center" width="45%" dataurl="limititemcode.json"></div>
				<!--  <div name='type' text="是否有限制年检事项" textalign="center" width="20%" dataurl="../comselect/btype.json"></div> -->
