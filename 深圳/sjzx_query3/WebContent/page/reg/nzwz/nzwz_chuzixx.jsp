...
<script type="text/javascript">
	...
	function fixColumn(event, obj) {// 维护按钮
		...
		for(var i=0;i<data.length;i++){
			...
			var ent = '<a id="persname" href="javascript:void(0);" onclick="viewEntDetail(\''+data[i]["cerno"]+'\');">' + data[i]["inv"] + '</a>';
	...
	function viewDataSource(invid,inv,cerno){
		var title="详细信息";
		var frameurl=""+'/trsquery/querynzwzchuzixxform.do?invid='+invid+"&cerno="+cerno+"&inv="+encode(inv)+"&entname="+encode(parent.entname);
