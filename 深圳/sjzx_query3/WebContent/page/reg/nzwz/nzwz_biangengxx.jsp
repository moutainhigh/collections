...
function fixColumn(event, obj) {// 维护按钮
	...
	for(var i=0;i<data.length;i++){
		var htmCompare ='<div class="jazz-grid-cell-inner">'
			+'<a href="javascript:void(0);" title="查看" onclick="viewDataSource(\''+priPid+'\',\''+entityNo+'\',\''+economicproperty+'\',\''+data[i]["alttime"]+'\',\''+data[i]["altdate"]+'\',\''+data[i]["entname"]+'\',\''+sign+'\');"><img src="'+rootPath+'/static/images/other/mag.png" width="11px" height="12px" border="0"/></a>'
			+'</div>';
...
function viewDataSource(pripid,entityNo,economicproperty,alttime,altdate,entname,sign){
	var title="详细信息";
	var frameurl = ""+'/page/reg/nzwz/nzwz_biangengxx_two.jsp?priPid='+pripid+'&entityNo='+entityNo+'&economicproperty='+economicproperty+'&alttime='+alttime+'&altdate='+altdate+'&entname='+entname+'&sign='+sign;
