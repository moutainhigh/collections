...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="食品安全员信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='name' text="姓名" textalign="center" width="7%"></div>
				<div name='personnelQuality' text="人员性质" textalign="center" width="15%"></div>
				<div name='certificateNo' text="证书编号" textalign="center" width="13%"></div>
				<div name='effectLimit' datatype="date" dataformat="YYYY-MM-DD" text="有效期至" textalign="center" width="13%"></div>
				<div name='credentialType' text="证件类型" textalign="center" width="13%"></div>
				<div name='credentialNo' text="证件号码" textalign="center" width="13%"></div>
				<div name='grade' text="管理员级别" textalign="center" width="13%"></div>
				<div name='contactMobile' text="手机" textalign="center" width="15%"></div>
			</div>
		</div>
		<!-- 表格 -->
