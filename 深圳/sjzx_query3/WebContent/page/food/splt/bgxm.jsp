...
<body>
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		title="变更项目记录信息" defaultview="table" showborder="false"
		isshowselecthelper="false" selecttype="2">
		<!-- 表头 -->
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				<div name='itemNo' text="变更项目" textalign="center" width="20%"></div>
				<div name='itemBefore' text="变更前内容" textalign="center" width="40%"></div>
				<div name='itemAfter' text="变更后内容" textalign="center" width="40%"></div>
