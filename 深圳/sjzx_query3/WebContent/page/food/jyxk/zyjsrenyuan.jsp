...
//	}
	function viewDataSource(id){
		var title="详细信息";
		var frameurl="<%=request.getContextPath()%>"+"/page/food/jyxk/zyjsrenyuanDetail.jsp?id="+id;
	...
	<div vtype="gridpanel" name="jbxxGrid" height="536" width="100%"
		...
		<div vtype="gridcolumn" name="grid_column" width="100%">
			<div>
				...
				<div name='staffType' text="人员类型" textalign="center" width="30%"></div>
				<div name='position' text="职务" textalign="center" width="20%"></div>
