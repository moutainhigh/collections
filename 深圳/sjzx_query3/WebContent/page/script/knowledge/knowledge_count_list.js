...
function initDataGrid(){
	$('#knowledgeGrid').datagrid({
	    height: 567,
	    width:"99%",
	    url: '../../knowledge/manageAction.do?method=queryKnowledgeCountList',
	    method: 'POST',
	    idField: 'docId',
	    striped: true,
	    title:"查询列表",
	    ...
	    columns: [[
	        { field: 'ck',checkbox:true},
   	        ...
   	        { field: 'title', title: '标题 ', width:"29%", align: 'left',fixed:true},
   	        { field: 'catName', title: '属性类别', width: "12%", align: 'left',fixed:true},
   	        { field: 'searchCount', title: '浏览次数', width: "15%", align: 'left',fixed:true},
   	        { field: 'orgName', title: '浏览机关', width: "25%", align: 'left',fixed:true},
   	        { field: 'readDate', title: '浏览日期', width: 170, align: 'center',fixed:true,formatter:formatDatebox}
