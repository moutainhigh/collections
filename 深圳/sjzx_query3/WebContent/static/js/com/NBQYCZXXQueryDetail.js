			 ...
			 queryFunctionConfig : function(ancheid){
				/* var params = {
				  ...
				  //   var panelUrl="../../otherselect/getQueryById.do";
				     var panelUrl="../../NBselect/getCZXXQueryDetail.do?ancheid="+ancheid;
				 //	$("#querySXDetialPanel").formpanel("option","dataurlparams",params);
	    			$("#NBQYCZXXDetialPanel").formpanel("option","dataurl",panelUrl);
	    			$("#NBQYCZXXDetialPanel").formpanel("reload");
	    		//	$("div[name='lisubconam']").textfield("setValue",$("div[name='lisubconam']").textfield("getValue")+"万元");
			},
			/**
