...
public class BlackEntService extends BaseService{
	...
	public List<Map> queryYRRenyuanxx(Map<String, String> str) throws OptimusException {
		...
		*/
		...
		StringBuffer sb = new StringBuffer();
		sb.append(" select  top 100  s_ext_nodenum, pripid, person_id, name, certype , cerno, sex, natdate, dom, postalcode , tel, litdeg, nation, polstand, occst , offsign, accdside, lerepsign, character, country , arrchdate, cerlssdate, cervalper, chiofthedelsign, s_ext_timestamp , s_ext_batch, notorg, notdocno, s_ext_sequence sExtSequence, s_ext_validflag FROM ENTER_ONEPERSON_PERSON where  pripid = ?");
