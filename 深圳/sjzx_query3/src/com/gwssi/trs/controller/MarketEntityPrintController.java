...
import com.gwssi.trs.service.MarketEntityPrintService;
import com.gwssi.trs.service.MarketEntityService;
import com.gwssi.util.CacheUtile;
import com.gwssi.util.FreemarkerUtil;

@Controller
@RequestMapping("/regPrint")
public class MarketEntityPrintController {

	private static  Logger log=Logger.getLogger(MarketEntityPrintController.class);

	private static String fmkFileName = "printFtl.ftl";
...
//				}
				...
				returnString = FreemarkerUtil.returnString(ConfigManager.getProperty(fmkFileName), datasMap);
				sortMap.clear();
			} catch (Exception e) {
				e.printStackTrace();
...
/*		System.out.println("------------------");
	...
	@ResponseBody
	@RequestMapping("scztjbxxPrint")
	public Map<String,Object> scztPrint(OptimusRequest req, OptimusResponse res) throws OptimusException {
...
//				}
				...
				//datasMap.put("weaponMap", dataMap);  
				datasMap.put("weaponMap", sortMap); 
				returnString = FreemarkerUtil.returnString("printFtl.ftl", datasMap);
				sortMap.clear();
			} catch (Exception e) {
				e.printStackTrace();
				log.error(e.getMessage());
...
/*		System.out.println("------------------");
	...
	public void showphone(OptimusRequest req, OptimusResponse res) throws OptimusException {
		...
		marketEntityService.queryPhone(flag, entname+","+persname, req);
	}
	...
	public void casedetailedInfo(OptimusRequest req, OptimusResponse res)throws OptimusException, UnsupportedEncodingException{
		...
		String bpripid = (String)req.getAttr("bregno");
		res.addGrid("jbxxGrid",marketEntityService.queryCaseXX(entname,regno,pripid));
	}
	...
	public static void main(String[] args) {
		List<Map<String,Object>> t = new MarketEntityPrintController().testList();
