...
@Component
public class CalStock_ClosePrice_Ma20_Up {
	...
	@Autowired
	private Stock_ClosePrice_Ma20_Comp_Dao stock_Shou_Yang_One_DayDao;
	...
	//
	//@Scheduled(cron="*/10 * * * * ?")
	//@Scheduled(cron="30 39 19 ? * *")
	public void getStockInfo() {
		long startTime = System.currentTimeMillis();    //获取开始时间
		List<Stock_ClosePrice_Ma20_Comp> entitys =  null;
		stock_Shou_Yang_One_DayDao.truncateTable(Stock_ClosePrice_Ma20_Comp.class);
		Stock_ClosePrice_Ma20_Comp stock_Shou_Yang_Day_One_Day = null;
		...
		for (int i = 1; i <= step; i++) {
			entitys = new ArrayList<Stock_ClosePrice_Ma20_Comp>(); 
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if(datas!=null&&datas.size()>=3){
					...
					double zhangFu = (day1Close - day2Close)/day2Close*100; 
					
				//	Double rates = (day1Close - day1Ma5)/day1Ma5*100;
					
					double rate = day1Ma20 - day2Ma20;
					double isBigMa5 = day1Close - day1Ma5;
					double isBigMa10 = day1Close - day1Ma10;
					double isBigMa20 = day1Close - day1Ma20;
					double ma5IsZhang = day1Ma5 - day2Ma5;
					double ma5Ma10FuDu  = (day1Ma5 - day1Ma10)/day1Ma10*100;
					
					calday.info(day1IsZhang + " =====  "  + " ===>" + sts.getCode() + "  ==> "+ sts.getName()+" ，涨跌幅度：" + zhangFu);
					
					//if(day1IsZhang>0&&rate>0&&isBigMa20>0){
					if(rate>0&&isBigMa20>0&&isBigMa10>0&&isBigMa5>0&&ma5IsZhang>0&&zhangFu>=2.2&&ma5Ma10FuDu>=1.2){
						
						stock_Shou_Yang_Day_One_Day = new Stock_ClosePrice_Ma20_Comp();
		...
		sendStockDayInfoEmail.stockClosePirceMa20Comp();
