...
@RestController
@RequestMapping("api")
public class StockClosePriceMa20CompController {

	@Autowired
	private Stock_ClosePrice_Ma20_Comp_Dao stock_Shou_Yang_One_DayDao;
	
	private String tableName = " Stock_ClosePrice_Ma20_Comp ";
	
	@RequestMapping("/closePriceMa20List")
	...
	@RequestMapping("/getclosePriceMa20MaxTime")
	...
	@RequestMapping("/findClosePriceMa20")
