...
@RestController
@RequestMapping("api")
public class StockDaYangController {

	@Autowired
	private Stock_Da_Yang_Dao stock_Shou_Yang_One_DayDao;
	
	private String tableName = " Stock_Da_Yang_Inf ";
	
	
	@RequestMapping("/daYangList")
	public Page<Stock_Da_Yang_Inf> getInfo(String pageNum,String pageSize){
		int pageNo = 0;
		int row = 10;
	...
	@RequestMapping("/getdaYangMaxTime")
