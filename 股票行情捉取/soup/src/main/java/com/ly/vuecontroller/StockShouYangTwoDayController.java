...
@RestController
@RequestMapping("api")
public class StockShouYangTwoDayController {

	@Autowired
	private Stock_Shou_Yang_Two_DayDao stock_Shou_Yang_One_DayDao;
	private String tableName = " Stock_Shou_Yang_Two_Day ";
	@RequestMapping("/shouYangTwoList")
	...
	@RequestMapping("/getShouYangTwoMaxTime")
	...
	@RequestMapping("/findShouYangTwo")
