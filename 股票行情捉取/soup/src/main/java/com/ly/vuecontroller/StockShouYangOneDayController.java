...
@RestController
@RequestMapping("api")
public class StockShouYangOneDayController {

	@Autowired
	private Stock_Shou_Yang_One_DayDao stock_Shou_Yang_One_DayDao;
	
	private String tableName = " Stock_Shou_Yang_One_Day ";
	
	@RequestMapping("/shouYangOneList")
	...
	@RequestMapping("/getShouYangOneMaxTime")
	...
	@RequestMapping("/findShouYangOne")
