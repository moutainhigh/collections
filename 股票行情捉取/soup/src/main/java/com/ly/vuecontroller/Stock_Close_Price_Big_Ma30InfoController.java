...
@RestController
@RequestMapping("api")
public class Stock_Close_Price_Big_Ma30InfoController {

	@Autowired
	private Stock_Close_Price_Big_Ma30Dao stock_Shou_Yang_One_DayDao;
	
	private String tableName = " Stock_Close_Price_Big_Ma30 ";
	
	
	@RequestMapping("/ma30List")
