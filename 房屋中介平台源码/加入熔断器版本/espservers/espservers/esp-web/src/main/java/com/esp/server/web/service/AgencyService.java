...
public interface AgencyService {
    ...
    @Component
    class AgencyServiceFallback implements AgencyService {

        @Override
        public ApiResponse<UserVO> getAgencyDetail(Long id) {
            return ResponseDataUtil.setResponseData("getAgencyDetail");
        }

        @Override
        public ApiResponse create(Agency agency) {
            return ResponseDataUtil.setResponseData("create");
        }

        @Override
        public ApiResponse<List<Agency>> list() {
            return ResponseDataUtil.setResponseData("list");
        }

        @Override
        public ApiResponse<Agency> detail(Integer id) {
            return ResponseDataUtil.setResponseData("detail");
        }

        @Override
        public ApiResponse<ListResponse<UserVO>> agentList(Integer limit, Integer offset) {
            return ResponseDataUtil.setResponseData("agentList");
        }
    }
}
