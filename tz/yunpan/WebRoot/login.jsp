...
<style type="text/css">
	*{padding:0px;margin:0px}
	...
	#header { height:35%; margin-bottom:0px;position:relative}
	#mainContent { height:65%; }
...
<div id="container">
  ...
  <div id="mainContent" style="text-align:center;">
	<div class="box">
		...
		<form action="service/userdao.jsp" method="post">
			账号：<input type="text" class="inputs" id="account" name="account" autofocus="autofocus" placeholder="请输入账号" maxLength="20">&nbsp;&nbsp;&nbsp;&nbsp;
			密码：<input type="password" class="inputs" id="password" name="password" placeholder="请输入密码" maxLength="20">
			<p class="btn"><input type="button" id="loginbtn" onclick="tm_login(this)" class="submit" value="登陆"><p>
		</form>
	</div>
  </div>
</div>
